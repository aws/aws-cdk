...
export declare function genTypeForPropertyType(typeName: string, propertyTypeName: string): IType;
export declare function genTypeForProperty(typeName: string, ...propertyPath: string[]): IType;
export declare function l1ResourceType(cloudFormationResourceType: string): import("../type").StandardType;
export declare function l1PropertyType(cloudFormationResourceType: string, propTypeName: string): import("../type").StandardType;
