import type { IScope, StructType } from '@cdklabs/typewriter';
import { $E, expr, FreeFunction, stmt, Type } from '@cdklabs/typewriter';
import { CDK_CORE } from './cdk';
import type { CloudFormationMapping } from './cloudformation-mapping';
