...
**YOU ARE IN: `aws_cdk/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/aws_cdk/` (rig root) or other directories
...
**Your mail address:** `aws_cdk/polecats/furiosa`
**Your rig:** aws_cdk
**Your Witness:** `aws_cdk/witness`
...
| Ask Witness for help | `gt mail send aws_cdk/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`aws_cdk/witness`) when:
...
```bash
gt mail send aws_cdk/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
