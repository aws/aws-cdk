...
CloudFormation has pseudo parameters that can be used to reference things like the current AWS region, account ID, or stack name. You can add these pseudo parameters in a CDK stack using the `cdk.Aws()` accessor:
