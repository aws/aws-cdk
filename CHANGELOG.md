...
* **rds**: the property engineVersion in IClusterEngine changed from a string tpo EngineVersion
...
- **@aws-cdk/cfnspec**: Updated [CloudFormation resource specification] to `v2.8.0` ([@RomainMuller] in [#767](https://github.com/aws/aws-cdk/pull/767))
  ...
  - **Property Type Changes**
    ...
    - AWS::CodeDeploy::DeploymentGroup.TagFilter Key.Documentation (**changed**)
      ...
      - New: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codedeploy-deploymentgroup-tagfil
