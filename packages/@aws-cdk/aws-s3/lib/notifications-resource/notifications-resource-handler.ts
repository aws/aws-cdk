...
import {
  Aws, CfnResource, cfnTagToCloudFormation, Construct,
  listMapper, Stack, TagManager, TagType
} from '@aws-cdk/core';
...
export class NotificationsResourceHandler extends Construct {
  ...
  constructor(scope: Construct, id: string) {
    ...
    const role = new iam.Role(this, 'Role', {
      ...
      description: `Generated by the aws-s3 module for stack: ${Aws.STACK_NAME}.`,
      managedPolicies: [
    ...
    class InLineLambda extends CfnResource {
      public readonly tags: TagManager = new TagManager(TagType.STANDARD, resourceType);

      protected renderProperties(properties: any): { [key: string]: any } {
        properties.Tags = listMapper(
          cfnTagToCloudFormation)(this.tags.renderTags());
