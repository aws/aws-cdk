import { Lazy, Logging, Resource } from '@aws-cdk/core';
...
export abstract class BaseListener extends Resource {
  ...
  protected _setDefaultAction(action: IListenerAction) {
    ...
    if (this.defaultAction) {
      Logging.of(this).addWarning('A default Action already existed on this Listener and was replaced. Configure exactly one default Action.');
    }
