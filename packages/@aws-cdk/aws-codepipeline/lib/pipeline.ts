...
import { App, Aws, Construct, Lazy, PhysicalName, RemovalPolicy, Resource, Stack, Token } from '@aws-cdk/core';
...
export class Pipeline extends PipelineBase {
  ...
  constructor(scope: Construct, id: string, props: PipelineProps = {}) {
    ...
    this.role = props.role || new iam.Role(this, 'Role', {
      ...
      description: `Generated by the aws-codepipeline module for stack: ${Aws.STACK_NAME}.`,
    });
