...
// @cfn2ts:meta@ {"generated":"2023-01-22T10:14:11.698Z","fingerprint":"3MaN9bdFfFmUaUNDcJvxSs7Gp9gEBJA2gNJE8qPE7ME="}
...
export class CfnDirectoryConfig extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appstream-directoryconfig.html#cfn-appstream-directoryconfig-certificatebasedauthproperties
     */
    public certificateBasedAuthProperties: CfnDirectoryConfig.CertificateBasedAuthPropertiesProperty | cdk.IResolvable | undefined;
 ...
 * @returns the result of the validation.
 */
function CfnDirectoryConfig_CertificateBasedAuthPropertiesPropertyValidator(properties: any): cdk.ValidationResult {
    if (!cdk.canInspect(properties)) { return cdk.VALIDATION_SUCCESS; }
    const errors = new cdk.ValidationResults();
    if (typeof properties !== 'object') {
        errors.collect(new cdk.ValidationResult('Expected an object, but received: ' + JSON.stringify(properties)));
 ...
 */
// @ts-ignore TS6133
function cfnDirectoryConfigCertificateBasedAuthPropertiesPropertyToCloudFormation(properties: any): any {
    if (!cdk.canInspect(properties)) { return properties; }
...
export class CfnStack extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appstream-stack.html#cfn-appstream-stack-streamingexperiencesettings
     */
    public streamingExperienceSettings: CfnStack.StreamingExperienceSettingsProperty | cdk.IResolvable | undefined;
 ...
 * @returns the result of the validation.
 */
function CfnStack_StreamingExperienceSettingsPropertyValidator(properties: any): cdk.ValidationResult {
    if (!cdk.canInspect(properties)) { return cdk.VALIDATION_SUCCESS; }
    const errors = new cdk.ValidationResults();
    if (typeof properties !== 'object') {
        errors.collect(new cdk.ValidationResult('Expected an object, but received: ' + JSON.stringify(properties)));
 ...
 */
// @ts-ignore TS6133
function cfnStackStreamingExperienceSettingsPropertyToCloudFormation(properties: any): any {
    if (!cdk.canInspect(properties)) { return properties; }
...
// @ts-ignore TS6133
function CfnStackStreamingExperienceSettingsPropertyFromCloudFormation(properties: any): cfn_parse.FromCloudFormationResult<CfnStack.StreamingExperienceSettingsProperty | cdk.IResolvable> {
    if (cdk.isResolvableObject(properties)) {
        return new cfn_parse.FromCloudFormationResult(properties);
    }
    properties = properties == null ? {} : properties;
