...
new secretsmanager.SecretRotation(this, 'SecretRotation', {
  ...
  excludeCharacters: ProblemCharacters.AWS_DMS + ProblemCharacters.SHELL, // A string of characters to never use when generating new passwords. Example is a superset of the characters which will break DMS endpoints and characters which cause problems in shell scripts.
});
```
