...
// @cfn2ts:meta@ {"generated":"2023-03-11T07:33:23.501Z","fingerprint":"Bw3nNMCLiE8uR8vUt3gv/D0/DpbTWzwPl6K8ilbIpOg="}
...
export class CfnArchive extends cdk.CfnResource implements cdk.IInspectable {
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnArchiveProps) {
        ...
        this.attrArchiveName = cdk.Token.asString(this.getAtt('ArchiveName', cdk.ResolutionTypeHint.STRING));
        this.attrArn = cdk.Token.asString(this.getAtt('Arn', cdk.ResolutionTypeHint.STRING));
