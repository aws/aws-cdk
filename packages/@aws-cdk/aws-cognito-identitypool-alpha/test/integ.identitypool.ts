...
const importedUserPool = UserPool.fromUserPoolAttributes(stack, 'ImportedUserPool',
  { userPoolId: userPoolToImport.userPoolId, userPoolProviderName: userPoolToImport.userPoolProviderName },
);
