...
describe('cross environment', () => {
    ...
    test('cannot reference a deploy-time physical name across environments', () => {
        ...
        // THEN
        expect(() => util_1.toCloudFormation(stack2)).toThrow(/Cannot use resource 'Stack1\/MyResource' in a cross-environment fashion/);
    });
