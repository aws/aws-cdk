...
class Stack extends constructs_1.Construct {
    ...
    addDependency(target, reason) {
        ...
        deps_1.addDependency(this, target, reason ?? `{${this.node.path}}.addDependency({${target.node.path}})`);
    }
    /**
    ...
    resolveExportedValue(exportedValue) {
        ...
        const exportable = refs_1.getExportable(this, resolvable);
...
function makeStackName(components) {
    ...
    return unique_resource_name_1.makeUniqueResourceName(components, { maxLength: 128 });
}
