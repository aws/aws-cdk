...
import { FingerprintOptions, IgnoreMode } from '../fs';
 ...
 */
export interface ImageAssetOptions extends FingerprintOptions {
  /**
 ...
 * consumed at runtime.
 */
export interface ImageAssetLocation {
  /**
...
/**
 * DEPRECATED
 * @deprecated use `ImageAssetSource`
 */
export interface DockerImageAssetSource extends ImageAssetSource { }

/**
 * DEPRECATED
 * @deprecated use `ImageAssetLocation`
 */
export interface DockerImageAssetLocation extends ImageAssetLocation { }
