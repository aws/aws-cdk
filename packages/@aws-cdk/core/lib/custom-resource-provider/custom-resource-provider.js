...
class CustomResourceProvider extends constructs_1.Construct {
    constructor(scope, id, props) {
        ...
        const config = helpers_internal_1.getPrecreatedRoleConfig(this, `${this.node.path}/Role`);
