...
export class Image extends ImageBase {
  ...
  public constructor(scope: Construct, id: string, props: ImageProps) {
    super(scope, id, {
      physicalName: props.recipe._isImageRecipe()
        ? props.recipe.imageRecipeName
        : props.recipe._isContainerRecipe()
          ? props.recipe.containerRecipeName
          : undefined, // Image names do not take recipe name as input. Instead, they inherit from the recipe name
    });
