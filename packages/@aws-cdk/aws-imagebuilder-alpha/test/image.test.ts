...
describe('Image', () => {
  ...
  test('with all parameters - image recipe', () => {
    const image = new Image(stack, 'Image', {
      ...
      workflows: [{ workflow: AwsManagedWorkflow.buildImage(stack, 'BuildImageWorkflow') }],
  ...
  test('throws a validation error when importing a recipe that is neither an image recipe or container recipe', () => {
