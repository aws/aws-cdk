...
const stack = new cdk.Stack(app, 'aws-cdk-imagebuilder-image-default-parameters');
...
new imagebuilder.Image(stack, 'Image-AMI', { recipe: imageRecipe });
new imagebuilder.Image(stack, 'Image-Container', { recipe: containerRecipe });

new integ.IntegTest(app, 'ImageTest-DefaultParameters', {
  testCases: [stack],
});
