...
// @cfn2ts:meta@ {"generated":"2023-01-22T09:52:23.381Z","fingerprint":"qZXxy5JUWC0+Q9Go2K+vUqjkq53XjmZwoz6qGWTeXZ0="}
 ...
 * @returns the result of the validation.
 */
function CfnDetector_CFNMalwareProtectionConfigurationPropertyValidator(properties: any): cdk.ValidationResult {
    if (!cdk.canInspect(properties)) { return cdk.VALIDATION_SUCCESS; }
    const errors = new cdk.ValidationResults();
    if (typeof properties !== 'object') {
        errors.collect(new cdk.ValidationResult('Expected an object, but received: ' + JSON.stringify(properties)));
 ...
 */
// @ts-ignore TS6133
function cfnDetectorCFNMalwareProtectionConfigurationPropertyToCloudFormation(properties: any): any {
    if (!cdk.canInspect(properties)) { return properties; }
 ...
 * @returns the result of the validation.
 */
function CfnDetector_CFNScanEc2InstanceWithFindingsConfigurationPropertyValidator(properties: any): cdk.ValidationResult {
    if (!cdk.canInspect(properties)) { return cdk.VALIDATION_SUCCESS; }
    const errors = new cdk.ValidationResults();
    if (typeof properties !== 'object') {
        errors.collect(new cdk.ValidationResult('Expected an object, but received: ' + JSON.stringify(properties)));
 ...
 */
// @ts-ignore TS6133
function cfnDetectorCFNScanEc2InstanceWithFindingsConfigurationPropertyToCloudFormation(properties: any): any {
    if (!cdk.canInspect(properties)) { return properties; }
