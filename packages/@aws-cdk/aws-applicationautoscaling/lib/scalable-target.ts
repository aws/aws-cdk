...
import { Aws, Construct, IResource, Lazy, Resource, withResolved } from '@aws-cdk/core';
...
export class ScalableTarget extends Resource implements IScalableTarget {
  ...
  constructor(scope: Construct, id: string, props: ScalableTargetProps) {
    ...
    this.role = props.role || new iam.Role(this, 'Role', {
      ...
      description: `Generated by the aws-applicationautoscaling module for stack: ${Aws.STACK_NAME}.`,
    });
