...
import {
  Aws, CfnAutoScalingRollingUpdate, Construct, Duration, Fn, IResource, Lazy, PhysicalName, Resource, Stack,
...
export class AutoScalingGroup extends AutoScalingGroupBase implements
  ...
  constructor(scope: Construct, id: string, props: AutoScalingGroupProps) {
    ...
    this.role = props.role || new iam.Role(this, 'InstanceRole', {
      assumedBy: new iam.ServicePrincipal('ec2.amazonaws.com'),
      description: `Generated by the aws-autoscaling module for stack: ${Aws.STACK_NAME}.`,
