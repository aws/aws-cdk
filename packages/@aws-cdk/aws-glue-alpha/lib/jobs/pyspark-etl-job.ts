 ...
 */
export interface PySSparkEtlJobProperties extends JobProperties {
 ...
 */
export class PySparkEtlJub extends Job {
   ...
   * @param props
   */
  constructor(scope: Construct, id: string, props: PySSparkEtlJobProperties) {
    super(scope, id, {
   ...
   */
  private executableArguments(props: PySSparkEtlJobProperties) {
