...
describe('GlueVersion', () => {
  ...
  test('of(customVersion) should set the name correctly', () =>
    expect(glue.GlueVersion.of('CustomVersion').name).toEqual('CustomVersion'));
});
...
describe('JobType', () => {
  ...
  test('.PYTHON_SHELL should set the name correctly', () =>
  ...
  test('of(customName) should set the name correctly', () =>
    expect(glue.JobType.of('CustomName').name).toEqual('CustomName'));
});
...
describe('JobExecutable', () => {
  ...
  describe('.of()', () => {
    ...
    [glue.GlueVersion.V0_9, glue.GlueVersion.V1_0, glue.GlueVersion.V2_0, glue.GlueVersion.V3_0].forEach(
      (glueVersion) => {
