...
/**
 * Represents a custom claim validation configuration for JWT authorizers.
...
export class CustomClaim {
   ...
   * @returns A CustomClaim configured for string validation
   */
  public static withStringValue(name: string, value: string): CustomClaim {
    return new CustomClaim(name, CustomClaimValueType.STRING, CustomClaimOperator.EQUALS, value);
  }
   ...
   * @returns A CustomClaim configured for string array validation
   */
  public static withStringArrayValue(
    ...
    return new CustomClaim(name, CustomClaimValueType.STRING_ARRAY, operator, values);
  }
