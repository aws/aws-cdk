...
import { Aws, Construct, Duration, IResource, Resource, Stack } from '@aws-cdk/core';
...
export class StateMachine extends StateMachineBase {
    ...
    constructor(scope: Construct, id: string, props: StateMachineProps) {
        ...
        this.role = props.role || new iam.Role(this, 'Role', {
            ...
            description: `Generated by the aws-stepfunctions module for stack: ${Aws.STACK_NAME}.`,
        });
