...
class VariableComparison extends Condition {
  public constructor(private readonly variable: string, private readonly comparisonOperator: ComparisonOperator, private readonly value: any) {
    super();
    if (!/^\$[.[]/.test(variable)) {
...
class CompoundCondition extends Condition {
  ...
  public constructor(private readonly operator: CompoundOperator, ...conditions: Condition[]) {
    super();
...
class NotCondition extends Condition {
  public constructor(private readonly comparisonOperation: Condition) {
    super();
  }
