...
class EndpointProductionVariant implements IEndpointProductionVariant {
    ...
    public autoScaleInstanceCount(
        ...
        return (this.scalableInstanceCount = new ScalableInstanceCount(
            this.endpoint,
            "InstanceCount",
            {
...
export interface EndpointProps {
    ...
    /**
     * Whether to retain the variant properties when updating endpoint resources.
     *
...
export class Endpoint extends EndpointBase {
    ...
    constructor(scope: cdk.Construct, id: string, props: EndpointProps) {
        ...
        const endpoint = new CfnEndpoint(this, "Endpoint", {
            ...
            retainAllVariantProperties: props.retainAllVariantProperties,
        });
    ...
    public get productionVariants(): IEndpointProductionVariant[] {
        return this.endpointConfig.productionVariants.map(
            (v) => new EndpointProductionVariant(this, v),
        );
    }
