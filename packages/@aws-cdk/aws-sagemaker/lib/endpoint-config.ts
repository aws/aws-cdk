...
export interface EndpointConfigProps {
    ...
    /**
     * Optional DataCapture Config associated with this EndpointConfig.
     *
     * https://docs.aws.amazon.com/cdk/api/latest/docs/@aws-cdk_aws-sagemaker.CfnEndpointConfig.DataCaptureConfigProperty.html
     *
     * @default none
     */
    ...
    /**
     * Optional AsyncInference Config associated with this EndpointConfig.
     *
     * https://docs.aws.amazon.com/cdk/api/latest/docs/@aws-cdk_aws-sagemaker.CfnEndpointConfig.AsyncInferenceConfigProperty.html
     *
     * @default none
     */
    readonly asyncInferenceConfig?:
...
export class EndpointConfig extends cdk.Resource implements IEndpointConfig {
    ...
    constructor(scope: cdk.Construct, id: string, props: EndpointConfigProps) {
        ...
        [props.productionVariant, ...(props.extraProductionVariants || [])].map((p) =>
            this.addProductionVariant(p),
        );
        ...
        const endpointConfig = new CfnEndpointConfig(this, "EndpointConfig", {
            ...
            dataCaptureConfig: props.dataCaptureConfig ? props.dataCaptureConfig : undefined,
            asyncInferenceConfig: props.asyncInferenceConfig
                ? props.asyncInferenceConfig
                : undefined,
        });
        this.endpointConfigName = this.getResourceNameAttribute(
            endpointConfig.attrEndpointConfigName,
        );
    ...
    public addProductionVariant(props: ProductionVariantProps): void {
        if (props.variantName in this._productionVariants) {
            throw new Error(
                `There is already a Production Variant with name '${props.variantName}'`,
            );
        }
    ...
    private validateProps(props: ProductionVariantProps): void {
        ...
        if (props.instanceType) {
            ...
            if (
                ...
                errors.push(
                    `Invalid instance type for a SageMaker Endpoint Production Variant: ${instanceType}`,
                );
            }
        }
