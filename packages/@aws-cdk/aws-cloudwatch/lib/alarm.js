...
function renderIfSimpleStatistic(statistic) {
    ...
    if (parsed.type === 'simple') {
        return statistic_1.normalizeStatistic(parsed);
    }
    return undefined;
}
