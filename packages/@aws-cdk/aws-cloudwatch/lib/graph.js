...
class GaugeWidget extends widget_1.ConcreteWidget {
    ...
    toJson() {
        ...
        const metrics = rendering_1.allMetricsGraphJson(this.metrics, []);
        const leftYAxis = {
