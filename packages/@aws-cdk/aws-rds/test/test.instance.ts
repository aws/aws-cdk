...
export = {
  ...
  'instance with option and parameter group'(test: Test) {
    ...
    new rds.DatabaseInstance(stack, 'Database', {
      ...
      instanceClass: ec2.InstanceType.pair(ec2.InstanceClass.BURSTABLE2, ec2.InstanceSize.SMALL),
      masterUsername: 'syscdk',
  ...
  'create an instance from snapshot'(test: Test) {
    ...
    new rds.DatabaseInstanceFromSnapshot(stack, 'Instance', {
      ...
      instanceClass: ec2.InstanceType.pair(ec2.InstanceClass.BURSTABLE2, ec2.InstanceSize.LARGE),
      vpc
    });
