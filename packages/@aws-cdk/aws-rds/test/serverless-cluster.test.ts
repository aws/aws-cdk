...
import { AuroraPostgresEngineVersion, ServerlessCluster, DatabaseClusterEngine, ParameterGroup, AuroraCapacityUnit, DatabaseSecret, ServerlessClusterFromSnapshot, SnapshotCredentials } from '../lib';
    ...
    test('fromGeneratedSecret', () => {
      ...
      expect(stack).toHaveResourceLike('AWS::RDS::DBCluster', {
        ...
        MasterUserPassword: {
          ...
          'Fn::Join': ['', ['{{resolve:secretsmanager:', { Ref: 'ServerlessDatabaseSecret813910E98ee0a797cad8a68dbeb85f8698cdb5bb' }, ':SecretString:password::}}']],
        },
      });
