...
import { Aws, Construct, Duration, IResource, Lazy, RemovalPolicy, Resource, SecretValue, Stack, Token } from '@aws-cdk/core';
  ...
  constructor(scope: Construct, id: string, props: DatabaseInstanceNewProps) {
    ...
    if (props.monitoringInterval && props.monitoringInterval.toSeconds()) {
      monitoringRole = props.monitoringRole || new iam.Role(this, 'MonitoringRole', {
        ...
        description: `Generated by the aws-rds module for stack: ${Aws.STACK_NAME}.`,
