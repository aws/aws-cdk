...
export interface IDatabaseProxy extends cdk.IResource {
   ...
   *
   * @param options the properties for the new endpoint
   */
...
abstract class DatabaseProxyBase extends cdk.Resource implements IDatabaseProxy {
  ...
  public addEndpoint(id: string, options: DatabaseProxyEndpointOptions): IDatabaseProxyEndpoint {
    const endpoint = new DatabaseProxyEndpoint(this, id, {
      ...options,
      dbProxy: this,
    });
    return endpoint;
...
/**
 * Whether the DB proxy endpoint can be used for read/write or read-only operations.
 */
...
export interface DatabaseProxyEndpointOptions {
   ...
   *
   *  @default - Generated by CDK (recommended)
   */
...
export class DatabaseProxyEndpoint extends DatabaseProxyEndpointBase {
  ...
  constructor(scope: Construct, id: string, props: DatabaseProxyEndpointProps) {
    super(scope, id, {
      physicalName: props.dbProxyEndpointName || cdk.Lazy.string({ produce: () => cdk.Names.uniqueId(this) }),
    });
    ...
    const resource = new CfnDBProxyEndpoint(this, 'Resource', {
      ...
      targetRole: props.allowedOperations,
      vpcSecurityGroupIds: cdk.Lazy.list({ produce: () => this.connections.securityGroups.map(_ => _.securityGroupId) }),
      vpcSubnetIds: props.vpc.selectSubnets(props.vpcSubnets).subnetIds,
    });

    this.dbProxyEndpointName = resource.ref;
    this.dbProxyEndpointArn = resource.attrDbProxyEndpointArn;
    this.endpoint = resource.attrEndpoint;
    this.vpcId = resource.attrVpcId;
    this.isDefault = resource.attrIsDefault;
