...
export class Cluster extends ClusterBase {
  ...
  constructor(scope: constructs.Construct, id: string, props: ClusterProps) {
    ...
    if (props.clientAuthentication?.tlsProps?.certificateAuthorities !== undefined) {
      clientAuthentication = { ...clientAuthentication } || {};
      clientAuthentication.tls = {
        certificateAuthorityArnList: props.clientAuthentication.tlsProps.certificateAuthorities
          .map((ca) => ca.certificateAuthorityArn),
      };
    }
