...
export class IdentityPool extends Resource implements IIdentityPool {
  ...
  public addUserPool(userPool: IUserPool, options?: UserPoolClientOptions, disableServerSideTokenCheck?: boolean): UserPoolClient {
    ...
    this.cognitoIdentityProviders = this.cognitoIdentityProviders.concat(this.configureIdentityProviders(userPool, client, disableServerSideTokenCheck));
  ...
  */
   ...
   */
  private configureIdentityProviders(userPool: IUserPool, client: IUserPoolClient, disableServerSideTokenCheck?: boolean): CfnIdentityPool.CognitoIdentityProviderProperty[] {
