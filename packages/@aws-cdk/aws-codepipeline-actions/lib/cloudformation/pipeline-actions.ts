...
abstract class CloudFormationAction extends Action {
  ...
  public constructor(props: CloudFormationActionProps, inputs: codepipeline.Artifact[] | undefined) {
    super({
      ...props,
...
abstract class CloudFormationDeployAction extends CloudFormationAction {
  ...
  public constructor(props: CloudFormationDeployActionProps, inputs: codepipeline.Artifact[] | undefined) {
