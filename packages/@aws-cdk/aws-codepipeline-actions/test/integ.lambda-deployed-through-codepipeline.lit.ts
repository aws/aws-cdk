...
const cdkSourceAction = new actions.CodeCommitSourceAction({
...
const lambdaSourceAction = new actions.CodeCommitSourceAction({
...
const lambdaBuildAction = new actions.CodeBuildAction({
