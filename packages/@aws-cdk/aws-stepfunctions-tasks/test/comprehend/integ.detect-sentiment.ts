...
const stack = new cdk.Stack(app, 'aws-stepfunctions-tasks-detect-sentiment-integ');

const detectSyntaxTask = new tasks.ComprehendDetectSentiment(stack, 'ComprehendDetectSentiment', {
