...
const stack = new cdk.Stack(app, 'aws-stepfunctions-tasks-batch-detect-key-phrases-integ');

const detectSyntaxTask = new tasks.ComprehendBatchDetectKeyPhrases(stack, 'ComprehendBatchDetectKeyPhrases', {
