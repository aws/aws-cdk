...
const stack = new cdk.Stack(app, 'aws-stepfunctions-tasks-detect-entities-integ');

const detectSyntaxTask = new tasks.ComprehendDetectEntities(stack, 'ComprehendDetectEntities', {
  languageCode: 'en',
