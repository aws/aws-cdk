...
import { EksCreateNodegroup } from '../../lib';
...
const stack = new cdk.Stack(app, 'aws-stepfunctions-tasks-eks-create-nodegroup-integ');
...
const chain = sfn.Chain.start(createNodeGroupJob);
