...
import { Construct } from 'constructs'; import { integrationResourceArn, validatePatternSupported } from '../private/task-utils';
import { AppSpecification, ExperimentConfig, NetworkConfig, ProcessingInput, ProcessingOutputConfig, ProcessingResources, StoppingCondition } from './base-types';
...
export class SageMakerCreateProcessingJob extends sfn.TaskStateBase implements iam.IGrantable, ec2.IConnectable {
  ...
  private renderEnvironment(params: { [key: string]: any } | undefined): { [key: string]: any } {
    return (params) ? { Environment: params } : {};
  }
