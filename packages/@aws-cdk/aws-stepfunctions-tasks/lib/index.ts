...
export * from './comprehend/batch-detect-sentiment';
export * from './comprehend/batch-detect-syntax';
export * from './comprehend/contains-pii-entities';
export * from './comprehend/detect-dominant-language';
export * from './comprehend/detect-entities';
export * from './comprehend/detect-key-phrases';
export * from './comprehend/detect-sentiment';
export * from './comprehend/detect-syntax';