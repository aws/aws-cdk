...
export interface ComprehendBatchDetectEntitiesProps extends sfn.TaskStateBaseProps {
   ...
   *
   * @see https://docs.aws.amazon.com/comprehend/latest/dg/API_BatchDetectEntities.html#comprehend-BatchDetectEntities-request-LanguageCode
   */
   ...
   *
   * @see https://docs.aws.amazon.com/comprehend/latest/dg/API_BatchDetectEntities.html#comprehend-BatchDetectEntities-request-TextList
   */
