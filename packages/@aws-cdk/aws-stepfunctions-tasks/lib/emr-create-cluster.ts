...
import {
  Aws, booleanToCloudFormation, CfnTag, cfnTagToCloudFormation, Duration, listMapper,
  numberToCloudFormation, objectToCloudFormation, Stack, stringToCloudFormation
} from '@aws-cdk/core';
  ...
  public bind(task: sfn.Task): sfn.StepFunctionsTaskConfig {
    ...
    return {
      ...
      parameters: {
        ...
        JobFlowRole: stringToCloudFormation(this._clusterRole.roleName),
        Name: stringToCloudFormation(this.props.name),
        ServiceRole: stringToCloudFormation(this._serviceRole.roleName),
        AdditionalInfo: stringToCloudFormation(this.props.additionalInfo),
        Applications: listMapper(EmrCreateCluster.ApplicationConfigPropertyToJson)(this.props.applications),
        AutoScalingRole: stringToCloudFormation(this._autoScalingRole?.roleName),
        BootstrapActions: listMapper(EmrCreateCluster.BootstrapActionConfigToJson)(this.props.bootstrapActions),
        Configurations: listMapper(EmrCreateCluster.ConfigurationPropertyToJson)(this.props.configurations),
        CustomAmiId: stringToCloudFormation(this.props.customAmiId),
        EbsRootVolumeSize: numberToCloudFormation(this.props.ebsRootVolumeSize),
        ...
        LogUri: stringToCloudFormation(this.props.logUri),
        ReleaseLabel: stringToCloudFormation(this.props.releaseLabel),
        ScaleDownBehavior: stringToCloudFormation(this.props.scaleDownBehavior?.valueOf()),
        SecurityConfiguration: stringToCloudFormation(this.props.securityConfiguration),
        Tags: listMapper(cfnTagToCloudFormation)(this.props.tags),
        VisibleToAllUsers: booleanToCloudFormation(this.visibleToAllUsers)
      }
    };
  }
...
export namespace EmrCreateCluster {
  ...
  export function EbsBlockDeviceConfigPropertyToJson(property: EbsBlockDeviceConfigProperty) {
    return {
      VolumeSpecification: {
        Iops: numberToCloudFormation(property.volumeSpecification.iops),
        SizeInGB: numberToCloudFormation(property.volumeSpecification.sizeInGB),
        VolumeType: stringToCloudFormation(property.volumeSpecification.volumeType?.valueOf())
      },
      VolumesPerInstance: numberToCloudFormation(property.volumesPerInstance)
    };
  }
  ...
  export function EbsConfigurationPropertyToJson(property: EbsConfigurationProperty) {
    return {
      EbsBlockDeviceConfigs: listMapper(EbsBlockDeviceConfigPropertyToJson)(property.ebsBlockDeviceConfigs),
      EbsOptimized: booleanToCloudFormation(property.ebsOptimized)
    };
  }
  ...
  export function InstanceTypeConfigPropertyToJson(property: InstanceTypeConfigProperty) {
    return {
      BidPrice: stringToCloudFormation(property.bidPrice),
      BidPriceAsPercentageOfOnDemandPrice: numberToCloudFormation(property.bidPriceAsPercentageOfOnDemandPrice),
      Configurations: listMapper(ConfigurationPropertyToJson)(property.configurations),
      ...
      InstanceType: stringToCloudFormation(property.instanceType?.valueOf()),
      WeightedCapacity: numberToCloudFormation(property.weightedCapacity)
    };
  }
  ...
  export function InstanceFleetProvisioningSpecificationsPropertyToJson(property: InstanceFleetProvisioningSpecificationsProperty) {
    return {
      SpotSpecification: {
        BlockDurationMinutes: numberToCloudFormation(property.spotSpecification.blockDurationMinutes),
        TimeoutAction: stringToCloudFormation(property.spotSpecification.timeoutAction?.valueOf()),
        TimeoutDurationMinutes: numberToCloudFormation(property.spotSpecification.timeoutDurationMinutes)
      }
    };
  }
  ...
  export function InstanceFleetConfigPropertyToJson(property: InstanceFleetConfigProperty) {
    return {
      InstanceFleetType: stringToCloudFormation(property.instanceFleetType?.valueOf()),
      InstanceTypeConfigs: listMapper(InstanceTypeConfigPropertyToJson)(property.instanceTypeConfigs),
      ...
      Name: stringToCloudFormation(property.name),
      TargetOnDemandCapacity: numberToCloudFormation(property.targetOnDemandCapacity),
      TargetSpotCapacity: numberToCloudFormation(property.targetSpotCapacity)
    };
  }
  ...
  export function MetricDimensionPropertyToJson(property: MetricDimensionProperty) {
    return {
      Key: stringToCloudFormation(property.key),
      Value: stringToCloudFormation(property.value)
    };
  }
  ...
  export function ScalingTriggerPropertyToJson(property: ScalingTriggerProperty) {
    return {
      CloudWatchAlarmDefinition: {
        ComparisonOperator: stringToCloudFormation(property.cloudWatchAlarmDefinition.comparisonOperator?.valueOf()),
        Dimensions: listMapper(MetricDimensionPropertyToJson)(property.cloudWatchAlarmDefinition.dimensions),
        EvaluationPeriods: numberToCloudFormation(property.cloudWatchAlarmDefinition.evalutionPeriods),
        MetricName: stringToCloudFormation(property.cloudWatchAlarmDefinition.metricName),
        Namespace: stringToCloudFormation(property.cloudWatchAlarmDefinition.namespace),
        Period: numberToCloudFormation(property.cloudWatchAlarmDefinition.period.toSeconds()),
        Statistic: stringToCloudFormation(property.cloudWatchAlarmDefinition.statistic?.valueOf()),
        Threshold: numberToCloudFormation(property.cloudWatchAlarmDefinition.threshold),
        Unit: stringToCloudFormation(property.cloudWatchAlarmDefinition.unit?.valueOf())
      }
    };
  }
  ...
  export function ScalingActionPropertyToJson(property: ScalingActionProperty) {
    return {
      Market: stringToCloudFormation(property.market?.valueOf()),
      SimpleScalingPolicyConfiguration: {
        AdjustmentType: stringToCloudFormation(property.simpleScalingPolicyConfiguration.adjustmentType),
        CoolDown: numberToCloudFormation(property.simpleScalingPolicyConfiguration.coolDown),
        ScalingAdjustment: numberToCloudFormation(property.simpleScalingPolicyConfiguration.scalingAdjustment)
      }
    };
  }
  ...
  export function ScalingRulePropertyToJson(property: ScalingRuleProperty) {
    return {
      ...
      Description: stringToCloudFormation(property.description),
      Name: stringToCloudFormation(property.name),
  ...
  export function AutoScalingPolicyPropertyToJson(property: AutoScalingPolicyProperty) {
    return {
      Constraints: {
        MaxCapacity: numberToCloudFormation(property.constraints.maxCapacity),
        MinCapacity: numberToCloudFormation(property.constraints.minCapacity)
      },
      Rules: listMapper(ScalingRulePropertyToJson)(property.rules)
    };
  }
  ...
  export function InstanceGroupConfigPropertyToJson(property: InstanceGroupConfigProperty) {
    return {
      ...
      BidPrice: numberToCloudFormation(property.bidPrice),
      Configurations: listMapper(ConfigurationPropertyToJson)(property.configurations),
      EbsConfiguration: (property.ebsConfiguration === undefined) ?
        property.ebsConfiguration :
        EbsConfigurationPropertyToJson(property.ebsConfiguration),
      InstanceCount: numberToCloudFormation(property.instanceCount),
      InstanceRole: stringToCloudFormation(property.instanceRole?.valueOf()),
      InstanceType: stringToCloudFormation(property.instanceType),
      Market: stringToCloudFormation(property.market?.valueOf()),
      Name: stringToCloudFormation(property.name)
    };
  }
  ...
  export function PlacementTypePropertyToJson(property: PlacementTypeProperty) {
    return {
      AvailabilityZone: stringToCloudFormation(property.availabilityZone),
      AvailabilityZones: listMapper(stringToCloudFormation)(property.availabilityZones)
    };
  }
  ...
  export function InstancesConfigPropertyToJson(property: InstancesConfigProperty) {
    return {
      AdditionalMasterSecurityGroups: listMapper(stringToCloudFormation)(property.additionalMasterSecurityGroups),
      AdditionalSlaveSecurityGroups: listMapper(stringToCloudFormation)(property.additionalSlaveSecurityGroups),
      Ec2KeyName: stringToCloudFormation(property.ec2KeyName),
      Ec2SubnetId: stringToCloudFormation(property.ec2SubnetId),
      Ec2SubnetIds: listMapper(stringToCloudFormation)(property.ec2SubnetIds),
      EmrManagedMasterSecurityGroup: stringToCloudFormation(property.emrManagedMasterSecurityGroup),
      EmrManagedSlaveSecurityGroup: stringToCloudFormation(property.emrManagedSlaveSecurityGroup),
      HadoopVersion: stringToCloudFormation(property.hadoopVersion),
      InstanceCount: numberToCloudFormation(property.instanceCount),
      InstanceFleets: listMapper(InstanceFleetConfigPropertyToJson)(property.instanceFleets),
      InstanceGroups: listMapper(InstanceGroupConfigPropertyToJson)(property.instanceGroups),
      KeepJobFlowAliveWhenNoSteps: true,
      MasterInstanceType: stringToCloudFormation(property.masterInstanceType),
      Placement: (property.placement === undefined) ?
        property.placement :
        PlacementTypePropertyToJson(property.placement),
      ServiceAccessSecurityGroup: stringToCloudFormation(property.serviceAccessSecurityGroup),
      SlaveInstanceType: stringToCloudFormation(property.slaveInstanceType),
      TerminationProtected: booleanToCloudFormation(property.terminationProtected)
    };
  }
  ...
  export function ApplicationConfigPropertyToJson(property: ApplicationConfigProperty) {
    return {
      Name: stringToCloudFormation(property.name),
      Args: listMapper(stringToCloudFormation)(property.args),
      Version: stringToCloudFormation(property.version),
      AdditionalInfo: objectToCloudFormation(property.additionalInfo)
    };
  }
  ...
  export function BootstrapActionConfigToJson(property: BootstrapActionConfigProperty) {
    return {
      ...
      ScriptBootstrapAction: {
        Path: stringToCloudFormation(property.scriptBootstrapAction.path),
        Args: listMapper(stringToCloudFormation)(property.scriptBootstrapAction.args)
      }
    };
  }
  ...
  export function ConfigurationPropertyToJson(property: ConfigurationProperty) {
    return {
      Classification: stringToCloudFormation(property.classification),
      Properties: objectToCloudFormation(property.properties),
      Configurations: listMapper(ConfigurationPropertyToJson)(property.configurations)
    };
  }
  ...
  export function KerberosAttributesPropertyToJson(property: KerberosAttributesProperty) {
    return {
      ADDomainJoinPassword: stringToCloudFormation(property.adDomainJoinPassword),
      ADDomainJoinUser: stringToCloudFormation(property.adDomainJoinUser),
      CrossRealmTrustPrincipalPassword: stringToCloudFormation(property.crossRealmTrustPrincipalPassword),
      KdcAdminPassword: stringToCloudFormation(property.kdcAdminPassword),
      Realm: stringToCloudFormation(property.realm)
    };
  }
}