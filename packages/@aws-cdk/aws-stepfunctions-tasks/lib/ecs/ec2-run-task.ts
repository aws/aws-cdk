...
/**
 * Properties to run an ECS task on EC2 in StepFunctions and ECS
 */
export interface EcsEc2RunTaskProps extends EcsRunTaskCommonProps {
  /**
...
/**
 * Run an ECS/EC2 Task in a Step Functions workflow
 */
export class EcsEc2RunTask extends EcsRunTaskStateBase {
  constructor(scope: Construct, id: string, props: EcsEc2RunTaskProps) {
 ...
 */
function validateNoNetworkingProps(props: EcsEc2RunTaskProps) {
