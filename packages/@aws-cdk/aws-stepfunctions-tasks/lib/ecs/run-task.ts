...
export interface EcsRunTaskCommonProps extends sfn.TaskStateBaseProps {
  ...
  /**
   * ECS or Fargate Launch type
   */
  readonly launchTarget: IEcsLaunchType;
}

export interface IEcsLaunchType {
  bind(): EcsLaunchConfig;
}

export interface EcsLaunchConfig {
 ...
 */
export interface EcsRunTaskProps extends EcsRunTaskCommonProps {
  /**
...
export class EcsRunTask extends sfn.TaskStateBase implements ec2.IConnectable {
  ...
  private platformVersion?: ecs.FargatePlatformVersion;
  ...
  protected setupPlatformVersion(platformVersion?: ecs.FargatePlatformVersion) {
