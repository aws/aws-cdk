...
import { Aws, Construct, IResource, Lazy, Resource, ResourceProps, Stack } from '@aws-cdk/core';
...
export interface IServerDeploymentGroup extends IResource {
 ...
 */
abstract class ServerDeploymentGroupBase extends Resource implements IServerDeploymentGroup {
  ...
  constructor(scope: Construct, id: string, deploymentConfig?: IServerDeploymentConfig, props?: ResourceProps) {
...
export class ServerDeploymentGroup extends ServerDeploymentGroupBase {
  ...
  constructor(scope: Construct, id: string, props: ServerDeploymentGroupProps = {}) {
    ...
    const resource = new CfnDeploymentGroup(this, 'Resource', {
      ...
      autoScalingGroups: Lazy.listValue({ produce: () => this._autoScalingGroups.map(asg => asg.autoScalingGroupName) }, { omitEmpty: true }),
