 ...
 */
export interface ILambdaDeploymentGroup extends IResource {
  /**
 ...
 */
export class LambdaDeploymentGroup extends Resource implements ILambdaDeploymentGroup {
  /**
  ...
  constructor(scope: Construct, id: string, props: LambdaDeploymentGroupProps) {
    ...
    this.role = props.role || new iam.Role(this, 'ServiceRole', {
      ...
      description: `Generated by the aws-codedeploy module for stack: ${Aws.STACK_NAME}.`,
    });
    ...
    const resource = new CfnDeploymentGroup(this, 'Resource', {
      ...
      alarmConfiguration: Lazy.anyValue({ produce: () => renderAlarmConfiguration(this.alarms, props.ignorePollAlarmsFailure) }),
      autoRollbackConfiguration: Lazy.anyValue({ produce: () => renderAutoRollbackConfiguration(this.alarms, props.autoRollback) }),
    });
    ...
    (props.alias.node.defaultChild as lambda.CfnAlias).cfnOptions.updatePolicy = {
      codeDeployLambdaAliasUpdate: {
        ...
        beforeAllowTrafficHook: Lazy.stringValue({ produce: () => this.preHook && this.preHook.functionName }),
        afterAllowTrafficHook: Lazy.stringValue({ produce: () => this.postHook && this.postHook.functionName }),
      }
    };
  }
...
class ImportedLambdaDeploymentGroup extends Resource implements ILambdaDeploymentGroup {
  public readonly application: ILambdaApplication;
  public readonly deploymentGroupName: string;
  public readonly deploymentGroupArn: string;
  public readonly deploymentConfig: ILambdaDeploymentConfig;
