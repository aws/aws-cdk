...
class TestStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    new CfnOutput(this, 'MatchmakingConfigurationArn', {
      value: matchmakingConfiguration.matchmakingConfigurationArn,
    });
    new CfnOutput(this, 'MatchmakingConfigurationName', {
      value: matchmakingConfiguration.matchmakingConfigurationName,
    });
  }
}
