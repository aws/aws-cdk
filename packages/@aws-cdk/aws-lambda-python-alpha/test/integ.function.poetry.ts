...
class TestStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const pythonFunction37WithHashes = new lambda.PythonFunction(
      this,
      'my_handler_inline_with_hashes_python_37',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        index: 'basic.py',
        runtime: Runtime.PYTHON_3_7,
    ...
    const pythonFunction38WithHashes = new lambda.PythonFunction(
      this,
      'my_handler_inline_with_hashes_python_38',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        index: 'basic.py',
        runtime: Runtime.PYTHON_3_8,
    ...
    const pythonFunction39WithHashes = new lambda.PythonFunction(
      this,
      'my_handler_inline_with_hashes_python_39',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        runtime: Runtime.PYTHON_3_9,
        bundling: {
    ...
    const pythonFunction310WithHashes = new lambda.PythonFunction(
      this,
      'my_handler_inline_with_hashes_python_310',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        runtime: Runtime.PYTHON_3_10,
        bundling: {
    ...
    const pythonFunction311WithHashes = new lambda.PythonFunction(
      this,
      'my_handler_inline_with_hashes_python_311',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        runtime: Runtime.PYTHON_3_11,
        bundling: {
    ...
    const pythonFunction37Excludes = new lambda.PythonFunction(
      this,
      'my_handler_inline_excludes_python_37',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        index: 'basic.py',
        runtime: Runtime.PYTHON_3_7,
    ...
    const pythonFunction38Excludes = new lambda.PythonFunction(
      this,
      'my_handler_inline_excludes_python_38',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        index: 'basic.py',
        runtime: Runtime.PYTHON_3_8,
    ...
    const pythonFunction39Excludes = new lambda.PythonFunction(
      this,
      'my_handler_inline_excludes_python_39',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        runtime: Runtime.PYTHON_3_9,
        bundling: {
    ...
    const pythonFunction310Excludes = new lambda.PythonFunction(
      this,
      'my_handler_inline_excludes_python_310',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        runtime: Runtime.PYTHON_3_10,
        bundling: {
    ...
    const pythonFunction311Excludes = new lambda.PythonFunction(
      this,
      'my_handler_inline_excludes_python_311',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        runtime: Runtime.PYTHON_3_11,
        bundling: {
    ...
    const pythonFunction37WithHashesExcludes = new lambda.PythonFunction(
      this,
      'my_handler_with_hashes_excludes_python_37',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        index: 'basic.py',
        runtime: Runtime.PYTHON_3_7,
    ...
    const pythonFunction38WithHashesExcludes = new lambda.PythonFunction(
      this,
      'my_handler_with_hashes_excludes_python_38',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        index: 'basic.py',
        runtime: Runtime.PYTHON_3_8,
    ...
    const pythonFunction39WithHashesExcludes = new lambda.PythonFunction(
      this,
      'my_handler_with_hashes_excludes_python_39',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        runtime: Runtime.PYTHON_3_9,
        bundling: {
    ...
    const pythonFunction310WithHashesExcludes = new lambda.PythonFunction(
      this,
      'my_handler_with_hashes_excludes_python_310',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        runtime: Runtime.PYTHON_3_10,
        bundling: {
    ...
    const pythonFunction311WithHashesExcludes = new lambda.PythonFunction(
      this,
      'my_handler_with_hashes_excludes_python_311',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        runtime: Runtime.PYTHON_3_11,
        bundling: {
    ...
    const pythonFunction37WithoutUrls = new lambda.PythonFunction(
      this,
      'my_handler_inline_without_urls_python_37',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        index: 'basic.py',
        runtime: Runtime.PYTHON_3_7,
    ...
    const pythonFunction38WithoutUrls = new lambda.PythonFunction(
      this,
      'my_handler_inline_without_urls_python_38',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        index: 'basic.py',
        runtime: Runtime.PYTHON_3_8,
    ...
    const pythonFunction39WithoutUrls = new lambda.PythonFunction(
      this,
      'my_handler_inline_without_urls_python_39',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        runtime: Runtime.PYTHON_3_9,
        bundling: {
    ...
    const pythonFunction310WithoutUrls = new lambda.PythonFunction(
      this,
      'my_handler_inline_without_urls_python_310',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        runtime: Runtime.PYTHON_3_10,
        bundling: {
    ...
    const pythonFunction311WithoutUrls = new lambda.PythonFunction(
      this,
      'my_handler_inline_without_urls_python_311',
      {
        entry: path.join(__dirname, 'lambda-handler-poetry'),
        runtime: Runtime.PYTHON_3_11,
        bundling: {
