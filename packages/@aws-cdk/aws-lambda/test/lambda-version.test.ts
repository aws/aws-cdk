...
describe('lambda version', () => {
  ...
  test('addAlias can be used to add an alias that points to a version', () => {
    ...
    expect(stack).toHaveResource('AWS::Lambda::Alias', {
      ...
      FunctionVersion: {
        'Fn::GetAtt': [
          'FnCurrentVersion17A89ABB734f8396c6bf253af280ea9c5b22ae59',
          'Version',
        ],
      },
      Name: 'foo',
  ...
  test('edgeArn', () => {
    ...
    // THEN
    expect(stack.resolve(version.edgeArn)).toEqual({ Ref: 'FnCurrentVersion17A89ABB80486b870700fd98d45df0d591d19e82' });
  });
