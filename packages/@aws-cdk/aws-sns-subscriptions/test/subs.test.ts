...
test('url subscription with cdk generated dlq', () => {
  topic.addSubscription(new subs.UrlSubscription('https://foobar.com/', {
      ...
      'MyTopichttpsfoobarcomDEA92AB5': {
        ...
        'Properties': {
          ...
          'RedrivePolicy': {
            'deadLetterTargetArn': {
              'Fn::GetAtt': [
                'MyTopichttpsfoobarcomDeadLetterQueue5A1D84AE',
                'Arn',
              ],
            },
          },
...
test('queue subscription with cdk generated dlq', () => {
  const queue = new sqs.Queue(stack, 'MyQueue');
      ...
      'MyQueueMyTopic9B00631B': {
        ...
        'Properties': {
          ...
          'RedrivePolicy': {
            'deadLetterTargetArn': {
              'Fn::GetAtt': [
                'MyQueueMyTopicDeadLetterQueue558E62AB',
                'Arn',
              ],
            },
          },
