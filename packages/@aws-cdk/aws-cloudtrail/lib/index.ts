...
import { Aws, Construct, Resource, Stack } from '@aws-cdk/core';
...
export class Trail extends Resource {
  ...
  constructor(scope: Construct, id: string, props: TrailProps = {}) {
    ...
    if (props.sendToCloudWatchLogs) {
      ...
      logsRole = new iam.Role(this, 'LogsRole', {
        assumedBy: cloudTrailPrincipal,
        description: `Generated by the aws-cloudtrail module for stack: ${Aws.STACK_NAME}.`,
      });
