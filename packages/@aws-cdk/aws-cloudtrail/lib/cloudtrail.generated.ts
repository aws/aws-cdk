...
// @cfn2ts:meta@ {"generated":"2023-03-09T03:54:14.941Z","fingerprint":"UH/UJFrEUxurAVBw8pGML2ZbCl05tREAo+KW3Gk1/Fk="}
...
export class CfnChannel extends cdk.CfnResource implements cdk.IInspectable {
     ...
     */
    public static readonly CFN_RESOURCE_TYPE_NAME = "AWS::CloudTrail::Channel";
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudtrail-channel.html#cfn-cloudtrail-channel-destinations
     */
    public destinations: Array<CfnChannel.DestinationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
 ...
 * @returns the result of the validation.
 */
function CfnChannel_DestinationPropertyValidator(properties: any): cdk.ValidationResult {
    if (!cdk.canInspect(properties)) { return cdk.VALIDATION_SUCCESS; }
    const errors = new cdk.ValidationResults();
    if (typeof properties !== 'object') {
        errors.collect(new cdk.ValidationResult('Expected an object, but received: ' + JSON.stringify(properties)));
 ...
 */
// @ts-ignore TS6133
function cfnChannelDestinationPropertyToCloudFormation(properties: any): any {
    if (!cdk.canInspect(properties)) { return properties; }
...
export class CfnResourcePolicy extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * The CloudFormation resource type name for this resource class.
     */
    public static readonly CFN_RESOURCE_TYPE_NAME = "AWS::CloudTrail::ResourcePolicy";
