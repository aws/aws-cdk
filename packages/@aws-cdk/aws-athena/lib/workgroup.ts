...
export class WorkGroup extends WorkGroupBase {
      ...
      workGroupConfiguration: (props.configuration) ?
        {
          ...
          engineVersion: (props.configuration.engineVersion) ? {
            selectedEngineVersion: props.configuration.engineVersion.name,
          }: undefined,
          resultConfiguration: (props.configuration.resultConfigurations)
            ? this.resolveResultConfiguration(props.configuration.resultConfigurations): undefined,
        } : undefined,
  ...
  private resolveResultConfiguration(resultCfg: ResultConfiguration) {
