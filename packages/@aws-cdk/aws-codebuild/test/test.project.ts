...
export = {
  ...
  'EnvironmentVariables': {
    ...
    'from SecretsManager': {
      ...
      'can be provided as a SecretValue of a new Secret, with its physical name set, created in a different account'(test: Test) {
        // GIVEN
        const app = new cdk.App();
      ...
      'can be provided as a SecretValue of a Secret imported by name in a different account'(test: Test) {
        // GIVEN
        const app = new cdk.App();
        const secretStack = new cdk.Stack(app, 'SecretStack', {
          env: { account: '012345678912' },
