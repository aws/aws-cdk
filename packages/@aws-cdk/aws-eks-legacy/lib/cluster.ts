...
import { Aws, CfnOutput, Construct, Duration, IResource, Resource, Stack, Tag, Token } from '@aws-cdk/core';
...
export class Cluster extends Resource implements ICluster {
  ...
  constructor(scope: Construct, id: string, props: ClusterProps = { }) {
    ...
    this.role = props.role || new iam.Role(this, 'ClusterRole', {
      ...
      description: `Generated by the aws-eks-legacy CDK module for stack: ${Aws.STACK_NAME}.`,
      managedPolicies: [
