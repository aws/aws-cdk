...
import { Construct, Duration, Legacy, Stack } from '@aws-cdk/core';
...
export class HelmChart extends Construct {
  ...
  constructor(scope: Construct, id: string, props: HelmChartProps) {
    ...
    new CustomResource(this, 'Resource', {
      ...
      properties: {
        Release: props.release || Legacy.uniqueId(this).slice(-63).toLowerCase(), // Helm has a 63 character limit for the name
        Chart: props.chart,
