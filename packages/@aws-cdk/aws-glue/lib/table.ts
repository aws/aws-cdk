  ...
  constructor(scope: Construct, id: string, props: TableProps) {
    ...
    const tableResource = new CfnTable(this, 'Table', {
      ...
      tableInput: {
        ...
        description: props.description || `${props.tableName.value} generated by CDK`,
    ...
    const resourceIdentifiers = new ResourceIdentifiers(this, {
      arn: Stack.of(this).formatArn({
        service: 'glue',
        resource: 'table',
        resourceName: `${this.database.databaseName}/${tableResource.refAsString}`
      }),
      name: tableResource.refAsString,
      arnComponents: {
        service: 'glue',
        resource: 'table',
        resourceName: `${this.database.physicalName.value}/${this.physicalName.value}`
      },
    });
