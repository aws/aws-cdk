  ...
  constructor(scope: Construct, id: string, props: TableProps) {
    ...
    const resourceIdentifiers = new ResourceIdentifiers(this, {
      arn: Stack.of(this).formatArn({
        service: 'glue',
        resource: 'table',
        resourceName: `${this.database.databaseName}/${tableResource.tableName}`
      }),
      name: tableResource.tableName,
      arnComponents: {
        service: 'glue',
        resource: 'table',
        resourceName: `${this.database.databaseName}/${this.physicalName.value}`
      },
    });
