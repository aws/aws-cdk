...
test('glue View', ()=> {
  ...
  const viewStack = new cdk.Stack(app, 'view');
  new glue.View(viewStack, 'View', {
    database,
    tableName: 'view',
    columns: [{
      name: 'col',
  ...
  Template.fromStack(viewStack).hasResourceProperties('AWS::Glue::Table', {
    CatalogId: {
      Ref: 'AWS::AccountId',
    },
    DatabaseName: {
    ...
    TableInput: {
      Name: 'view',
      Description: 'view generated by CDK',
      Parameters: {
        comment: 'Presto View',
        presto_view: 'true',
      },
      ...
      ViewOriginalText: {
        'Fn::Sub': [
          '/* Presto View: ${PrestoBase64} */',
          {
            PrestoBase64: {
              'Fn::Base64': {
                'Fn::Sub': [
                  '{"originalSql":${OriginalSql},"catalog":"${Catalog}","schema":"${Schema}","columns":${Columns}}',
                  {
                    Catalog: 'awsdatacatalog',
                    Schema: {
                      'Fn::ImportValue': 'db:ExportsOutputRefDatabaseB269D8BB88F4B1C4',
                    },
                    OriginalSql: JSON.stringify('select "1" as col'),
