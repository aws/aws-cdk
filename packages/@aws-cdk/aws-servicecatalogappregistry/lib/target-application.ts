...
export interface TargetApplicationCommonOptions extends cdk.StackProps {
  ...
  /**
    ...
    * target application. If set to `false`, the application will not be shared with the accounts that own the stacks.
    *
    * @default true
    */
...
class CreateTargetApplication extends TargetApplication {
  ...
  public bind(scope: Construct): BindTargetApplicationResult {
    ...
    return {
      ...
      associateCrossAccountStacks: this.applicationOptions.associateCrossAccountStacks ?? true,
    };
  }
}
