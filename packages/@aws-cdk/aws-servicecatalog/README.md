...
```ts fixture=portfolio-product
// Create a singular TagOption
const tagOption = new servicecatalog.TagOption(this, 'SingleTagOption', {
  key: 'costCenter',
  value: 'engineering',
});
product.associateTagOption(tagOptionsForProduct);

// Create multiple tagOptions based on lists of keys and values.
const tagOptions= new servicecatalog.TagOptions(this, {
  group: ['finance', 'engineering', 'marketing', 'research'],
  environment: ['test', 'dev'],
});
portfolio.associateTagOptions(tagOption);
```
