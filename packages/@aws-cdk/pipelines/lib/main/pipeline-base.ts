...
import { AddStageOpts as StageOptions, WaveOptions, Wave, IFileSetProducer, ScriptStep } from '../blueprint';
...
export abstract class PipelineBase extends CoreConstruct {
  ...
  constructor(scope: Construct, id: string, props: PipelineBaseProps) {
    ...
    if (props.synth instanceof ScriptStep && !props.synth.primaryOutput) {
