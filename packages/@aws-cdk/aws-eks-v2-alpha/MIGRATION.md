...
When the removal policy is set to `RETAIN`, all resources created by the V1 construct will be preserved when they are no longer managed by Cloudformation. These resources include:
