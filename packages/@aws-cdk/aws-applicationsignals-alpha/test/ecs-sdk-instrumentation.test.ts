...
import { InstrumentationVersion, JavaInjector, JavaInstrumentationVersion, PythonInstrumentation, DotnetInstrumentationVersion, CommonExporting, DotNetLinuxInjector, PythonInjector, PythonInstrumentationVersion, DotNetWindowsInjector, NodeInjector, NodeInstrumentationVersion, Injector } from '../lib';

class SnapshotInstrumentationVersion extends InstrumentationVersion {
}
...
describe('application signals adot sdk agent integration', () => {
  test('should create an init container with default java config', () => {
    ...
    const injector = new JavaInjector('test', JavaInstrumentationVersion.V2_10_0);
  ...
  test('should create an init container with custom java instrumentation version', () => {
    ...
    const injector = new JavaInjector(
      'test',
      // override image and increase the memory resource
      new SnapshotInstrumentationVersion(JavaInstrumentationVersion.IMAGE_REPO, 'SNAPSHOT', 128),
      // customize service.name and add additional resource attributes
      [{
        name: CommonExporting.OTEL_RESOURCE_ATTRIBUTES,
  ...
  test('should create an init container with default python config', () => {
    ...
    for (const test of [
      ...
      const injector = new PythonInjector('test', PythonInstrumentationVersion.V0_8_0);
      injector.injectInitContainer(fargateTaskDefinition);
      injector.renderDefaultContainer(fargateTaskDefinition);
  ...
  test('should create an init container with default dotnet on linux', () => {
    ...
    for (const test of [new TestCase(ecs.CpuArchitecture.ARM64, '/otel-auto-instrumentation-dotnet/linux-arm64/OpenTelemetry.AutoInstrumentation.Native.so' ),
      ...
      const injector = new DotNetLinuxInjector('test', DotnetInstrumentationVersion.V1_6_0, test.cpuArch);
      injector.injectInitContainer(fargateTaskDefinition);
      injector.renderDefaultContainer(fargateTaskDefinition);
  ...
  test('should create an init container with default dotnet on windows', () => {
    ...
    const injector = new DotNetWindowsInjector('test', DotnetInstrumentationVersion.V1_6_0_WINDOWS2022);
    injector.injectInitContainer(fargateTaskDefinition);
    injector.renderDefaultContainer(fargateTaskDefinition);
  ...
  test('should create an init container with default nodejs config', () => {
    ...
    for (const test of [
      ...
      const injector = new NodeInjector('test', NodeInstrumentationVersion.V0_5_0);
      injector.injectInitContainer(fargateTaskDefinition);
      injector.renderDefaultContainer(fargateTaskDefinition);
...
class CustomJavaInjector extends JavaInjector {
  get containerPath(): string {
    return '/otel-snapshot';
  }
}

class CustomPythonInjector extends PythonInjector {
  get containerPath(): string {
    return '/otel-snapshot';
  }
  ...
  protected injectAdditionalEnvironments(envsToInject: { [key: string]: string }, _envsFromTaskDef: { [key: string]: string }): void {
    ...
    envsToInject[PythonInstrumentation.PYTHONPATH] = `${this.containerPath}/auto_instrumentation:${this.containerPath}`;
  }
}

class CustomDotnetLinuxInjector extends DotNetLinuxInjector {
  get containerPath(): string {
    return '/otel-snapshot';
  }
}

class CustomNodeInjector extends NodeInjector {
  get containerPath(): string {
    return '/otel-snapshot';
  }
}
...
describe('application signals custom injector', () => {
  test('should create an init container with custom java injector', () => {
    ...
    const injector = new CustomJavaInjector('test', JavaInstrumentationVersion.V2_10_0);
    injector.injectInitContainer(fargateTaskDefinition);
    injector.renderDefaultContainer(fargateTaskDefinition);
  ...
  test('should create an init container with custom python injector', () => {
    ...
    const injector = new CustomPythonInjector('test', PythonInstrumentationVersion.V0_8_0);
    injector.injectInitContainer(fargateTaskDefinition);
    injector.renderDefaultContainer(fargateTaskDefinition);
  ...
  test('should create an init container with custom dotnet injector', () => {
    ...
    const injector = new CustomDotnetLinuxInjector('test', DotnetInstrumentationVersion.V1_6_0, ecs.CpuArchitecture.X86_64);
    injector.injectInitContainer(fargateTaskDefinition);
    injector.renderDefaultContainer(fargateTaskDefinition);
  ...
  test('should create an init container with custom nodejs injector', () => {
    ...
    const injector = new CustomNodeInjector('test', NodeInstrumentationVersion.V0_5_0);
    injector.injectInitContainer(fargateTaskDefinition);
    injector.renderDefaultContainer(fargateTaskDefinition);
