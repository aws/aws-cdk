...
import { ApplicationSignalsIntegration, PythonInstrumentationVersion, JavaInstrumentationVersion, InstrumentationVersion, DotnetInstrumentationVersion, NodeInstrumentation, NodeInstrumentationVersion, CloudWatchAgentVersion } from '../lib';
  ...
  test('should create container dependencies with different instrumentation versions', () => {
    class TestCase {
      ...
      get expectedCWAgentImage(): string {
        return this.windows?CloudWatchAgentVersion.CLOUDWATCH_AGENT_IMAGE_WIN2022:CloudWatchAgentVersion.CLOUDWATCH_AGENT_IMAGE;
      }
    }

    for (const test of [new TestCase(JavaInstrumentationVersion.V1_32_6, '/otel-auto-instrumentation'),
      new TestCase(PythonInstrumentationVersion.V0_8_0, '/otel-auto-instrumentation-python'),
      new TestCase(DotnetInstrumentationVersion.V1_6_0, '/otel-auto-instrumentation-dotnet'),
      new TestCase(DotnetInstrumentationVersion.V1_6_0_WINDOWS2022, 'C:\\otel-auto-instrumentation-dotnet', true),
      new TestCase(NodeInstrumentationVersion.V0_5_0, '/otel-auto-instrumentation-nodejs')]) {
      // GIVEN
