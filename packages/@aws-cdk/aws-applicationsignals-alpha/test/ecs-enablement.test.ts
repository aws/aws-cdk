...
import { ApplicationSignalsIntegration, InstrumentationLanguage, DotnetInstrumentationVersion, PythonInstrumentationVersion, JavaInstrumentationVersion, NodeInstrumentationVersion } from '../lib';
...
describe('application signals integration', () => {
  ...
  test('should create application signals configurations with dotnet on windows', () => {
    // GIVEN
    const stack = new Stack();
  ...
  test('should create application signals configurations with node', () => {
    ...
    new ApplicationSignalsIntegration(stack, 'TestIntegration', {
      taskDefinition: ec2TaskDefinition,
      instrumentation: {
        language: InstrumentationLanguage.NODEJS,
