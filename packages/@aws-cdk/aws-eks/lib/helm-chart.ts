import { CustomResource, Duration, Legacy, Stack } from '@aws-cdk/core';
  ...
  constructor(scope: Construct, id: string, props: HelmChartProps) {
    ...
    new CustomResource(this, 'Resource', {
      ...
      properties: {
        ...
        Release: props.release ?? Legacy.uniqueId(this).slice(-53).toLowerCase(), // Helm has a 53 character limit for the name
        Chart: props.chart,
