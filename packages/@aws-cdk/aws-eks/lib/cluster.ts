...
export class Cluster extends ClusterBase {
   ...
   *
   * Note that if you specify `updatePolicy: UpdatePolicy.rollingUpdate()` or `updateType: UpdatePolicy.replacingUpdate`, your nodes might be replaced at deploy
   * time without notice in case the recommended AMI for your machine image type has been updated by AWS.
   * The default behavior for `updatePolicy` is `None`, which means only new instances will be launched using the new AMI.
   *
