...
// @cfn2ts:meta@ {"generated":"2023-01-22T06:40:00.623Z","fingerprint":"zvtk3Q3LC9Cs3x9BeE7OLhYpdzrv4bphmTQzeU6xgvI="}
...
export class CfnAddon extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-eks-addon.html#cfn-eks-addon-configurationvalues
     */
    public configurationValues: string | undefined;
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-eks-addon.html#cfn-eks-addon-preserveondelete
     */
    public preserveOnDelete: boolean | cdk.IResolvable | undefined;
...
export class CfnCluster extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-eks-cluster.html#cfn-eks-cluster-outpostconfig
     */
    public outpostConfig: CfnCluster.OutpostConfigProperty | cdk.IResolvable | undefined;
 ...
 * @returns the result of the validation.
 */
function CfnCluster_ControlPlanePlacementPropertyValidator(properties: any): cdk.ValidationResult {
    if (!cdk.canInspect(properties)) { return cdk.VALIDATION_SUCCESS; }
    const errors = new cdk.ValidationResults();
    if (typeof properties !== 'object') {
        errors.collect(new cdk.ValidationResult('Expected an object, but received: ' + JSON.stringify(properties)));
 ...
 */
// @ts-ignore TS6133
function cfnClusterControlPlanePlacementPropertyToCloudFormation(properties: any): any {
    if (!cdk.canInspect(properties)) { return properties; }
 ...
 * @returns the result of the validation.
 */
function CfnCluster_OutpostConfigPropertyValidator(properties: any): cdk.ValidationResult {
    if (!cdk.canInspect(properties)) { return cdk.VALIDATION_SUCCESS; }
    const errors = new cdk.ValidationResults();
    if (typeof properties !== 'object') {
        errors.collect(new cdk.ValidationResult('Expected an object, but received: ' + JSON.stringify(properties)));
 ...
 */
// @ts-ignore TS6133
function cfnClusterOutpostConfigPropertyToCloudFormation(properties: any): any {
    if (!cdk.canInspect(properties)) { return properties; }
...
// @ts-ignore TS6133
function CfnClusterOutpostConfigPropertyFromCloudFormation(properties: any): cfn_parse.FromCloudFormationResult<CfnCluster.OutpostConfigProperty | cdk.IResolvable> {
    if (cdk.isResolvableObject(properties)) {
        return new cfn_parse.FromCloudFormationResult(properties);
    }
    properties = properties == null ? {} : properties;
...
export class CfnNodegroup extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-eks-nodegroup.html#cfn-eks-nodegroup-labels
     */
    public labels: { [key: string]: (string) } | cdk.IResolvable | undefined;
