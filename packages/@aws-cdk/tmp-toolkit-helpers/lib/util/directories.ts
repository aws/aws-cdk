...
/**
 * Find the resources dir of the package. This is a well-known directory in the root of the repo.
 */
...
/**
 * Find the path to resource file in the well-known resources directory in the root of the repo.
 */
export function resourcePath(...resource: string[]): string {
  return path.join(rootDir(), 'resources', ...resource);
}
