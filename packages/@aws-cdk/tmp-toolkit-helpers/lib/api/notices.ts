...
import { AwsCliCompatible } from './aws-auth/awscli-compatible';
import { SdkHttpOptions } from './aws-auth/sdk-provider';
...
import { loadTreeFromDir, some } from '../util/tree';
...
export class Notices {
   ...
   */
  public display(cliVersion: string, options: NoticesPrintOptions = {}) {
    if (!this.shouldDisplay) {
      return;
    }
