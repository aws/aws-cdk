...
import { CloudAssembly, DefaultSelection, ExtendedStackSelection, StackCollection } from './cxapp/cloud-assembly';
 ...
 */
export async function listStacks(assembly: CloudAssembly, options: ListStacksOptions): Promise<StackDetails[]> {
