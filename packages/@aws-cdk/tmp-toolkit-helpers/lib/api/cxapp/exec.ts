...
import { loadTree, some } from '../../util/tree';
...
export async function execProgram(aws: SdkProvider, config: Configuration, cliVersionNumber: string): Promise<ExecProgramResult> {
  ...
  try {
    ...
    env[cxapi.CLI_VERSION_ENV] = cliVersionNumber;
