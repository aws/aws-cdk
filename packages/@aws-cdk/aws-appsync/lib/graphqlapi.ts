...
export abstract class BaseDataSource extends Construct implements IGrantable {
  ...
  public constructor(scope: Construct, id: string, props: BaseDataSourceProps, extended: ExtendedDataSourceProps) {
    super(scope, id);
...
export class DynamoDbDataSource extends BaseDataSource {
  public constructor(scope: Construct, id: string, props: DynamoDbDataSourceProps) {
...
export class LambdaDataSource extends BaseDataSource {
  public constructor(scope: Construct, id: string, props: LambdaDataSourceProps) {
    super(scope, id, props, {
      type: 'AWS_LAMBDA',
      lambdaConfig: {
