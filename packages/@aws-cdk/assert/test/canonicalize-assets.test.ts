...
import { canonicalizeStackArtifact } from '../lib';
...
test('Canonicalize asset parameters and references to them', () => {
      ...
      '/something': [
        {
          ...
          data: {
            packaging: 'file',
            sourceHash: 'ea46702e1c05b2735e48e826d630f7bf6acdf7e55d6fa8d9fa8df858d5542161',
            artifactHashParameter: 'AssetParametersea46702e1c05b2735e48e826d630f7bf6acdf7e55d6fa8d9fa8df858d5542161ArtifactHash67B22EF2',
            s3KeyParameter: 'AssetParametersea46702e1c05b2735e48e826d630f7bf6acdf7e55d6fa8d9fa8df858d5542161S3VersionKey6841F1F8',
            s3BucketParameter: 'AssetParametersea46702e1c05b2735e48e826d630f7bf6acdf7e55d6fa8d9fa8df858d5542161S3Bucket0C424907',
          } as cxschema.FileAssetMetadataEntry,
        },
      ],
    },
  });

  builder.writeStack('Expected', { template: {
    Resources: {
      AResource: {
        Type: 'Some::Resource',
        Properties: {
  ...
  const input = assembly.getStackByName('Input');
  const expected = assembly.getStackByName('Expected');

  expect(canonicalizeStackArtifact(input).template).toEqual(expected.template);
});
      ...
      '/something-else': [
        {
          ...
          data: {
            packaging: 'zip',
            sourceHash: '1111111111111111111111111111111111122222222222222222222222222222',
            artifactHashParameter: 'AssetParameters1111111111111111111111111111111111122222222222222222222222222222ArtifactHash67B22EF2',
            s3KeyParameter: 'AssetParameters1111111111111111111111111111111111122222222222222222222222222222S3VersionKey6841F1F8',
            s3BucketParameter: 'AssetParameters1111111111111111111111111111111111122222222222222222222222222222S3Bucket0C424907',
          } as cxschema.FileAssetMetadataEntry,
        },
      ],
    },
