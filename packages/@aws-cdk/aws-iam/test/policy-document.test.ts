...
describe('IAM policy document', () => {
  ...
  describe('fromJson', () => {
    ...
    test('from JSON awsAccountPrincipal', () => {
      const stack = new Stack();
    ...
    test('from JSON addCanonicalUserPrincipal', () => {
      const stack = new Stack();
    ...
    test('from JSON addFederatedPrincipal', () => {
      const stack = new Stack();
    ...
    test('from JSON addServicePrincipal', () => {
      const stack = new Stack();
