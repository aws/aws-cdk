...
class ManagedBucketTest(unittest.TestCase):
    ...
    def test_create(self, _, s3_client: MagicMock):

        event = make_event("Create", True)

        index.handler(event, {})

        s3_client.put_bucket_notification_configuration.assert_called_once_with(
    ...
    @patch('index.s3')
    @patch("index.submit_response")
    def test_update(self, _, s3_client: MagicMock):
    ...
    @patch('index.s3')
    @patch("index.submit_response")
    def test_delete(self, _, s3_client: MagicMock):
...
class UnmanagedCleanBucketTest(unittest.TestCase):
    ...
    @patch('index.s3')
    @patch("index.submit_response")
    def test_create_with_eventbridge(self, _, s3_client: MagicMock):
    ...
    def test_update(self, _, s3_client: MagicMock):
        ...
        s3_client.get_bucket_notification_configuration.return_value = current_notifications
    ...
    @patch('index.s3')
    @patch("index.submit_response")
    def test_update_with_eventbridge(self, _, s3_client: MagicMock):
    ...
    @patch('index.s3')
    @patch("index.submit_response")
    def test_update_with_existing_eventbridge(self, _, s3_client: MagicMock):
    ...
    @patch('index.s3')
    @patch("index.submit_response")
    def test_delete_with_eventbridge_should_not_remove_eventbridge(self, _, s3_client: MagicMock):
...
class UnmanagedDirtyBucketTest(unittest.TestCase):
    ...
    @patch('index.s3')
    @patch("index.submit_response")
    def test_create_with_existing_eventbridge(self, _, s3_client: MagicMock):
    ...
    @patch('index.s3')
    @patch("index.submit_response")
    def test_update_without_eventbridge_should_not_remove_existing_eventbridge(self, _, s3_client: MagicMock):
    ...
    def test_delete_with_eventbridge_should_not_remove_eventbridge(self, _, s3_client: MagicMock):
        ...
        s3_client.put_bucket_notification_configuration.assert_called_once_with(
            Bucket=event["ResourceProperties"]["BucketName"],
            NotificationConfiguration=make_eventbridge_configuration(),
        )
