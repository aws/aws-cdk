...
describe('Notification Target', () => {
  ...
  test('notification added targets', () => {
    ...
    const topic1 = new sns.Topic(stack, 'MyTopic1', {});
    const topic2 = new sns.Topic(stack, 'MyTopic2', {});
    ...
    notifier.addTarget(new targets.SnsTopic(topic1));
    notifier.addTarget(new targets.SnsTopic(topic2));
    notifier.addTarget(new targets.SlackChannelConfiguration(slack));
