...
tgw.defaultRouteTable.addBlackholeRoute('defaultRTBRoute2', '10.1.0.0/16');
tgw.defaultRouteTable.addAssociation('customRtbAssociation', attachment);
tgw.defaultRouteTable.enablePropagation('customRtbPropagation', attachment);
