...
export interface PoolOptions {
  ...
  */
  ...
  /**
   * source resource
   * @default - no source resource
   * */
  readonly sourceResource?: IResource;
}
...
export class IpamPool extends Resource implements IIpamPool {
  ...
  private static getSourceResource(source?: IResource): CfnIPAMPool.SourceResourceProperty | undefined {
    if (source == null) return undefined;
    return {
      resourceId: source.node.id,
      resourceOwner: source.stack.account,
      resourceRegion: source.stack.region,
      resourceType: 'vpc',
    };
  }
  ...
  constructor(scope: Construct, id: string, props: IpamPoolProps) {
    ...
    this._ipamPool = new CfnIPAMPool(this, id, {
      ...
      sourceResource: IpamPool.getSourceResource(props.sourceResource),
    });
