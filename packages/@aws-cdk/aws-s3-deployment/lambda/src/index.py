...
def handler(event, context):
    ...
    try:
        ...
        try:
            ...
            delete              = props.get('Delete', 'true') == 'true'
        ...
        if request_type == "Update" or request_type == "Create":
            s3_deploy(s3_source_zips, s3_dest, user_metadata, system_metadata, delete)
...
def s3_deploy(s3_source_zips, s3_dest, user_metadata, system_metadata, delete):
