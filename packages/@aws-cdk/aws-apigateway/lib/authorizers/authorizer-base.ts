...
const AUTHORIZER_BASE_SYMBOL = Symbol.for('@aws-cdk/apigateway.AuthorizerBase');

/**
 * Base class for all custom authorizers
 */
export abstract class AuthorizerBase extends Resource implements IAuthorizer {
  ...
  public static _isAuthorizer(x: any): x is AuthorizerBase {
    return x !== null && typeof(x) === 'object' && AUTHORIZER_BASE_SYMBOL in x;
  }
  ...
  constructor(scope: Construct, id: string, props?: ResourceProps) {
    ...
    Object.defineProperty(this, AUTHORIZER_BASE_SYMBOL, { value: true });
  }
