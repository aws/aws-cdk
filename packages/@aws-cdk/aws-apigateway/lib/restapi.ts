...
import { Aws, CfnOutput, Construct,  IResource as IResourceBase, Resource, Stack } from '@aws-cdk/core';
...
export class RestApi extends Resource implements IRestApi {
  ...
  private configureCloudWatchRole(apiResource: CfnRestApi) {
    const role = new iam.Role(this, 'CloudWatchRole', {
      ...
      description: `Generated by the aws-apigateway module for stack: ${Aws.STACK_NAME}.`,
