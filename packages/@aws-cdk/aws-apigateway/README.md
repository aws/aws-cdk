...
You can find a full working example [here](test/authorizers/integ.token-authorizer.lit.ts).
...
You can find a full working example [here](test/authorizers/integ.request-authorizer.lit.ts).
