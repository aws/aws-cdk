...
If you need custom logic for setting up the AWS::EC2::VPC resource, you can provide your own
`IVpcResourceCreator` implementation which returns the `CfnVPC` resource.
