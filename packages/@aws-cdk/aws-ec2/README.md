...
When using `ec2.CloudFormationInit.fromElements` the order you add the elements has no bearing on the execution order. The `cfn-init` helper script processes them in the following order: 
