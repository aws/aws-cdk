...
class VolumeBase extends core_1.Resource {
    ...
    calculateResourceTagValue(constructs) {
        return helpers_internal_1.md5hash(constructs.map(c => core_1.Names.uniqueId(c)).join(''));
    }
}
/**
