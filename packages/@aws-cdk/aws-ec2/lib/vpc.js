    ...
    createSubnets() {
        ...
        this.subnetConfiguration.forEach((configuration) => (this.availabilityZones.forEach((az, index) => {
            requestedSubnets.push({
                availabilityZone: az,
                subnetConstructId: util_1.subnetId(configuration.name, index),
                configuration,
            });
        })));
...
Vpc.DEFAULT_SUBNETS = [
    ...
    },
    {
        ...
        name: util_1.defaultSubnetName(SubnetType.PRIVATE_WITH_EGRESS),
    },
];
/**
