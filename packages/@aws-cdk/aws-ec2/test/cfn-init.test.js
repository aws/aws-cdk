    ...
    Resource: [
        {
            'Fn::Join': ['', [
                    ...
                    { Ref: 'AWS::Partition' },
                    ':s3:::',
                    { Ref: util_1.stringLike(/AssetParameter.*S3Bucket.*/) },
                ]],
        },
        {
            'Fn::Join': ['', [
        ...
        expectMetadataLike({
                        ...
                        '/etc/fun.js': {
                            source: {
                                'Fn::Join': ['', [
                                        ...
                                        { Ref: 'AWS::URLSuffix' },
                                        '/',
                                        { Ref: util_1.stringLike(/AssetParameters.*/) },
                                        '/',
                                        { 'Fn::Select': [0, { 'Fn::Split': ['||', { Ref: util_1.stringLike(/AssetParameters.*/) }] }] },
                                        { 'Fn::Select': [1, { 'Fn::Split': ['||', { Ref: util_1.stringLike(/AssetParameters.*/) }] }] },
                                    ]],
                            },
                        },
                    },
            ...
            'AWS::CloudFormation::Authentication': {
                S3AccessCreds: {
                    ...
                    buckets: [
                        { Ref: util_1.stringLike(/AssetParameters.*S3Bucket.*/) },
                    ],
                },
            },
        });
