...
/*
 * Test creating a cluster with engine version 1.5.0.0 and associated parameter group with family neptune1.5
 *
...
const clusterParameterGroup = new ClusterParameterGroup(stack, 'Params', {
  ...
  family: ParameterGroupFamily.NEPTUNE_1_5,
  parameters: {
...
const cluster = new DatabaseCluster(stack, 'Database', {
  ...
  engineVersion: EngineVersion.V1_5_0_0,
