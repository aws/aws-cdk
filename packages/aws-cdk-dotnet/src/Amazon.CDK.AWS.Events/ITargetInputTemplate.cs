...
namespace Amazon.CDK.AWS.Events
{
    ...
    [JsiiInterface(typeof(ITargetInputTemplate), "@aws-cdk/aws-events.TargetInputTemplate")]
    public interface ITargetInputTemplate
    {
        /// <summary>
        ...
        IDictionary<string, string> PathsMap
        {
            get;
            set;
        }
