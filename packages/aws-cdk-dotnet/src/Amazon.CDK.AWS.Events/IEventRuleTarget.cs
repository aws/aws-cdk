...
{
    [JsiiInterface(typeof(IEventRuleTarget), "@aws-cdk/aws-events.EventRuleTarget")]
    public interface IEventRuleTarget
    {
        ...
        IEcsParametersProperty EcsParameters
        {
            get;
            set;
        }
        ...
        IKinesisParametersProperty KinesisParameters
        {
            get;
            set;
        }
        ...
        IRunCommandParametersProperty RunCommandParameters
        {
            get;
            set;
        }
