...
namespace Amazon.CDK.AWS.Events
{
    ...
    [JsiiInterfaceProxy(typeof(IEventPattern), "@aws-cdk/aws-events.EventPattern")]
    internal class EventPatternProxy : DeputyBase, IEventPattern
    {
        private EventPatternProxy(ByRefValue reference): base(reference)
        {
        }

        /// <summary>By default, this is set to 0 (zero) in all events.</summary>
        [JsiiProperty("version", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"primitive\":\"string\"}},\"optional\":true}")]
        ...
        /// </summary>
        [JsiiProperty("id", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"primitive\":\"string\"}},\"optional\":true}")]
        ...
        /// </summary>
        [JsiiProperty("detailType", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"primitive\":\"string\"}},\"optional\":true}")]
        ...
        [JsiiProperty("source", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"primitive\":\"string\"}},\"optional\":true}")]
        ...
        [JsiiProperty("account", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"primitive\":\"string\"}},\"optional\":true}")]
        ...
        /// </summary>
        [JsiiProperty("time", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"primitive\":\"string\"}},\"optional\":true}")]
        ...
        [JsiiProperty("region", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"primitive\":\"string\"}},\"optional\":true}")]
        ...
        /// resource ARNs.
        /// </summary>
        [JsiiProperty("resources", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"@aws-cdk/cdk.Arn\"}},\"optional\":true}")]
        public virtual Arn[] Resources
        {
        ...
        /// </summary>
        [JsiiProperty("detail", "{\"primitive\":\"any\",\"optional\":true}")]
