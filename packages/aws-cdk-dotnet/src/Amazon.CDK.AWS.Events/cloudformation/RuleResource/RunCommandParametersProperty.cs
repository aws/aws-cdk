...
namespace Amazon.CDK.AWS.Events.cloudformation.RuleResource
{
    ...
    public class RunCommandParametersProperty : DeputyBase, IRunCommandParametersProperty
    {
        ...
        [JsiiProperty("runCommandTargets", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-events.cloudformation.RuleResource.RunCommandTargetProperty\"}]}}}}]}}", true)]
