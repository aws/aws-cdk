...
namespace Amazon.CDK.AWS.ECS.cloudformation.TaskDefinitionResource
{
    ...
    public class KernelCapabilitiesProperty : DeputyBase, IKernelCapabilitiesProperty
    {
        ...
        [JsiiProperty("add", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}}}]},\"optional\":true}", true)]
        public object Add
        {
            get;
            set;
        ...
        [JsiiProperty("drop", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}}}]},\"optional\":true}", true)]
        public object Drop
        {
            get;
            set;
