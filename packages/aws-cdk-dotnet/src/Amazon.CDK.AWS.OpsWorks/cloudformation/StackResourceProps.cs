...
namespace Amazon.CDK.AWS.OpsWorks.cloudformation
{
    ...
    public class StackResourceProps : DeputyBase, IStackResourceProps
    {
        ...
        [JsiiProperty("defaultInstanceProfileArn", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}", true)]
        public object DefaultInstanceProfileArn
        {
            get;
            set;
        }
        ...
        [JsiiProperty("stackName", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}", true)]
        public object StackName
        {
            get;
            set;
        }
        ...
        [JsiiProperty("chefConfiguration", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-opsworks.cloudformation.StackResource.ChefConfigurationProperty\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("cloneAppIds", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}}}]},\"optional\":true}", true)]
        public object CloneAppIds
        {
            get;
            set;
        }
        ...
        [JsiiProperty("clonePermissions", "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("configurationManager", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-opsworks.cloudformation.StackResource.StackConfigurationManagerProperty\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("customCookbooksSource", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-opsworks.cloudformation.StackResource.SourceProperty\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("defaultAvailabilityZone", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object DefaultAvailabilityZone
        {
            get;
            set;
        }
        ...
        [JsiiProperty("defaultOs", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object DefaultOs
        {
            get;
            set;
        }
        ...
        [JsiiProperty("defaultRootDeviceType", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object DefaultRootDeviceType
        {
            get;
            set;
        }
        ...
        [JsiiProperty("defaultSshKeyName", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object DefaultSshKeyName
        {
            get;
            set;
        }
        ...
        [JsiiProperty("defaultSubnetId", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object DefaultSubnetId
        {
            get;
            set;
        }
        ...
        [JsiiProperty("ecsClusterArn", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object EcsClusterArn
        {
            get;
            set;
        }
        ...
        [JsiiProperty("elasticIps", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-opsworks.cloudformation.StackResource.ElasticIpProperty\"}]}}}}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("hostnameTheme", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object HostnameTheme
        {
            get;
            set;
        }
        ...
        [JsiiProperty("rdsDbInstances", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-opsworks.cloudformation.StackResource.RdsDbInstanceProperty\"}]}}}}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("sourceStackId", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object SourceStackId
        {
            get;
            set;
        }
        ...
        [JsiiProperty("useCustomCookbooks", "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("useOpsworksSecurityGroups", "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
