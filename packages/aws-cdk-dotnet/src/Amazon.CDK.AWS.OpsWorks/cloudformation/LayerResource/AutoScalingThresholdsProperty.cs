...
namespace Amazon.CDK.AWS.OpsWorks.cloudformation.LayerResource
{
    ...
    public class AutoScalingThresholdsProperty : DeputyBase, IAutoScalingThresholdsProperty
    {
        ...
        [JsiiProperty("cpuThreshold", "{\"union\":{\"types\":[{\"primitive\":\"number\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object CpuThreshold
        {
            get;
            set;
        }
        ...
        [JsiiProperty("ignoreMetricsTime", "{\"union\":{\"types\":[{\"primitive\":\"number\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object IgnoreMetricsTime
        {
            get;
            set;
        }
        ...
        [JsiiProperty("loadThreshold", "{\"union\":{\"types\":[{\"primitive\":\"number\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object LoadThreshold
        {
            get;
            set;
        }
        ...
        [JsiiProperty("memoryThreshold", "{\"union\":{\"types\":[{\"primitive\":\"number\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object MemoryThreshold
        {
            get;
            set;
        }
        ...
        [JsiiProperty("thresholdsWaitTime", "{\"union\":{\"types\":[{\"primitive\":\"number\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object ThresholdsWaitTime
        {
            get;
            set;
        }
