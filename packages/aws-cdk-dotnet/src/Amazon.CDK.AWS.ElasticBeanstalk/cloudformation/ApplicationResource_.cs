...
namespace Amazon.CDK.AWS.ElasticBeanstalk.cloudformation
{
    ...
    [JsiiClass(typeof(ApplicationResource_), "@aws-cdk/aws-elasticbeanstalk.cloudformation.ApplicationResource", "[{\"name\":\"parent\",\"type\":{\"fqn\":\"@aws-cdk/cdk.Construct\"}},{\"name\":\"name\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"properties\",\"type\":{\"fqn\":\"@aws-cdk/aws-elasticbeanstalk.cloudformation.ApplicationResourceProps\",\"optional\":true}}]")]
