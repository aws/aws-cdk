...
namespace Amazon.CDK.AWS.ElasticBeanstalk.cloudformation.ApplicationResource
{
    ...
    [JsiiInterface(typeof(IApplicationVersionLifecycleConfigProperty), "@aws-cdk/aws-elasticbeanstalk.cloudformation.ApplicationResource.ApplicationVersionLifecycleConfigProperty")]
    public interface IApplicationVersionLifecycleConfigProperty
    {
