...
namespace Amazon.CDK.AWS.DataPipeline.cloudformation.PipelineResource
{
    ...
    [JsiiInterface(typeof(IParameterObjectProperty), "@aws-cdk/aws-datapipeline.cloudformation.PipelineResource.ParameterObjectProperty")]
    public interface IParameterObjectProperty
    {
