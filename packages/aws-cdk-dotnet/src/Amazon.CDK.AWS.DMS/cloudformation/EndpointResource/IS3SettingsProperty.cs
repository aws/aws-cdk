...
namespace Amazon.CDK.AWS.DMS.cloudformation.EndpointResource
{
    ...
    [JsiiInterface(typeof(IS3SettingsProperty), "@aws-cdk/aws-dms.cloudformation.EndpointResource.S3SettingsProperty")]
    public interface IS3SettingsProperty
    {
