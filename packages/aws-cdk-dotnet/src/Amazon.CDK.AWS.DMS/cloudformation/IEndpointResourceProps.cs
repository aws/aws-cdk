...
namespace Amazon.CDK.AWS.DMS.cloudformation
{
    ...
    [JsiiInterface(typeof(IEndpointResourceProps), "@aws-cdk/aws-dms.cloudformation.EndpointResourceProps")]
    public interface IEndpointResourceProps
    {
        ...
        object ExtraConnectionAttributes
        {
            get;
            set;
        }
