...
namespace Amazon.CDK.AWS.DMS.cloudformation
{
    ...
    [JsiiInterface(typeof(IReplicationInstanceResourceProps), "@aws-cdk/aws-dms.cloudformation.ReplicationInstanceResourceProps")]
    public interface IReplicationInstanceResourceProps
    {
        ...
        object ReplicationInstanceClass
        {
            get;
            set;
        }
        ...
        object ReplicationInstanceIdentifier
        {
            get;
            set;
        }
