...
namespace Amazon.CDK.AWS.Redshift.cloudformation
{
    ...
    [JsiiInterface(typeof(IClusterResourceProps), "@aws-cdk/aws-redshift.cloudformation.ClusterResourceProps")]
    public interface IClusterResourceProps
    {
        ...
        object AutomatedSnapshotRetentionPeriod
        {
            get;
            set;
        }
        ...
        object ClusterParameterGroupName
        {
            get;
            set;
        }
        ...
        object HsmClientCertificateIdentifier
        {
            get;
            set;
        }
        ...
        object HsmConfigurationIdentifier
        {
            get;
            set;
        }
        ...
        object SnapshotClusterIdentifier
        {
            get;
            set;
        }
