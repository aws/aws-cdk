...
namespace Amazon.CDK.AWS.Elasticsearch.cloudformation.DomainResource
{
    ...
    public class VPCOptionsProperty : DeputyBase, IVPCOptionsProperty
    {
        ...
        [JsiiProperty("subnetIds", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}}}]},\"optional\":true}", true)]
