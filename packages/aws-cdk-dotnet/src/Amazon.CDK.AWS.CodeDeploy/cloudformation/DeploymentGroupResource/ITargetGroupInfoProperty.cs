...
namespace Amazon.CDK.AWS.CodeDeploy.cloudformation.DeploymentGroupResource
{
    ...
    [JsiiInterface(typeof(ITargetGroupInfoProperty), "@aws-cdk/aws-codedeploy.cloudformation.DeploymentGroupResource.TargetGroupInfoProperty")]
    public interface ITargetGroupInfoProperty
    {
