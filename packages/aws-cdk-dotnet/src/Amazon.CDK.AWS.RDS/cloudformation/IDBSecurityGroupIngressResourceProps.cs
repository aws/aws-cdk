...
namespace Amazon.CDK.AWS.RDS.cloudformation
{
    ...
    [JsiiInterface(typeof(IDBSecurityGroupIngressResourceProps), "@aws-cdk/aws-rds.cloudformation.DBSecurityGroupIngressResourceProps")]
    public interface IDBSecurityGroupIngressResourceProps
    {
