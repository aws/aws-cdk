...
namespace Amazon.CDK.AWS.Cognito.cloudformation.UserPoolResource
{
    ...
    [JsiiInterface(typeof(IPasswordPolicyProperty), "@aws-cdk/aws-cognito.cloudformation.UserPoolResource.PasswordPolicyProperty")]
    public interface IPasswordPolicyProperty
    {
