...
namespace Amazon.CDK.AWS.Cognito.cloudformation
{
    ...
    [JsiiInterface(typeof(IUserPoolResourceProps), "@aws-cdk/aws-cognito.cloudformation.UserPoolResourceProps")]
    public interface IUserPoolResourceProps
    {
        ...
        object EmailVerificationMessage
        {
            get;
            set;
        }
        ...
        object EmailVerificationSubject
        {
            get;
            set;
        }
        ...
        object SmsAuthenticationMessage
        {
            get;
            set;
        }
