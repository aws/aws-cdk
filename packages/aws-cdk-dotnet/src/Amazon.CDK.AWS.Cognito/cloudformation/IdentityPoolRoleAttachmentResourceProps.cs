...
namespace Amazon.CDK.AWS.Cognito.cloudformation
{
    ...
    public class IdentityPoolRoleAttachmentResourceProps : DeputyBase, IIdentityPoolRoleAttachmentResourceProps
    {
        ...
        [JsiiProperty("identityPoolId", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}", true)]
        public object IdentityPoolId
        {
            get;
            set;
        }
        ...
        [JsiiProperty("roleMappings", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"map\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-cognito.cloudformation.IdentityPoolRoleAttachmentResource.RoleMappingProperty\"}]}}}}]},\"optional\":true}", true)]
        public object RoleMappings
        {
            get;
            set;
        }
        ...
        [JsiiProperty("roles", "{\"union\":{\"types\":[{\"primitive\":\"json\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object Roles
        {
            get;
            set;
