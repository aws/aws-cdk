...
namespace Amazon.CDK.AWS.EMR.cloudformation.InstanceGroupConfigResource
{
    ...
    public class ScalingRuleProperty : DeputyBase, Amazon.CDK.AWS.EMR.cloudformation.InstanceGroupConfigResource.IScalingRuleProperty
    {
        ...
        [JsiiProperty("action", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-emr.cloudformation.InstanceGroupConfigResource.ScalingActionProperty\"}]}}", true)]
        ...
        [JsiiProperty("trigger", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-emr.cloudformation.InstanceGroupConfigResource.ScalingTriggerProperty\"}]}}", true)]
