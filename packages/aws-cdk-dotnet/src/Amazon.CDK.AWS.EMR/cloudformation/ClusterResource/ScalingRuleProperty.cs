...
namespace Amazon.CDK.AWS.EMR.cloudformation.ClusterResource
{
    ...
    public class ScalingRuleProperty : DeputyBase, Amazon.CDK.AWS.EMR.cloudformation.ClusterResource.IScalingRuleProperty
    {
        ...
        [JsiiProperty("action", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-emr.cloudformation.ClusterResource.ScalingActionProperty\"}]}}", true)]
        ...
        [JsiiProperty("trigger", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-emr.cloudformation.ClusterResource.ScalingTriggerProperty\"}]}}", true)]
