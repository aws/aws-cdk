...
namespace Amazon.CDK.AWS.ServiceCatalog.cloudformation
{
    ...
    [JsiiInterface(typeof(ICloudFormationProvisionedProductResourceProps), "@aws-cdk/aws-servicecatalog.cloudformation.CloudFormationProvisionedProductResourceProps")]
    public interface ICloudFormationProvisionedProductResourceProps
    {
        ...
        object ProvisioningArtifactName
        {
            get;
            set;
        }
