...
namespace Amazon.CDK.AWS.ServiceCatalog.cloudformation
{
    ...
    [JsiiInterface(typeof(ILaunchTemplateConstraintResourceProps), "@aws-cdk/aws-servicecatalog.cloudformation.LaunchTemplateConstraintResourceProps")]
    public interface ILaunchTemplateConstraintResourceProps
    {
