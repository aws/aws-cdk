...
namespace Amazon.CDK.AWS.ServiceCatalog.cloudformation
{
    ...
    [JsiiInterfaceProxy(typeof(ILaunchNotificationConstraintResourceProps), "@aws-cdk/aws-servicecatalog.cloudformation.LaunchNotificationConstraintResourceProps")]
    internal class LaunchNotificationConstraintResourcePropsProxy : DeputyBase, ILaunchNotificationConstraintResourceProps
    {
        private LaunchNotificationConstraintResourcePropsProxy(ByRefValue reference): base(reference)
        {
        }
