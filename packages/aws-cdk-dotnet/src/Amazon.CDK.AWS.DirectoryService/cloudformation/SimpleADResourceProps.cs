...
namespace Amazon.CDK.AWS.DirectoryService.cloudformation
{
    ...
    public class SimpleADResourceProps : DeputyBase, ISimpleADResourceProps
    {
        ...
        [JsiiProperty("simpleAdName", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}", true)]
        public object SimpleAdName
        {
            get;
            set;
        }
        ...
        [JsiiProperty("size", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}", true)]
        public object Size
        {
            get;
            set;
        ...
        [JsiiProperty("vpcSettings", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-directoryservice.cloudformation.SimpleADResource.VpcSettingsProperty\"}]}}", true)]
