...
namespace Amazon.CDK.AWS.IAM.cloudformation
{
    ...
    public class RoleResourceProps : DeputyBase, IRoleResourceProps
    {
        ...
        [JsiiProperty("assumeRolePolicyDocument", "{\"union\":{\"types\":[{\"primitive\":\"json\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}", true)]
        ...
        [JsiiProperty("maxSessionDuration", "{\"union\":{\"types\":[{\"primitive\":\"number\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("policies", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-iam.cloudformation.RoleResource.PolicyProperty\"}]}}}}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("roleName", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
