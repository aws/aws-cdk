...
namespace Amazon.CDK.AWS.IAM
{
    ...
    [JsiiInterfaceProxy(typeof(IIPrincipal), "@aws-cdk/aws-iam.IPrincipal")]
    internal class IPrincipalProxy : DeputyBase, IIPrincipal
    {
        private IPrincipalProxy(ByRefValue reference): base(reference)
        {
        }
