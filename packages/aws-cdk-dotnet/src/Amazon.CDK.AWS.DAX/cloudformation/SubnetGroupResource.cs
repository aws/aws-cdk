...
namespace Amazon.CDK.AWS.DAX.cloudformation
{
    ...
    [JsiiClass(typeof(SubnetGroupResource), "@aws-cdk/aws-dax.cloudformation.SubnetGroupResource", "[{\"name\":\"parent\",\"type\":{\"fqn\":\"@aws-cdk/cdk.Construct\"}},{\"name\":\"name\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"properties\",\"type\":{\"fqn\":\"@aws-cdk/aws-dax.cloudformation.SubnetGroupResourceProps\"}}]")]
