...
{
    public class S3BucketBuildArtifactsProps : DeputyBase, IS3BucketBuildArtifactsProps
    {
        ...
        [JsiiProperty("includeBuildID", "{\"primitive\":\"boolean\",\"optional\":true}", true)]
        public bool? IncludeBuildID
        {
            get;
            set;
        }
        ...
        [JsiiProperty("packageZip", "{\"primitive\":\"boolean\",\"optional\":true}", true)]
