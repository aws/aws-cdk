...
namespace Amazon.CDK.AWS.Glue.cloudformation.PartitionResource
{
    ...
    [JsiiInterfaceProxy(typeof(IStorageDescriptorProperty), "@aws-cdk/aws-glue.cloudformation.PartitionResource.StorageDescriptorProperty")]
    internal class StorageDescriptorPropertyProxy : DeputyBase, Amazon.CDK.AWS.Glue.cloudformation.PartitionResource.IStorageDescriptorProperty
    {
