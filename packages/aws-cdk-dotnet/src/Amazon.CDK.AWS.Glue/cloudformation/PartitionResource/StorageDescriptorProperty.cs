...
namespace Amazon.CDK.AWS.Glue.cloudformation.PartitionResource
{
    ...
    public class StorageDescriptorProperty : DeputyBase, Amazon.CDK.AWS.Glue.cloudformation.PartitionResource.IStorageDescriptorProperty
    {
        ...
        [JsiiProperty("columns", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-glue.cloudformation.PartitionResource.ColumnProperty\"}]}}}}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("serdeInfo", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-glue.cloudformation.PartitionResource.SerdeInfoProperty\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("skewedInfo", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-glue.cloudformation.PartitionResource.SkewedInfoProperty\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("sortColumns", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-glue.cloudformation.PartitionResource.OrderProperty\"}]}}}}]},\"optional\":true}", true)]
