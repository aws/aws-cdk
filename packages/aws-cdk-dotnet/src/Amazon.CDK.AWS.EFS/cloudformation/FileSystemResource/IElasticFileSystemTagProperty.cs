...
namespace Amazon.CDK.AWS.EFS.cloudformation.FileSystemResource
{
    ...
    [JsiiInterface(typeof(IElasticFileSystemTagProperty), "@aws-cdk/aws-efs.cloudformation.FileSystemResource.ElasticFileSystemTagProperty")]
    public interface IElasticFileSystemTagProperty
    {
