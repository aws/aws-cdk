...
namespace Amazon.CDK.AWS.EFS.cloudformation
{
    ...
    [JsiiInterface(typeof(IFileSystemResourceProps), "@aws-cdk/aws-efs.cloudformation.FileSystemResourceProps")]
    public interface IFileSystemResourceProps
    {
