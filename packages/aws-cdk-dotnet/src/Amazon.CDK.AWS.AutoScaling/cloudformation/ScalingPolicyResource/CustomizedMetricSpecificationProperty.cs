...
namespace Amazon.CDK.AWS.AutoScaling.cloudformation.ScalingPolicyResource
{
    ...
    public class CustomizedMetricSpecificationProperty : DeputyBase, ICustomizedMetricSpecificationProperty
    {
        ...
        [JsiiProperty("dimensions", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-autoscaling.cloudformation.ScalingPolicyResource.MetricDimensionProperty\"}]}}}}]},\"optional\":true}", true)]
