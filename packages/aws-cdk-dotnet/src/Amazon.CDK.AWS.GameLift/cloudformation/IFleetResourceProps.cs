...
namespace Amazon.CDK.AWS.GameLift.cloudformation
{
    ...
    [JsiiInterface(typeof(IFleetResourceProps), "@aws-cdk/aws-gamelift.cloudformation.FleetResourceProps")]
    public interface IFleetResourceProps
    {
