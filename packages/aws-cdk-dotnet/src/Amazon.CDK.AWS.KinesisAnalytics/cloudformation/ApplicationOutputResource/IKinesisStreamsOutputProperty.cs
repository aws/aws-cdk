...
namespace Amazon.CDK.AWS.KinesisAnalytics.cloudformation.ApplicationOutputResource
{
    ...
    [JsiiInterface(typeof(IKinesisStreamsOutputProperty), "@aws-cdk/aws-kinesisanalytics.cloudformation.ApplicationOutputResource.KinesisStreamsOutputProperty")]
    public interface IKinesisStreamsOutputProperty
    {
