...
namespace Amazon.CDK.AWS.CodePipeline.cloudformation.PipelineResource
{
    ...
    [JsiiInterface(typeof(IBlockerDeclarationProperty), "@aws-cdk/aws-codepipeline.cloudformation.PipelineResource.BlockerDeclarationProperty")]
    public interface IBlockerDeclarationProperty
    {
