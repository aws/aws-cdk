...
namespace Amazon.CDK.AWS.Batch.cloudformation.ComputeEnvironmentResource
{
    ...
    [JsiiInterface(typeof(IComputeResourcesProperty), "@aws-cdk/aws-batch.cloudformation.ComputeEnvironmentResource.ComputeResourcesProperty")]
    public interface IComputeResourcesProperty
    {
