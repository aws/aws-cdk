...
namespace Amazon.CDK.AWS.SSM.cloudformation
{
    ...
    public class ParameterResourceProps : DeputyBase, IParameterResourceProps
    {
        ...
        [JsiiProperty("allowedPattern", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object AllowedPattern
        {
            get;
            set;
        }
        ...
        [JsiiProperty("parameterName", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
