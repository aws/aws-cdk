...
namespace Amazon.CDK.AWS.ApplicationAutoScaling.cloudformation
{
    ...
    public class ScalableTargetResourceProps : DeputyBase, IScalableTargetResourceProps
    {
        ...
        [JsiiProperty("scheduledActions", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-applicationautoscaling.cloudformation.ScalableTargetResource.ScheduledActionProperty\"}]}}}}]},\"optional\":true}", true)]
