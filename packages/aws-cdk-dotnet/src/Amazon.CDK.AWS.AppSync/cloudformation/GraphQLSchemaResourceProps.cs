...
namespace Amazon.CDK.AWS.AppSync.cloudformation
{
    ...
    public class GraphQLSchemaResourceProps : DeputyBase, IGraphQLSchemaResourceProps
    {
        ...
        [JsiiProperty("definition", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("definitionS3Location", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
