...
namespace Amazon.CDK.AWS.S3
{
    ...
    public class LifecycleRule : DeputyBase, ILifecycleRule
    {
        /// <summary>A unique identifier for this rule. The value cannot be more than 255 characters.</summary>
        [JsiiProperty("id", "{\"primitive\":\"string\",\"optional\":true}", true)]
        public string Id
        {
            get;
            set;
        ...
        [JsiiProperty("abortIncompleteMultipartUploadAfterDays", "{\"primitive\":\"number\",\"optional\":true}", true)]
        public double? AbortIncompleteMultipartUploadAfterDays
        {
            get;
            set;
        }
        ...
        [JsiiProperty("expirationDate", "{\"primitive\":\"date\",\"optional\":true}", true)]
        ...
        [JsiiProperty("expirationInDays", "{\"primitive\":\"number\",\"optional\":true}", true)]
        ...
        [JsiiProperty("noncurrentVersionExpirationInDays", "{\"primitive\":\"number\",\"optional\":true}", true)]
        public double? NoncurrentVersionExpirationInDays
        {
            get;
            set;
        }
        ...
        /// </summary>
        [JsiiProperty("noncurrentVersionTransitions", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"@aws-cdk/aws-s3.NoncurrentVersionTransition\"}},\"optional\":true}", true)]
        public INoncurrentVersionTransition[] NoncurrentVersionTransitions
        {
            get;
            set;
        }
        ...
        [JsiiProperty("transitions", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"@aws-cdk/aws-s3.Transition\"}},\"optional\":true}", true)]
        ...
        /// <remarks>default: Rule applies to all objects</remarks>
        [JsiiProperty("tagFilters", "{\"collection\":{\"kind\":\"map\",\"elementtype\":{\"primitive\":\"any\"}},\"optional\":true}", true)]
        public IDictionary<string, object> TagFilters
        {
            get;
            set;
        }
