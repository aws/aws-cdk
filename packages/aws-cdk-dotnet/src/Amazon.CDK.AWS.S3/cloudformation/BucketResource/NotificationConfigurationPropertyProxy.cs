...
namespace Amazon.CDK.AWS.S3.cloudformation.BucketResource
{
    ...
    [JsiiInterfaceProxy(typeof(INotificationConfigurationProperty), "@aws-cdk/aws-s3.cloudformation.BucketResource.NotificationConfigurationProperty")]
    internal class NotificationConfigurationPropertyProxy : DeputyBase, INotificationConfigurationProperty
    {
        ...
        public virtual object LambdaConfigurations
        {
        ...
        public virtual object QueueConfigurations
        {
            get => GetInstanceProperty<object>();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual object TopicConfigurations
        {
            get => GetInstanceProperty<object>();
            set => SetInstanceProperty(value);
        }
