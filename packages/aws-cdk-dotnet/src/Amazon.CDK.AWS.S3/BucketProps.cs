...
{
    public class BucketProps : DeputyBase, IBucketProps
    {
        /// <summary>
        ...
        [JsiiProperty("encryption", "{\"fqn\":\"@aws-cdk/aws-s3.BucketEncryption\",\"optional\":true}", true)]
        ...
        [JsiiProperty("bucketName", "{\"primitive\":\"string\",\"optional\":true}", true)]
        ...
        [JsiiProperty("removalPolicy", "{\"fqn\":\"@aws-cdk/cdk.RemovalPolicy\",\"optional\":true}", true)]
        ...
        /// to addToPolicy.
        /// </remarks>
        [JsiiProperty("policy", "{\"fqn\":\"@aws-cdk/aws-s3.BucketPolicy\",\"optional\":true}", true)]
        ...
        [JsiiProperty("versioned", "{\"primitive\":\"boolean\",\"optional\":true}", true)]
        ...
        [JsiiProperty("lifecycleRules", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"@aws-cdk/aws-s3.LifecycleRule\"}},\"optional\":true}", true)]
        public ILifecycleRule[] LifecycleRules
        {
            get;
            set;
        }
