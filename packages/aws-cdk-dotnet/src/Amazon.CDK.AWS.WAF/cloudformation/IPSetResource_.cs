...
namespace Amazon.CDK.AWS.WAF.cloudformation
{
    ...
    [JsiiClass(typeof(IPSetResource_), "@aws-cdk/aws-waf.cloudformation.IPSetResource", "[{\"name\":\"parent\",\"type\":{\"fqn\":\"@aws-cdk/cdk.Construct\"}},{\"name\":\"name\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"properties\",\"type\":{\"fqn\":\"@aws-cdk/aws-waf.cloudformation.IPSetResourceProps\"}}]")]
