...
namespace Amazon.CDK.AWS.WAF.cloudformation
{
    ...
    [JsiiClass(typeof(ByteMatchSetResource_), "@aws-cdk/aws-waf.cloudformation.ByteMatchSetResource", "[{\"name\":\"parent\",\"type\":{\"fqn\":\"@aws-cdk/cdk.Construct\"}},{\"name\":\"name\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"properties\",\"type\":{\"fqn\":\"@aws-cdk/aws-waf.cloudformation.ByteMatchSetResourceProps\"}}]")]
