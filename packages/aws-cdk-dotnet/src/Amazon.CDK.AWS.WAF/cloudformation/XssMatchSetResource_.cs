...
namespace Amazon.CDK.AWS.WAF.cloudformation
{
    ...
    [JsiiClass(typeof(XssMatchSetResource_), "@aws-cdk/aws-waf.cloudformation.XssMatchSetResource", "[{\"name\":\"parent\",\"type\":{\"fqn\":\"@aws-cdk/cdk.Construct\"}},{\"name\":\"name\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"properties\",\"type\":{\"fqn\":\"@aws-cdk/aws-waf.cloudformation.XssMatchSetResourceProps\"}}]")]
