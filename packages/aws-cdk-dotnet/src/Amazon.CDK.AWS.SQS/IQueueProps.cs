...
namespace Amazon.CDK.AWS.SQS
{
    ...
    [JsiiInterface(typeof(IQueueProps), "@aws-cdk/aws-sqs.QueueProps")]
    public interface IQueueProps
    {
        ...
        double? ReceiveMessageWaitTimeSec
        {
            get;
            set;
        }
        ...
        [JsiiProperty("deadLetterQueue", "{\"fqn\":\"@aws-cdk/aws-sqs.DeadLetterQueue\",\"optional\":true}")]
        ...
        [JsiiProperty("encryption", "{\"fqn\":\"@aws-cdk/aws-sqs.QueueEncryption\",\"optional\":true}")]
        ...
        [JsiiProperty("encryptionMasterKey", "{\"fqn\":\"@aws-cdk/aws-kms.EncryptionKeyRef\",\"optional\":true}")]
        EncryptionKeyRef EncryptionMasterKey
        {
            get;
            set;
        }
