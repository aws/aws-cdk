...
namespace Amazon.CDK.AWS.SQS
{
    ...
    [JsiiInterfaceProxy(typeof(IQueueProps), "@aws-cdk/aws-sqs.QueueProps")]
    internal class QueuePropsProxy : DeputyBase, IQueueProps
    {
        ...
        {
            get => GetInstanceProperty<IDeadLetterQueue>();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual QueueEncryption Encryption
        {
            get => GetInstanceProperty<QueueEncryption>();
            set => SetInstanceProperty(value);
        }
