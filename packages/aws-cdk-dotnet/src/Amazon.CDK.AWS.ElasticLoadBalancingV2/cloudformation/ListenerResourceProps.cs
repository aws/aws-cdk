...
namespace Amazon.CDK.AWS.ElasticLoadBalancingV2.cloudformation
{
    ...
    public class ListenerResourceProps : DeputyBase, IListenerResourceProps
    {
        ...
        [JsiiProperty("defaultActions", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/aws-elasticloadbalancingv2.cloudformation.ListenerResource.ActionProperty\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}}}]}}", true)]
        ...
        [JsiiProperty("loadBalancerArn", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}", true)]
        public object LoadBalancerArn
        {
            get;
            set;
        }
        ...
        [JsiiProperty("certificates", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-elasticloadbalancingv2.cloudformation.ListenerResource.CertificateProperty\"}]}}}}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("sslPolicy", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object SslPolicy
        {
            get;
            set;
        }
