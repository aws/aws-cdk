...
namespace Amazon.CDK.AWS.ElasticLoadBalancingV2.cloudformation
{
    ...
    [JsiiInterface(typeof(IListenerCertificateResourceProps), "@aws-cdk/aws-elasticloadbalancingv2.cloudformation.ListenerCertificateResourceProps")]
    public interface IListenerCertificateResourceProps
    {
