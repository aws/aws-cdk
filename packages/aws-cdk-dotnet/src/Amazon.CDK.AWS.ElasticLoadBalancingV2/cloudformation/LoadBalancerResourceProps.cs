...
namespace Amazon.CDK.AWS.ElasticLoadBalancingV2.cloudformation
{
    ...
    public class LoadBalancerResourceProps : DeputyBase, ILoadBalancerResourceProps
    {
        ...
        [JsiiProperty("ipAddressType", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object IpAddressType
        {
            get;
            set;
        }
        ...
        [JsiiProperty("loadBalancerAttributes", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-elasticloadbalancingv2.cloudformation.LoadBalancerResource.LoadBalancerAttributeProperty\"}]}}}}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("subnetMappings", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-elasticloadbalancingv2.cloudformation.LoadBalancerResource.SubnetMappingProperty\"}]}}}}]},\"optional\":true}", true)]
