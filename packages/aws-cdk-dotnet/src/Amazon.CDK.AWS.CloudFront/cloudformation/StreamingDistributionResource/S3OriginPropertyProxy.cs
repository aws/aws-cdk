...
namespace Amazon.CDK.AWS.CloudFront.cloudformation.StreamingDistributionResource
{
    ...
    [JsiiInterfaceProxy(typeof(IS3OriginProperty), "@aws-cdk/aws-cloudfront.cloudformation.StreamingDistributionResource.S3OriginProperty")]
    internal class S3OriginPropertyProxy : DeputyBase, IS3OriginProperty
    {
        private S3OriginPropertyProxy(ByRefValue reference): base(reference)
        {
        }
