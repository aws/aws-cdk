...
namespace Amazon.CDK.AWS.CloudFront.cloudformation.DistributionResource
{
    ...
    [JsiiInterface(typeof(ICacheBehaviorProperty), "@aws-cdk/aws-cloudfront.cloudformation.DistributionResource.CacheBehaviorProperty")]
    public interface ICacheBehaviorProperty
    {
