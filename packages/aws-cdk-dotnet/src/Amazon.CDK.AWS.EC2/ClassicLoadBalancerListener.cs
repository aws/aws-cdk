...
namespace Amazon.CDK.AWS.EC2
{
    ...
    public class ClassicLoadBalancerListener : DeputyBase, IClassicLoadBalancerListener
    {
        ...
        /// </summary>
        [JsiiProperty("externalProtocol", "{\"fqn\":\"@aws-cdk/aws-ec2.LoadBalancingProtocol\",\"optional\":true}", true)]
        public LoadBalancingProtocol ExternalProtocol
        {
            get;
            set;
        }
        ...
        /// </summary>
        [JsiiProperty("internalProtocol", "{\"fqn\":\"@aws-cdk/aws-ec2.LoadBalancingProtocol\",\"optional\":true}", true)]
        public LoadBalancingProtocol InternalProtocol
        {
            get;
            set;
        }
        ...
        [JsiiProperty("sslCertificateId", "{\"fqn\":\"@aws-cdk/cdk.Arn\",\"optional\":true}", true)]
        ...
        [JsiiProperty("allowConnectionsFrom", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"@aws-cdk/aws-ec2.IConnectable\"}},\"optional\":true}", true)]
