...
{
    public class ConnectionRule : DeputyBase, IConnectionRule
    {
        /// <summary>
        ...
        [JsiiProperty("protocol", "{\"primitive\":\"string\",\"optional\":true}", true)]
        ...
        /// </summary>
        [JsiiProperty("fromPort", "{\"primitive\":\"number\"}", true)]
        ...
        [JsiiProperty("toPort", "{\"primitive\":\"number\",\"optional\":true}", true)]
