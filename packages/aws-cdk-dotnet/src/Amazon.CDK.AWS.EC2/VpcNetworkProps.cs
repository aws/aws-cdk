...
namespace Amazon.CDK.AWS.EC2
{
    ...
    public class VpcNetworkProps : DeputyBase, IVpcNetworkProps
    {
        /// <summary>
        ...
        /// </summary>
        [JsiiProperty("cidr", "{\"primitive\":\"string\",\"optional\":true}", true)]
        public string Cidr
        {
            get;
            set;
        ...
        /// </summary>
        [JsiiProperty("enableDnsHostnames", "{\"primitive\":\"boolean\",\"optional\":true}", true)]
        ...
        /// </summary>
        [JsiiProperty("enableDnsSupport", "{\"primitive\":\"boolean\",\"optional\":true}", true)]
        ...
        /// </summary>
        [JsiiProperty("defaultInstanceTenancy", "{\"fqn\":\"@aws-cdk/aws-ec2.DefaultInstanceTenancy\",\"optional\":true}", true)]
        public DefaultInstanceTenancy DefaultInstanceTenancy
        {
            get;
            set;
        }
        ...
        [JsiiProperty("tags", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"@aws-cdk/cdk.Tag\"}},\"optional\":true}", true)]
        public ITag[] Tags
        {
            get;
            set;
        ...
        [JsiiProperty("maxAZs", "{\"primitive\":\"number\",\"optional\":true}", true)]
        public double? MaxAZs
        {
            get;
            set;
        }
        ...
        [JsiiProperty("natGateways", "{\"primitive\":\"number\",\"optional\":true}", true)]
        public double? NatGateways
        {
            get;
            set;
        }
        ...
        /// </remarks>
        [JsiiProperty("subnetConfiguration", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"@aws-cdk/aws-ec2.SubnetConfiguration\"}},\"optional\":true}", true)]
        public ISubnetConfiguration[] SubnetConfiguration
        {
            get;
            set;
        }
