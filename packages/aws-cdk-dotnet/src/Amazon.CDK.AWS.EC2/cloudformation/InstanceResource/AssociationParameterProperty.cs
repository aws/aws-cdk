...
namespace Amazon.CDK.AWS.EC2.cloudformation.InstanceResource
{
    ...
    public class AssociationParameterProperty : DeputyBase, IAssociationParameterProperty
    {
        ...
        [JsiiProperty("value", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}}}]}}", true)]
        public object Value
        {
            get;
            set;
