...
namespace Amazon.CDK.AWS.EC2.cloudformation
{
    ...
    [JsiiInterface(typeof(ILaunchTemplateResourceProps), "@aws-cdk/aws-ec2.cloudformation.LaunchTemplateResourceProps")]
    public interface ILaunchTemplateResourceProps
    {
