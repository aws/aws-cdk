...
namespace Amazon.CDK.AWS.EC2.cloudformation.SpotFleetResource
{
    ...
    public class BlockDeviceMappingProperty : DeputyBase, Amazon.CDK.AWS.EC2.cloudformation.SpotFleetResource.IBlockDeviceMappingProperty
    {
        ...
        [JsiiProperty("ebs", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-ec2.cloudformation.SpotFleetResource.EbsBlockDeviceProperty\"}]},\"optional\":true}", true)]
        public object Ebs
        {
            get;
            set;
