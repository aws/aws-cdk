...
namespace Amazon.CDK.AWS.EC2.cloudformation.LaunchTemplateResource
{
    ...
    [JsiiInterfaceProxy(typeof(IMonitoringProperty), "@aws-cdk/aws-ec2.cloudformation.LaunchTemplateResource.MonitoringProperty")]
    internal class MonitoringPropertyProxy : DeputyBase, IMonitoringProperty
    {
        private MonitoringPropertyProxy(ByRefValue reference): base(reference)
        {
        }
