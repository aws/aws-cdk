...
namespace Amazon.CDK.AWS.EC2.cloudformation.LaunchTemplateResource
{
    ...
    public class TagSpecificationProperty : DeputyBase, ITagSpecificationProperty
    {
        ...
        [JsiiProperty("resourceType", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
