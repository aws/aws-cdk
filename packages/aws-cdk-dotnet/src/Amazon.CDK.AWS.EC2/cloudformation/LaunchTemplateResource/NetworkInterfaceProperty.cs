...
namespace Amazon.CDK.AWS.EC2.cloudformation.LaunchTemplateResource
{
    ...
    public class NetworkInterfaceProperty : DeputyBase, Amazon.CDK.AWS.EC2.cloudformation.LaunchTemplateResource.INetworkInterfaceProperty
    {
        ...
        [JsiiProperty("deviceIndex", "{\"union\":{\"types\":[{\"primitive\":\"number\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("ipv6Addresses", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-ec2.cloudformation.LaunchTemplateResource.Ipv6AddProperty\"}]}}}}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("privateIpAddresses", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-ec2.cloudformation.LaunchTemplateResource.PrivateIpAddProperty\"}]}}}}]},\"optional\":true}", true)]
