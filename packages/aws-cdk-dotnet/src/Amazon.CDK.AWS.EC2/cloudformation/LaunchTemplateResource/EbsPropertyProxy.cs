...
namespace Amazon.CDK.AWS.EC2.cloudformation.LaunchTemplateResource
{
    ...
    [JsiiInterfaceProxy(typeof(IEbsProperty), "@aws-cdk/aws-ec2.cloudformation.LaunchTemplateResource.EbsProperty")]
    internal class EbsPropertyProxy : DeputyBase, Amazon.CDK.AWS.EC2.cloudformation.LaunchTemplateResource.IEbsProperty
    {
