...
namespace Amazon.CDK.AWS.EC2.cloudformation
{
    ...
    [JsiiInterface(typeof(ISubnetNetworkAclAssociationResourceProps), "@aws-cdk/aws-ec2.cloudformation.SubnetNetworkAclAssociationResourceProps")]
    public interface ISubnetNetworkAclAssociationResourceProps
    {
