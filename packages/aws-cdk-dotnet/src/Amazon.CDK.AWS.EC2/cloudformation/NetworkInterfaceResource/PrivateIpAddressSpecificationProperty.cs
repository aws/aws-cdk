...
namespace Amazon.CDK.AWS.EC2.cloudformation.NetworkInterfaceResource
{
    ...
    public class PrivateIpAddressSpecificationProperty : DeputyBase, Amazon.CDK.AWS.EC2.cloudformation.NetworkInterfaceResource.IPrivateIpAddressSpecificationProperty
    {
