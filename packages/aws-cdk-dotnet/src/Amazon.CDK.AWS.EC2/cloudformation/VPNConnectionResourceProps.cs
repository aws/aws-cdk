...
namespace Amazon.CDK.AWS.EC2.cloudformation
{
    ...
    public class VPNConnectionResourceProps : DeputyBase, IVPNConnectionResourceProps
    {
        ...
        [JsiiProperty("customerGatewayId", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}", true)]
        ...
        [JsiiProperty("staticRoutesOnly", "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("vpnTunnelOptionsSpecifications", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-ec2.cloudformation.VPNConnectionResource.VpnTunnelOptionsSpecificationProperty\"}]}}}}]},\"optional\":true}", true)]
        public object VpnTunnelOptionsSpecifications
        {
            get;
            set;
        }
