...
namespace Amazon.CDK.AWS.SES.cloudformation.ConfigurationSetEventDestinationResource
{
    ...
    [JsiiInterface(typeof(ICloudWatchDestinationProperty), "@aws-cdk/aws-ses.cloudformation.ConfigurationSetEventDestinationResource.CloudWatchDestinationProperty")]
    public interface ICloudWatchDestinationProperty
    {
