...
namespace Amazon.CDK.AWS.Cloud9.cloudformation
{
    ...
    public class EnvironmentEC2ResourceProps : DeputyBase, IEnvironmentEC2ResourceProps
    {
        ...
        [JsiiProperty("automaticStopTimeMinutes", "{\"union\":{\"types\":[{\"primitive\":\"number\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object AutomaticStopTimeMinutes
        {
            get;
            set;
        }
        ...
        [JsiiProperty("environmentEc2Name", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object EnvironmentEc2Name
        {
            get;
            set;
        }
        ...
        [JsiiProperty("ownerArn", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object OwnerArn
        {
            get;
            set;
        }
        ...
        [JsiiProperty("repositories", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-cloud9.cloudformation.EnvironmentEC2Resource.RepositoryProperty\"}]}}}}]},\"optional\":true}", true)]
