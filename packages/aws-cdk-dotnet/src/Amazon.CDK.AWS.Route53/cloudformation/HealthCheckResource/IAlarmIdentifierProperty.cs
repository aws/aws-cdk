...
namespace Amazon.CDK.AWS.Route53.cloudformation.HealthCheckResource
{
    ...
    [JsiiInterface(typeof(IAlarmIdentifierProperty), "@aws-cdk/aws-route53.cloudformation.HealthCheckResource.AlarmIdentifierProperty")]
    public interface IAlarmIdentifierProperty
    {
