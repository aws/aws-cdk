...
namespace Amazon.CDK.AWS.Route53.cloudformation.RecordSetGroupResource
{
    ...
    [JsiiInterface(typeof(IRecordSetProperty), "@aws-cdk/aws-route53.cloudformation.RecordSetGroupResource.RecordSetProperty")]
    public interface IRecordSetProperty
    {
