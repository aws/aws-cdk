...
namespace Amazon.CDK.AWS.Lambda
{
    ...
    public class AliasProps : DeputyBase, IAliasProps
    {
        ...
        [JsiiProperty("aliasName", "{\"primitive\":\"string\"}", true)]
        ...
        [JsiiProperty("additionalVersions", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"fqn\":\"@aws-cdk/aws-lambda.VersionWeight\"}},\"optional\":true}", true)]
        public IVersionWeight[] AdditionalVersions
        {
            get;
            set;
        }
