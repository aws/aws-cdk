...
{
    [JsiiInterface(typeof(IInlineJavaScriptLambdaProps), "@aws-cdk/aws-lambda.InlineJavaScriptLambdaProps")]
    public interface IInlineJavaScriptLambdaProps
    {
        /// <summary>
        ...
        IIJavaScriptLambdaHandler Handler
        {
            get;
            set;
        }
        ...
        IInlinableJavascriptLambdaRuntime Runtime
        {
            get;
            set;
        }
