...
namespace Amazon.CDK.AWS.Lambda.cloudformation
{
    ...
    [JsiiInterface(typeof(IPermissionResourceProps), "@aws-cdk/aws-lambda.cloudformation.PermissionResourceProps")]
    public interface IPermissionResourceProps
    {
