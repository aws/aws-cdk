...
namespace Amazon.CDK.AWS.Lambda
{
    ...
    /// </summary>
    [JsiiInterfaceProxy(typeof(IIJavaScriptLambdaHandler), "@aws-cdk/aws-lambda.IJavaScriptLambdaHandler")]
    internal class IJavaScriptLambdaHandlerProxy : DeputyBase, IIJavaScriptLambdaHandler
    {
        private IJavaScriptLambdaHandlerProxy(ByRefValue reference): base(reference)
        {
        }
        ...
        public virtual void Fn(object @event, object context, object callback)
        {
            InvokeInstanceVoidMethod(new object[]{@event, context, callback});
        }
    }
}