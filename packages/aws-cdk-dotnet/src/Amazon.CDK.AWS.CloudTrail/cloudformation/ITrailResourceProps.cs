...
namespace Amazon.CDK.AWS.CloudTrail.cloudformation
{
    ...
    [JsiiInterface(typeof(ITrailResourceProps), "@aws-cdk/aws-cloudtrail.cloudformation.TrailResourceProps")]
    public interface ITrailResourceProps
    {
