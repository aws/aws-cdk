...
{
    [JsiiInterface(typeof(ICloudTrailProps), "@aws-cdk/aws-cloudtrail.CloudTrailProps")]
    public interface ICloudTrailProps
    {
        /// <summary>
        ...
        LogRetention CloudWatchLogsRetentionTimeDays
        {
            get;
            set;
        }
