...
namespace Amazon.CDK
{
    ...
    /// </summary>
    public class AutoScalingRollingUpdate : DeputyBase, IAutoScalingRollingUpdate
    {
        /// <summary>Specifies the maximum number of instances that AWS CloudFormation updates.</summary>
        [JsiiProperty("maxBatchSize", "{\"primitive\":\"number\",\"optional\":true}", true)]
        ...
        /// </summary>
        [JsiiProperty("minInstancesInService", "{\"primitive\":\"number\",\"optional\":true}", true)]
        public double? MinInstancesInService
        {
            get;
            set;
        }
        ...
        /// </summary>
        [JsiiProperty("minSuccessfulInstancesPercent", "{\"primitive\":\"number\",\"optional\":true}", true)]
        public double? MinSuccessfulInstancesPercent
        {
            get;
            set;
        }
        ...
        /// </summary>
        [JsiiProperty("pauseTime", "{\"primitive\":\"string\",\"optional\":true}", true)]
        ...
        /// </summary>
        [JsiiProperty("suspendProcesses", "{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"primitive\":\"string\"}},\"optional\":true}", true)]
        public string[] SuspendProcesses
        {
            get;
            set;
        }
        ...
        /// </summary>
        [JsiiProperty("waitOnResourceSignals", "{\"primitive\":\"boolean\",\"optional\":true}", true)]
        public bool? WaitOnResourceSignals
        {
            get;
            set;
        }
