...
{
    public class ParameterProps : DeputyBase, IParameterProps
    {
        ...
        /// </summary>
        [JsiiProperty("default", "{\"primitive\":\"any\",\"optional\":true}", true)]
        ...
        [JsiiProperty("maxValue", "{\"primitive\":\"number\",\"optional\":true}", true)]
        ...
        [JsiiProperty("minValue", "{\"primitive\":\"number\",\"optional\":true}", true)]
        ...
        /// </summary>
        [JsiiProperty("noEcho", "{\"primitive\":\"boolean\",\"optional\":true}", true)]
        public bool? NoEcho
        {
            get;
            set;
