...
namespace Amazon.CDK
{
    ...
    /// </summary>
    public class AutoScalingScheduledAction : DeputyBase, IAutoScalingScheduledAction
    {
        [JsiiProperty("ignoreUnmodifiedGroupSizeProperties", "{\"primitive\":\"boolean\",\"optional\":true}", true)]
        public bool? IgnoreUnmodifiedGroupSizeProperties
        {
            get;
            set;
        }
