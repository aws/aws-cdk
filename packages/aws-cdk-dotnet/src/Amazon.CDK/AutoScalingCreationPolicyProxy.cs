...
namespace Amazon.CDK
{
    ...
    /// update to succeed.
    /// </summary>
    [JsiiInterfaceProxy(typeof(IAutoScalingCreationPolicy), "@aws-cdk/cdk.AutoScalingCreationPolicy")]
    internal class AutoScalingCreationPolicyProxy : DeputyBase, IAutoScalingCreationPolicy
    {
        private AutoScalingCreationPolicyProxy(ByRefValue reference): base(reference)
        {
        }
