...
namespace Amazon.CDK
{
    ...
    /// </summary>
    [JsiiInterfaceProxy(typeof(ICreationPolicy), "@aws-cdk/cdk.CreationPolicy")]
    internal class CreationPolicyProxy : DeputyBase, ICreationPolicy
    {
        private CreationPolicyProxy(ByRefValue reference): base(reference)
        {
        }
        ...
        /// update to succeed.
        /// </summary>
        [JsiiProperty("autoScalingCreationPolicy", "{\"fqn\":\"@aws-cdk/cdk.AutoScalingCreationPolicy\",\"optional\":true}")]
        public virtual IAutoScalingCreationPolicy AutoScalingCreationPolicy
        {
            get => GetInstanceProperty<IAutoScalingCreationPolicy>();
        ...
        /// </summary>
        [JsiiProperty("resourceSignal", "{\"fqn\":\"@aws-cdk/cdk.ResourceSignal\",\"optional\":true}")]
        public virtual IResourceSignal ResourceSignal
        {
            get => GetInstanceProperty<IResourceSignal>();
            set => SetInstanceProperty(value);
        }
    }
}