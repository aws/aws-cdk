...
namespace Amazon.CDK
{
    ...
    /// </summary>
    [JsiiInterface(typeof(IUpdatePolicy), "@aws-cdk/cdk.UpdatePolicy")]
    public interface IUpdatePolicy
    {
        ...
        IAutoScalingReplacingUpdate AutoScalingReplacingUpdate
        {
            get;
            set;
        }
        ...
        IAutoScalingRollingUpdate AutoScalingRollingUpdate
        {
            get;
            set;
        }
        ...
        IAutoScalingScheduledAction AutoScalingScheduledAction
        {
            get;
            set;
        }
