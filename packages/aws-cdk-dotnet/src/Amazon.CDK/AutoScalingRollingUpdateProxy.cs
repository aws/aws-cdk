...
namespace Amazon.CDK
{
    ...
    /// </summary>
    [JsiiInterfaceProxy(typeof(IAutoScalingRollingUpdate), "@aws-cdk/cdk.AutoScalingRollingUpdate")]
    internal class AutoScalingRollingUpdateProxy : DeputyBase, IAutoScalingRollingUpdate
    {
        private AutoScalingRollingUpdateProxy(ByRefValue reference): base(reference)
        {
        }
        ...
        public virtual double? MinInstancesInService
        {
            get => GetInstanceProperty<double? >();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual double? MinSuccessfulInstancesPercent
        {
            get => GetInstanceProperty<double? >();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual string[] SuspendProcesses
        {
            get => GetInstanceProperty<string[]>();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual bool? WaitOnResourceSignals
        {
