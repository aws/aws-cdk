...
namespace Amazon.CDK.AWS.APIGateway.cloudformation
{
    ...
    public class AuthorizerResourceProps : DeputyBase, IAuthorizerResourceProps
    {
        ...
        [JsiiProperty("authorizerCredentials", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object AuthorizerCredentials
        {
            get;
            set;
        }
        ...
        [JsiiProperty("authorizerResultTtlInSeconds", "{\"union\":{\"types\":[{\"primitive\":\"number\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object AuthorizerResultTtlInSeconds
        {
            get;
            set;
        }
        ...
        [JsiiProperty("authorizerUri", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object AuthorizerUri
        {
            get;
            set;
        }
        ...
        [JsiiProperty("identitySource", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("identityValidationExpression", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object IdentityValidationExpression
        {
            get;
            set;
        }
        ...
        [JsiiProperty("authorizerName", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object AuthorizerName
        {
            get;
            set;
        }
        ...
        [JsiiProperty("providerArns", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}}}]},\"optional\":true}", true)]
        public object ProviderArns
        {
            get;
            set;
        }
