...
namespace Amazon.CDK.AWS.APIGateway.cloudformation
{
    ...
    public class RestApiResourceProps : DeputyBase, IRestApiResourceProps
    {
        ...
        [JsiiProperty("apiKeySourceType", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object ApiKeySourceType
        {
            get;
            set;
        }
        ...
        [JsiiProperty("binaryMediaTypes", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]}}}}]},\"optional\":true}", true)]
        public object BinaryMediaTypes
        {
            get;
            set;
        }
        ...
        [JsiiProperty("body", "{\"union\":{\"types\":[{\"primitive\":\"json\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object Body
        {
            get;
            set;
        ...
        [JsiiProperty("bodyS3Location", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-apigateway.cloudformation.RestApiResource.S3LocationProperty\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("cloneFrom", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("endpointConfiguration", "{\"union\":{\"types\":[{\"fqn\":\"@aws-cdk/cdk.Token\"},{\"fqn\":\"@aws-cdk/aws-apigateway.cloudformation.RestApiResource.EndpointConfigurationProperty\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("failOnWarnings", "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        ...
        [JsiiProperty("minimumCompressionSize", "{\"union\":{\"types\":[{\"primitive\":\"number\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object MinimumCompressionSize
        {
            get;
            set;
        }
        ...
        [JsiiProperty("restApiName", "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
        public object RestApiName
        {
            get;
            set;
        }
        ...
        [JsiiProperty("policy", "{\"union\":{\"types\":[{\"primitive\":\"json\"},{\"fqn\":\"@aws-cdk/cdk.Token\"}]},\"optional\":true}", true)]
