...
namespace Amazon.CDK.AWS.Kinesis.cloudformation
{
    ...
    [JsiiInterface(typeof(IStreamResourceProps), "@aws-cdk/aws-kinesis.cloudformation.StreamResourceProps")]
    public interface IStreamResourceProps
    {
