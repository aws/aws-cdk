...
| [@aws-cdk/aws-eks-v2:useNativeOidcProvider](#aws-cdkaws-eks-v2usenativeoidcprovider) | When enabled, EKS V2 clusters will use the native OIDC provider resource AWS::IAM::OIDCProvider instead of creating the OIDCProvider with a custom resource (iam.OpenIDConnectProvider). | V2NEXT | new default |
...
### @aws-cdk/aws-eks-v2:useNativeOidcProvider
