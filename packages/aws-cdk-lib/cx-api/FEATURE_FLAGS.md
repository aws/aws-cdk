...
| [@aws-cdk/aws-ec2:securityGroupPruneSubsumedRules](#aws-cdkaws-ec2securitygroupprunesubsumedrules) | When enabled, security group rules that are fully subsumed by a broader rule are removed from the synthesized template | V2NEXT | fix |
...
```json
{
  "context": {
    ...
    "@aws-cdk/aws-ec2:securityGroupPruneSubsumedRules": true,
...
### @aws-cdk/aws-ec2:securityGroupPruneSubsumedRules

*When enabled, security group rules that are fully subsumed by a broader rule are removed from the synthesized template*
