...
| [@aws-cdk/aws-ec2:ebsDefaultGp3Volume](#aws-cdkaws-ec2defaultgp3volume) | When enabled, the default volume type of EBS will be GP3. | 2.139.0 | (default) |
...
*When enabled, the default volume type for EBS will be GP3.* (default)
