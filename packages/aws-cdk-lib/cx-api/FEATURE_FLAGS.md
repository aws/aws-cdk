...
| [@aws-cdk/ecs-patterns:fargateServiceBaseHasPublicLBDefault](#aws-cdkecs-patternsfargateservicebasehaspubliclbdefault) | When enabled, the load balancers created will be public by default | 2.172.0 | (fix) |
...
```json
{
  "context": {
    ...
    "@aws-cdk/ecs-patterns:fargateServiceBaseHasPublicLBDefault": false
  }
}
```
<!-- END json -->
...
| [@aws-cdk/ecs-patterns:fargateServiceBaseHasPublicLBDefault](#aws-cdkecs-patternsfargateservicebasehaspubliclbdefault) | When enabled, the load balancers created will be public by default | (fix) |  | `false` | `true` |
...
*When enabled, the load balancers created will be public by default* (fix)
