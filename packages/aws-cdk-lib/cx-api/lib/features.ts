...
export const DOCKER_IGNORE_SUPPORT =
...
export const S3_GRANT_WRITE_WITHOUT_ACL =
  "@aws-cdk/aws-s3:grantWriteWithoutAcl";
export const ECS_REMOVE_DEFAULT_DESIRED_COUNT =
  "@aws-cdk/aws-ecs-patterns:removeDefaultDesiredCount";
export const RDS_LOWERCASE_DB_IDENTIFIER =
  "@aws-cdk/aws-rds:lowercaseDbIdentifier";
export const APIGATEWAY_USAGEPLANKEY_ORDERINSENSITIVE_ID =
  "@aws-cdk/aws-apigateway:usagePlanKeyOrderInsensitiveId";
export const EFS_DEFAULT_ENCRYPTION_AT_REST =
  "@aws-cdk/aws-efs:defaultEncryptionAtRest";
export const LAMBDA_RECOGNIZE_VERSION_PROPS =
  "@aws-cdk/aws-lambda:recognizeVersionProps";
export const LAMBDA_RECOGNIZE_LAYER_VERSION =
...
export const EC2_UNIQUE_IMDSV2_LAUNCH_TEMPLATE_NAME =
  "@aws-cdk/aws-ec2:uniqueImdsv2TemplateName";
export const ECS_ARN_FORMAT_INCLUDES_CLUSTER_NAME =
...
export const VALIDATE_SNAPSHOT_REMOVAL_POLICY =
  "@aws-cdk/core:validateSnapshotRemovalPolicy";
export const CODEPIPELINE_CROSS_ACCOUNT_KEY_ALIAS_STACK_SAFE_RESOURCE_NAME =
  "@aws-cdk/aws-codepipeline:crossAccountKeyAliasStackSafeResourceName";
export const S3_CREATE_DEFAULT_LOGGING_POLICY =
  "@aws-cdk/aws-s3:createDefaultLoggingPolicy";
export const SNS_SUBSCRIPTIONS_SQS_DECRYPTION_POLICY =
  "@aws-cdk/aws-sns-subscriptions:restrictSqsDescryption";
export const APIGATEWAY_DISABLE_CLOUDWATCH_ROLE =
  "@aws-cdk/aws-apigateway:disableCloudWatchRole";
export const ENABLE_PARTITION_LITERALS =
  "@aws-cdk/core:enablePartitionLiterals";
export const EVENTS_TARGET_QUEUE_SAME_ACCOUNT =
...
export const ECS_PATTERNS_SEC_GROUPS_DISABLES_IMPLICIT_OPEN_LISTENER =
...
export const ROUTE53_PATTERNS_USE_CERTIFICATE =
  "@aws-cdk/aws-route53-patters:useCertificate";
export const ROUTE53_PATTERNS_USE_DISTRIBUTION =
...
export const EC2_RESTRICT_DEFAULT_SECURITY_GROUP =
...
export const KMS_APPLY_IMPORTED_ALIAS_PERMISSIONS_TO_PRINCIPAL =
...
export const EKS_USE_NATIVE_OIDC_PROVIDER =
...
export const ECS_REMOVE_DEFAULT_DEPLOYMENT_ALARM =
...
export const STEPFUNCTIONS_USE_DISTRIBUTED_MAP_RESULT_WRITER_V2 =
...
export const SIGNER_PROFILE_NAME_PASSED_TO_CFN =
  "@aws-cdk/aws-signer:signingProfileNamePassedToCfn";
export const USER_POOL_DOMAIN_NAME_METHOD_WITHOUT_CUSTOM_RESOURCE =
  "@aws-cdk/aws-route53-targets:userPoolDomainNameMethodWithoutCustomResource";
export const ALB_DUALSTACK_WITHOUT_PUBLIC_IPV4_SECURITY_GROUP_RULES_DEFAULT =
  "@aws-cdk/aws-elasticloadbalancingV2:albDualstackWithoutPublicIpv4SecurityGroupRulesDefault";
export const IAM_OIDC_REJECT_UNAUTHORIZED_CONNECTIONS =
  "@aws-cdk/aws-iam:oidcRejectUnauthorizedConnections";
export const ENABLE_ADDITIONAL_METADATA_COLLECTION =
  "@aws-cdk/core:enableAdditionalMetadataCollection";
export const LAMBDA_CREATE_NEW_POLICIES_WITH_ADDTOROLEPOLICY =
  "@aws-cdk/aws-lambda:createNewPoliciesWithAddToRolePolicy";
export const SET_UNIQUE_REPLICATION_ROLE_NAME =
  "@aws-cdk/aws-s3:setUniqueReplicationRoleName";
export const PIPELINE_REDUCE_STAGE_ROLE_TRUST_SCOPE =
  "@aws-cdk/pipelines:reduceStageRoleTrustScope";
export const EVENTBUS_POLICY_SID_REQUIRED =
  "@aws-cdk/aws-events:requireEventBusPolicySid";
export const ASPECT_PRIORITIES_MUTATING =
  "@aws-cdk/core:aspectPrioritiesMutating";
export const DYNAMODB_TABLE_RETAIN_TABLE_REPLICA =
  "@aws-cdk/aws-dynamodb:retainTableReplica";
export const LOG_USER_POOL_CLIENT_SECRET_VALUE =
  "@aws-cdk/cognito:logUserPoolClientSecretValue";
export const PIPELINE_REDUCE_CROSS_ACCOUNT_ACTION_ROLE_TRUST_SCOPE =
  "@aws-cdk/pipelines:reduceCrossAccountActionRoleTrustScope";
export const S3_TRUST_KEY_POLICY_FOR_SNS_SUBSCRIPTIONS =
  "@aws-cdk/s3-notifications:addS3TrustKeyPolicyForSnsSubscriptions";
export const EC2_REQUIRE_PRIVATE_SUBNETS_FOR_EGRESSONLYINTERNETGATEWAY =
  "@aws-cdk/aws-ec2:requirePrivateSubnetsForEgressOnlyInternetGateway";
export const USE_RESOURCEID_FOR_VPCV2_MIGRATION =
  "@aws-cdk/aws-ec2-alpha:useResourceIdForVpcV2Migration";
export const S3_PUBLIC_ACCESS_BLOCKED_BY_DEFAULT =
  "@aws-cdk/aws-s3:publicAccessBlockedByDefault";
export const USE_CDK_MANAGED_LAMBDA_LOGGROUP =
  "@aws-cdk/aws-lambda:useCdkManagedLogGroup";
export const NETWORK_LOAD_BALANCER_WITH_SECURITY_GROUP_BY_DEFAULT =
...
export const CLOUDFRONT_FUNCTION_DEFAULT_RUNTIME_V2_0 =
  "@aws-cdk/aws-cloudfront:defaultFunctionRuntimeV2_0";
export const ELB_USE_POST_QUANTUM_TLS_POLICY =
...
export const STEPFUNCTIONS_TASKS_SCOPED_SUBMIT_JOB_POLICY =
  "@aws-cdk/aws-stepfunctions-tasks:scopedSubmitJobPolicy";
...
export const FLAGS: Record<string, FlagInfo> = {
  ...
  [ENABLE_STACK_NAME_DUPLICATES_CONTEXT]: {
    ...
    compatibilityWithOldBehaviorMd:
      "Pass stack identifiers to the CLI instead of stack names.",
  },
  ...
  [ECS_PATTERNS_SEC_GROUPS_DISABLES_IMPLICIT_OPEN_LISTENER]: {
    ...
    recommendedValue: true,
    compatibilityWithOldBehaviorMd:
      "You can pass `openListener: true` explicitly to maintain the old behavior.",
  },
  ...
  [AWS_CUSTOM_RESOURCE_LATEST_SDK_DEFAULT]: {
    ...
    `,
    compatibilityWithOldBehaviorMd:
      "Set installLatestAwsSdk: true on all resources that need it.",
    introducedIn: { v2: "2.60.0" },
  ...
  [KMS_APPLY_IMPORTED_ALIAS_PERMISSIONS_TO_PRINCIPAL]: {
    ...
    recommendedValue: true,
    compatibilityWithOldBehaviorMd:
      "Remove calls to the grant* methods on the aliases referenced by name",
  },
  ...
  [EKS_USE_NATIVE_OIDC_PROVIDER]: {
    ...
    recommendedValue: true,
    compatibilityWithOldBehaviorMd:
      "Disable the feature flag to use the custom resource provider.",
  },
  ...
  [EXPLICIT_STACK_TAGS]: {
    ...
    recommendedValue: true,
    compatibilityWithOldBehaviorMd:
      "Configure stack-level tags using `new Stack(..., { tags: { ... } })`.",
  },
  ...
  [ALB_DUALSTACK_WITHOUT_PUBLIC_IPV4_SECURITY_GROUP_RULES_DEFAULT]: {
    ...
    recommendedValue: true,
    compatibilityWithOldBehaviorMd:
      "Disable the feature flag to only allow IPv4 ingress in the default security group rules.",
  },
  ...
  [IAM_OIDC_REJECT_UNAUTHORIZED_CONNECTIONS]: {
    ...
    recommendedValue: true,
    compatibilityWithOldBehaviorMd:
      "Disable the feature flag to allow unsecure OIDC connection.",
  },
  ...
  [LOG_USER_POOL_CLIENT_SECRET_VALUE]: {
    ...
    recommendedValue: false,
    compatibilityWithOldBehaviorMd:
      "Enable the feature flag to keep the old behavior and log the client secret values",
  },
  ...
  [STEPFUNCTIONS_USE_DISTRIBUTED_MAP_RESULT_WRITER_V2]: {
    ...
    recommendedValue: true,
    compatibilityWithOldBehaviorMd:
      "Disable the feature flag and set resultWriter in DistributedMap",
  },
  ...
  [USE_RESOURCEID_FOR_VPCV2_MIGRATION]: {
    ...
    unconfiguredBehavesLike: { v2: false },
    compatibilityWithOldBehaviorMd:
      "Disable the feature flag to use getAtt references for VPC V2 migration",
  },
  ...
  [USE_CDK_MANAGED_LAMBDA_LOGGROUP]: {
    ...
    recommendedValue: true,
    compatibilityWithOldBehaviorMd:
      "Disable the feature flag to let lambda service create logGroup or specify logGroup or logRetention",
  },
  ...
  [NETWORK_LOAD_BALANCER_WITH_SECURITY_GROUP_BY_DEFAULT]: {
    ...
    recommendedValue: true,
    compatibilityWithOldBehaviorMd:
      "Disable the feature flag to create Network Load Balancer without a security group by default.",
  },
  ...
  [ROUTE53_PATTERNS_USE_DISTRIBUTION]: {
    ...
    recommendedValue: true,
    compatibilityWithOldBehaviorMd:
      "Define a `CloudFrontWebDistribution` explicitly",
  },
  ...
  [CLOUDFRONT_FUNCTION_DEFAULT_RUNTIME_V2_0]: {
    ...
    recommendedValue: true,
    compatibilityWithOldBehaviorMd:
      "Set `runtime: FunctionRuntime.JS_1_0` explicitly to use the v1.0 runtime.",
  },
  ...
  [ELB_USE_POST_QUANTUM_TLS_POLICY]: {
    ...
    recommendedValue: true,
    compatibilityWithOldBehaviorMd:
      "Disable this feature flag to preserve existing behavior where no explicit SSL policy is set.",
  },
  ...
  [AUTOMATIC_L1_TRAITS]: {
    ...
    unconfiguredBehavesLike: { v2: true },
    compatibilityWithOldBehaviorMd:
      "Register traits explicitly for each resource type",
  },
...
**Warning**: Enabling this flag on existing stacks may cause compute environment replacement, which terminates running jobs. To migrate safely, first pin existing environments to their current imageType explicitly, then enable the flag.`,
  ...
  [STEPFUNCTIONS_TASKS_SCOPED_SUBMIT_JOB_POLICY]: {
    type: FlagType.BugFix,
    summary:
      "Scope down the IAM policy for BatchSubmitJob to the specific job definition.",
    detailsMd: `
    Previously, the BatchSubmitJob task added an IAM policy allowing batch:SubmitJob
    against any job definition in the account. With this flag enabled, the policy is
    scoped to the specific job definition (with a wildcard revision).
  `,
...
export const CURRENTLY_RECOMMENDED_FLAGS = Object.fromEntries(
  Object.entries(FLAGS)
    ...
    .filter(
      ([_, flag]) =>
        flag.recommendedValue !== flag.unconfiguredBehavesLike?.[CURRENT_MV],
    )
...
export const CURRENT_VERSION_FLAG_DEFAULTS = Object.fromEntries(
  Object.entries(FLAGS)
    .filter(
      ([_, flag]) => flag.unconfiguredBehavesLike?.[CURRENT_MV] !== undefined,
    )
...
export const FUTURE_FLAGS = Object.fromEntries(
  Object.entries(CURRENTLY_RECOMMENDED_FLAGS).filter(
