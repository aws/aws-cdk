...
export const EKSV2_USE_NATIVE_OIDC_PROVIDER = '@aws-cdk/aws-eks-v2:useNativeOidcProvider';
...
export const FLAGS: Record<string, FlagInfo> = {
  ...
  //////////////////////////////////////////////////////////////////////
  [EKSV2_USE_NATIVE_OIDC_PROVIDER]: {
    type: FlagType.ApiDefault,
    ...
    detailsMd: `
      ...
      CloudFormation resource instead of the custom resource provider for creating OIDC providers.
			...
			To migrate in place without disruption, follow the guide at: https://github.com/aws/aws-cdk/blob/main/packages/@aws-cdk/aws-eks-v2-alpha/README.md#migrating-from-the-deprecated-eksopenidconnectprovider-to-eksoidcprovidernative
    `,
