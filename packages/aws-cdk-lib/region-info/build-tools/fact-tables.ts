...
// Note: Application Signals layers are architecture-agnostic (work with both x86_64 and arm64).
// They use build numbers (not semantic versions) that vary by region.
// Structure: { runtime: { region: arn } }
export const APPLICATION_SIGNALS_LAMBDA_LAYER_ARNS: { [key: string]: { [key: string]: string } } = {
  python: {
