...
export const FIREHOSE_CIDR_BLOCKS: { [region: string]: string } = {
  ...
  'il-central-1': '51.16.102.64',
  'me-central-1': '3.28.159.64',
...
const ADOT_LAMBDA_LAYER_JAVA_SDK_ARNS: { [version: string]: { [arch: string]: { [region: string]: string } } } = {
  '1.28.1': {
    x86_64: {
      ...
      'cn-north-1': 'arn:aws:lambda:cn-north-1:901920570463:layer:aws-otel-java-wrapper-amd64-ver-1-28-1:1',
      'cn-northwest-1': 'arn:aws:lambda:cn-northwest-1:901920570463:layer:aws-otel-java-wrapper-amd64-ver-1-28-1:1',
    ...
    arm64: {
      ...
      'cn-north-1': 'arn:aws:lambda:cn-north-1:901920570463:layer:aws-otel-java-wrapper-arm64-ver-1-28-1:1',
      'cn-northwest-1': 'arn:aws:lambda:cn-northwest-1:901920570463:layer:aws-otel-java-wrapper-arm64-ver-1-28-1:1',
...
const ADOT_LAMBDA_LAYER_JAVA_AUTO_INSTRUMENTATION_ARNS: {
  ...
  '1.28.1': {
    x86_64: {
      ...
      'cn-north-1': 'arn:aws:lambda:cn-north-1:901920570463:layer:aws-otel-java-agent-amd64-ver-1-28-1:1',
      'cn-northwest-1': 'arn:aws:lambda:cn-northwest-1:901920570463:layer:aws-otel-java-agent-amd64-ver-1-28-1:1',
    ...
    arm64: {
      ...
      'cn-north-1': 'arn:aws:lambda:cn-north-1:901920570463:layer:aws-otel-java-agent-arm64-ver-1-28-1:1',
      'cn-northwest-1': 'arn:aws:lambda:cn-northwest-1:901920570463:layer:aws-otel-java-agent-arm64-ver-1-28-1:1',
...
const ADOT_LAMBDA_LAYER_JAVASCRIPT_SDK_ARNS: { [version: string]: { [arch: string]: { [region: string]: string } } } = {
  '1.15.0-1': {
    x86_64: {
      ...
      'cn-north-1': 'arn:aws:lambda:cn-north-1:901920570463:layer:aws-otel-nodejs-amd64-ver-1-15-0:2',
      'cn-northwest-1': 'arn:aws:lambda:cn-northwest-1:901920570463:layer:aws-otel-nodejs-amd64-ver-1-15-0:2',
    ...
    arm64: {
      ...
      'cn-north-1': 'arn:aws:lambda:cn-north-1:901920570463:layer:aws-otel-nodejs-arm64-ver-1-15-0:2',
      'cn-northwest-1': 'arn:aws:lambda:cn-northwest-1:901920570463:layer:aws-otel-nodejs-arm64-ver-1-15-0:2',
...
const ADOT_LAMBDA_LAYER_PYTHON_SDK_ARNS: { [version: string]: { [arch: string]: { [region: string]: string } } } = {
  '1.19.0-1': {
    x86_64: {
      ...
      'cn-north-1': 'arn:aws:lambda:cn-north-1:901920570463:layer:aws-otel-python-amd64-ver-1-19-0:2',
      'cn-northwest-1': 'arn:aws:lambda:cn-northwest-1:901920570463:layer:aws-otel-python-amd64-ver-1-19-0:2',
    ...
    arm64: {
      ...
      'cn-north-1': 'arn:aws:lambda:cn-north-1:901920570463:layer:aws-otel-python-arm64-ver-1-19-0:2',
      'cn-northwest-1': 'arn:aws:lambda:cn-northwest-1:901920570463:layer:aws-otel-python-arm64-ver-1-19-0:2',
...
const ADOT_LAMBDA_LAYER_GENERIC_ARNS: { [version: string]: { [arch: string]: { [region: string]: string } } } = {
  '0.82.0': {
    x86_64: {
      ...
      'cn-north-1': 'arn:aws:lambda:cn-north-1:901920570463:layer:aws-otel-collector-amd64-ver-0-82-0:1',
      'cn-northwest-1': 'arn:aws:lambda:cn-northwest-1:901920570463:layer:aws-otel-collector-amd64-ver-0-82-0:1',
    ...
    arm64: {
      ...
      'cn-north-1': 'arn:aws:lambda:cn-north-1:901920570463:layer:aws-otel-collector-arm64-ver-0-82-0:1',
      'cn-northwest-1': 'arn:aws:lambda:cn-northwest-1:901920570463:layer:aws-otel-collector-arm64-ver-0-82-0:1',
