...
You can configure system logging for your Kafka event source mappings to control the verbosity of logs generated by the polling infrastructure. This is particularly useful for troubleshooting connection issues, monitoring polling behavior, and understanding the internal operations of your event source mapping.
...
The same logging configuration works for self-managed Kafka:
...
Enhanced metrics provide detailed insights into your Kafka event source performance, including event processing rates, error counts, and Kafka-specific metrics like consumer lag and throughput.
