import { OnFailureDestinationConfig, IEventSourceOnFailureDestination, IEventSourceMapping, IFunction } from '../../aws-lambda';
import * as s3 from '../../aws-s3';

/**
 * An S3 dead letter bucket destination configuration for a Lambda event source
 */
export class S3OnFailureDestination implements IEventSourceOnFailureDestination {
