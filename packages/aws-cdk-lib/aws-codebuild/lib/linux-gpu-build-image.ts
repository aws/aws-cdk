...
export class LinuxGpuBuildImage implements IBindableBuildImage {
  ...
  public static readonly DLC_TENSORFLOW_1_15_2_TRAINING =
  ...
  public static readonly DLC_TENSORFLOW_1_15_2_INFERENCE =
    LinuxGpuBuildImage.awsDeepLearningContainersImage(
   ...
   * @see https://aws.amazon.com/releasenotes/available-deep-learning-containers-images
   */
  public static awsDeepLearningContainersImage(
      ...
      core.Lazy.string({
        produce: () => {
          if (this._imageAccount === undefined) {
            throw new Error(
              "Make sure this 'LinuxGpuBuildImage' is used in a CodeBuild Project construct"
            );
          }
