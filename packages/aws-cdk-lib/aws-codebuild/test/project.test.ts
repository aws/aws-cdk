...
describe('Environment', () => {
  ...
  test.each([
    ...
    ['Standard 8.0', codebuild.LinuxBuildImage.STANDARD_8_0, 'aws/codebuild/standard:8.0'],
    ...
    ['Amazon Linux 2023 6.0', codebuild.LinuxBuildImage.AMAZON_LINUX_2023_6, 'aws/codebuild/amazonlinux-x86_64-standard:6.0'],
    ['Amazon Linux 2023 ARM 4.0', codebuild.LinuxArmBuildImage.AMAZON_LINUX_2023_STANDARD_4_0, 'aws/codebuild/amazonlinux-aarch64-standard:4.0'],
