...
describe('Environment', () => {
  ...
  test.each([
    ...
    ['Linux EC2 AL2023 1.0', codebuild.EnvironmentType.LINUX_EC2, codebuild.LinuxBuildImage.AMAZON_LINUX_2023_AMI, 'aws/codebuild/ami/amazonlinux-x86_64-base:latest'],
    ['Arm EC2 AL2023 1.0', codebuild.EnvironmentType.ARM_EC2, codebuild.LinuxArmBuildImage.AMAZON_LINUX_2023_AMI, 'aws/codebuild/ami/amazonlinux-arm-base:latest'],
    ['Windows EC2 Server 2022 1.0', codebuild.EnvironmentType.WINDOWS_EC2, codebuild.WindowsBuildImage.WIN_SERVER_2022_AMI, 'aws/codebuild/ami/windows-base:2022'],
