...
test('throw warning if attached managed policies exceed 10 in constructor', () => {
  ...
  Annotations.fromStack(stack).hasWarning('*', 'IAM:Group:MaxPoliciesExceeded: You added 11 to IAM Group MyGroup. The maximum number of managed policies attached to an IAM group is 10.');
});
...
test('throw warning if attached managed policies exceed 10 when calling `addManagedPolicy`', () => {
  ...
  Annotations.fromStack(stack).hasWarning('/Default/MyGroup', 'IAM:Group:MaxPoliciesExceeded: You added 11 to IAM Group MyGroup. The maximum number of managed policies attached to an IAM group is 10.');
});
