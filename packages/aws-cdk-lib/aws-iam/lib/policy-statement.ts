...
export class PolicyStatement {
  ...
  public addActions(...actions: string[]) {
    ...
    if (actions.length > 0 && this._notAction.length > 0) {
      throw new UnscopedValidationError('CannotCannotActionsPolicy', 'Cannot add \'Actions\' to policy statement if \'NotActions\' have been added');
    }
  ...
  public addNotActions(...notActions: string[]) {
    ...
    if (notActions.length > 0 && this._action.length > 0) {
      throw new UnscopedValidationError('CannotCannotNotactionsPolicy', 'Cannot add \'NotActions\' to policy statement if \'Actions\' have been added');
    }
  ...
  public addPrincipals(...principals: IPrincipal[]) {
    ...
    if (principals.length > 0 && this._notPrincipals.length > 0) {
      throw new UnscopedValidationError('CannotCannotPrincipalsPolicy', 'Cannot add \'Principals\' to policy statement if \'NotPrincipals\' have been added');
    }
  ...
  public addNotPrincipals(...notPrincipals: IPrincipal[]) {
    ...
    if (notPrincipals.length > 0 && this._principals.length > 0) {
      throw new UnscopedValidationError('CannotCannotNotprincipalsPolicy', 'Cannot add \'NotPrincipals\' to policy statement if \'Principals\' have been added');
    }
  ...
  private validatePolicyPrincipal(principal: IPrincipal) {
    if (principal instanceof Group) {
      throw new UnscopedValidationError('CannotCannotGroupPrincipal', 'Cannot use an IAM Group as the \'Principal\' or \'NotPrincipal\' in an IAM Policy');
    }
  }
  ...
  public addResources(...arns: string[]) {
    ...
    if (arns.length > 0 && this._notResource.length > 0) {
      throw new UnscopedValidationError('CannotCannotResourcesPolicy', 'Cannot add \'Resources\' to policy statement if \'NotResources\' have been added');
    }
  ...
  public addNotResources(...arns: string[]) {
    ...
    if (arns.length > 0 && this._resource.length > 0) {
      throw new UnscopedValidationError('CannotCannotNotresourcesPolicy', 'Cannot add \'NotResources\' to policy statement if \'Resources\' have been added');
    }
