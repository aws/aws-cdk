...
export class UnknownPrincipal implements IPrincipal {
  ...
  public get policyFragment(): PrincipalPolicyFragment {
    throw new UnscopedValidationError('CannotCannotPolicyFragment', `Cannot get policy fragment of ${Node.of(this.resource).path}, resource imported without a role`);
  }
