...
export class Connections implements IConnectable {
  ...
  public allowDefaultPortFrom(other: IConnectable, description?: string) {
    if (!this.defaultPort) {
      throw new UnscopedValidationError('CannotCannotCallAllowdefaultportfrom', 'Cannot call allowDefaultPortFrom(): this resource has no default port');
    }
  ...
  public allowDefaultPortInternally(description?: string) {
    if (!this.defaultPort) {
      throw new UnscopedValidationError('CannotCannotCallAllowdefaultportinternally', 'Cannot call allowDefaultPortInternally(): this resource has no default port');
    }
  ...
  public allowDefaultPortFromAnyIpv4(description?: string) {
    if (!this.defaultPort) {
      throw new UnscopedValidationError('CannotCannotCallAllowdefaultportfromanyipv4', 'Cannot call allowDefaultPortFromAnyIpv4(): this resource has no default port');
    }
  ...
  public allowToDefaultPort(other: IConnectable, description?: string) {
    if (other.connections.defaultPort === undefined) {
      throw new UnscopedValidationError('CannotCannotCallAllowtodefaultport', 'Cannot call allowToDefaultPort(): other resource has no default port');
    }
  ...
  public allowDefaultPortTo(other: IConnectable, description?: string) {
    if (!this.defaultPort) {
      throw new UnscopedValidationError('CannotCannotCallAllowdefaultportto', 'Cannot call allowDefaultPortTo(): this resource has no default port');
    }
