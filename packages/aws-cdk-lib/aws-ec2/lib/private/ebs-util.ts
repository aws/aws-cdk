...
export function instanceBlockDeviceMappings(
  construct: Construct,
...
export function launchTemplateBlockDeviceMappings(
  ...
  return synthesizeBlockDeviceMappings<CfnLaunchTemplate.BlockDeviceMappingProperty, string>(
    construct,
    blockDevices,
    ''
  );
 ...
 */
function synthesizeBlockDeviceMappings<RT, NDT>(
  construct: Construct,
  blockDevices: BlockDevice[],
  noDeviceValue: NDT
): RT[] {
