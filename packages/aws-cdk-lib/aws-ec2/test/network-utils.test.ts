import { CidrBlock, InvalidCidrRangeError, NetworkBuilder, NetworkUtils } from '../lib/network-util';
...
describe('network utils', () => {
  ...
  describe('NetworkBuilder', () => {
    test('allows you to carve subnets our of CIDR network', () => {
      ...
      const expected = [wasteful.cidrStrings.sort(), efficient.cidrStrings.sort()];
