...
describe('InstanceType', () => {
  test.each([
    ...
    { instanceClass: InstanceClass.P6_B300, size: InstanceSize.XLARGE48METAL, expected: 'p6-b300.metal-48xl' },
    { instanceClass: InstanceClass.PARALLEL6_B300, size: InstanceSize.XLARGE48METAL, expected: 'p6-b300.metal-48xl' },
