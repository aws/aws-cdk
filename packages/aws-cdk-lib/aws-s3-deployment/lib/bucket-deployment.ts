...
import { BucketDeploymentFunction } from '../../custom-resource-handlers/dist/aws-s3-deployment/bucket-deployment-provider.generated';
...
export class BucketDeployment extends Construct {
  ...
  constructor(scope: Construct, id: string, props: BucketDeploymentProps) {
    ...
    const handler = new BucketDeploymentFunction(this, 'CustomResourceHandler', {
