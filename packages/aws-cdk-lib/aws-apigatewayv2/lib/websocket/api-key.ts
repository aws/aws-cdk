...
export class ApiKey extends ApiKeyBase {
   ...
   */
  public static readonly PROPERTY_INJECTION_ID: string = 'aws-cdk-lib.aws-apigatewayv2.websocket.ApiKey';
...
export class RateLimitedApiKey extends ApiKeyBase {
  /** Uniquely identifies this class. */
  public static readonly PROPERTY_INJECTION_ID: string = 'aws-cdk-lib.aws-apigatewayv2.RateLimitedApiKey';
  public readonly keyId: string;
  public readonly keyArn: string;
