...
export class EventBridgePutEvents extends ScheduleTargetBase implements IScheduleTarget {
  constructor(
    ...
    if (this.props.input) {
      throw new UnscopedValidationError('Scheduletargetbaseprops', 'ScheduleTargetBaseProps.input is not supported for EventBridgePutEvents. Please use entry.detail instead.');
    }
  }
