...
## usePipelineServiceRoleForActions field

You could enable this field to use pipeline service role as default action role in Codepipeline if no action role provided.
