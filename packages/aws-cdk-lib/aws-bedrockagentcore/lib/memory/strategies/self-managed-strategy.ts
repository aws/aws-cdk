      ...
      customMemoryStrategy: {
        ...
        configuration: {
          selfManagedConfiguration: {
            ...
            triggerConditions: [
              {
                messageBasedTrigger: { messageCount: this.triggerConditions.messageBasedTrigger },
              },
              {
                timeBasedTrigger: { idleSessionTimeout: this.triggerConditions.timeBasedTrigger?.toSeconds() },
              },
              {
                tokenBasedTrigger: { tokenCount: this.triggerConditions.tokenBasedTrigger },
              },
            ],
          },
        },
