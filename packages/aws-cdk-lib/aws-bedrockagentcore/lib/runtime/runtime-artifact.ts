...
export class AgentCoreRuntime {
   ...
   * Python 3.10 runtime
   */
  public static readonly PYTHON_3_10 = new AgentCoreRuntime('PYTHON_3_10');
  /**
   * Python 3.11 runtime
   */
  public static readonly PYTHON_3_11 = new AgentCoreRuntime('PYTHON_3_11');
  /**
   * Python 3.12 runtime
   */
  public static readonly PYTHON_3_12 = new AgentCoreRuntime('PYTHON_3_12');
  /**
   * Python 3.13 runtime
   */
  public static readonly PYTHON_3_13 = new AgentCoreRuntime('PYTHON_3_13');
  /**
   * Python 3.14 runtime
   */
  public static readonly PYTHON_3_14 = new AgentCoreRuntime('PYTHON_3_14');
  /**
   * Node.js 22 runtime
   */
  public static readonly NODE_22 = new AgentCoreRuntime('NODE_22');
  ...
  public static of(value: string): AgentCoreRuntime {
    return new AgentCoreRuntime(value);
  }
...
class EcrImage extends AgentRuntimeArtifact {
  ...
  public _render(): CfnRuntime.AgentRuntimeArtifactProperty {
    ...
    return { containerUri: this.repository.repositoryUriForTag(this.tag) } as any;
  }
}
...
class AssetImage extends AgentRuntimeArtifact {
  ...
  public _render(): CfnRuntime.AgentRuntimeArtifactProperty {
    ...
    // Return container configuration directly as expected by the runtime
    // The runtime wraps this in containerConfiguration
    return { containerUri: this.asset.imageUri } as any;
  }
}
...
class ImageUriArtifact extends AgentRuntimeArtifact {
  ...
  public _render(): CfnRuntime.AgentRuntimeArtifactProperty {
    return { containerUri: this.containerUri } as any;
  }
}
