...
import { Token, Lazy, Names } from '../../../core';
...
export class RuntimeEndpoint extends RuntimeEndpointBase {
  ...
  public static readonly PROPERTY_INJECTION_ID: string = 'aws-cdk-lib.aws-bedrockagentcore.RuntimeEndpoint';
  ...
  constructor(scope: Construct, id: string, props: RuntimeEndpointProps) {
    ...
    const cfnProps: bedrockagentcore.CfnRuntimeEndpointProps = {
      ...
      agentRuntimeId: Lazy.string({ produce: () => this.renderAgentRuntimeId() }),
      agentRuntimeVersion: Lazy.string({ produce: () => this.renderAgentRuntimeVersion() }),
      description: Lazy.string({ produce: () => this.renderDescription() }),
      tags: props.tags ?? {},
    };
