...
import type { ICodeInterpreterCustomRef, CodeInterpreterCustomReference } from '../../../aws-bedrockagentcore';
import type {
  MetricOptions,
  MetricProps,
} from '../../../aws-cloudwatch';
...
export abstract class CodeInterpreterCustomBase extends Resource implements ICodeInterpreterCustom {
  ...
  public metric(metricName: string, props?: MetricOptions): Metric {
    const metricProps: MetricProps = {
      ...
      metricName,
      ...props,
      dimensionsMap: { Resource: this.codeInterpreterCustomRef.codeInterpreterArn, ...props?.dimensionsMap },
    };
  ...
  public metricSessionDuration(props?: MetricOptions): Metric {
    return this.metric('Duration', { dimensionsMap: { Operation: 'CodeInterpreterSession' }, statistic: Stats.AVERAGE, ...props });
  }
...
export class CodeInterpreterCustom extends CodeInterpreterCustomBase {
  ...
  public static readonly PROPERTY_INJECTION_ID: string = 'aws-cdk-lib.aws-bedrockagentcore.CodeInterpreterCustom';
   ...
   * The name of the code interpreter
   */
  public readonly codeInterpreterCustomName: string;
  /**
  ...
  constructor(scope: Construct, id: string, props: CodeInterpreterCustomProps = {}) {
    ...
    // ------------------------------------------------------
    this.codeInterpreterCustomName = this.physicalName;
    ...
    throwIfInvalid(this._validateCodeInterpreterName, this.codeInterpreterCustomName);
    ...
    const cfnProps: agent_core.CfnCodeInterpreterCustomProps = {
      name: this.codeInterpreterCustomName,
