...
import { CfnApiKeyCredentialProvider } from '../../../aws-bedrockagentcore';
...
export class ApiKeyCredentialProvider extends ApiKeyCredentialProviderBase {
  ...
  public static readonly PROPERTY_INJECTION_ID: string = 'aws-cdk-lib.aws-bedrockagentcore.ApiKeyCredentialProvider';
  ...
  constructor(scope: Construct, id: string, props: ApiKeyCredentialProviderProps = {}) {
    super(scope, id, {
