...
import { Annotations, Stack, Token, Lazy, Names } from '../../../core';
...
export class PolicyEngineMode {
   ...
   *
   * @param value the raw mode value to pass to CloudFormation
   */
  public static of(value: string): PolicyEngineMode {
    return new PolicyEngineMode(value);
  }
...
export class Gateway extends GatewayBase {
  ...
  public static readonly PROPERTY_INJECTION_ID: string = 'aws-cdk-lib.aws-bedrockagentcore.Gateway';
  /**
  ...
  public static fromGatewayAttributes(
    ...
    class ImportedGateway extends GatewayBase {
      ...
      public readonly gatewayName = attrs.gatewayName;
  ...
  constructor(scope: Construct, id: string, props: GatewayProps = {}) {
    ...
    this.gatewayName = this.physicalName;
    this.validateGatewayName(this.gatewayName);
    ...
    if (this.authorizerConfiguration.authorizerType === GatewayAuthorizerType.NONE) {
      Annotations.of(this).addWarningV2(
        'aws-cdk-lib.aws-bedrockagentcore:noAuthGateway',
    ...
    const _resource = new bedrockagentcore.CfnGateway(this, 'Resource', {
      ...
      exceptionLevel: this.exceptionLevel?.value,
      ...
      policyEngineConfiguration: this.policyEngineConfiguration
        ? {
          ...
          mode: (this.policyEngineConfiguration.mode ?? PolicyEngineMode.ENFORCE).value,
        }
        : undefined,
  ...
  private createDefaultCognitoAuthorizerConfig(): {
    ...
    const userPool = new cognito.UserPool(this, 'UserPool', { signInCaseSensitive: false });
