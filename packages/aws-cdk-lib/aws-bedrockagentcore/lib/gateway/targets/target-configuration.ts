...
import { validateOpenApiSchema } from '../validation-helpers';
...
export abstract class McpTargetConfiguration implements ITargetConfiguration {
   ...
   */
  public _render(): any {
    return { mcp: this.renderMcpConfiguration() };
  }
}
...
export class OpenApiTargetConfiguration extends McpTargetConfiguration {
   ...
   */
  protected renderMcpConfiguration(): any {
    return { openApiSchema: this.apiSchema._render() };
  }
}
...
export class SmithyTargetConfiguration extends McpTargetConfiguration {
   ...
   */
  protected renderMcpConfiguration(): any {
    return { smithyModel: this.smithyModel._render() };
  }
}
...
export class McpServerTargetConfiguration extends McpTargetConfiguration {
  ...
  protected renderMcpConfiguration(): any {
    return {
      mcpServer: { endpoint: this.endpoint },
    };
  }
 ...
 */
export class ApiGatewayHttpMethod {
  /** GET method */
  public static readonly GET = new ApiGatewayHttpMethod('GET');
  /** POST method */
  public static readonly POST = new ApiGatewayHttpMethod('POST');
  /** PUT method */
  public static readonly PUT = new ApiGatewayHttpMethod('PUT');
  /** DELETE method */
  public static readonly DELETE = new ApiGatewayHttpMethod('DELETE');
  /** PATCH method */
  public static readonly PATCH = new ApiGatewayHttpMethod('PATCH');
  /** HEAD method */
  public static readonly HEAD = new ApiGatewayHttpMethod('HEAD');
  /** OPTIONS method */
  public static readonly OPTIONS = new ApiGatewayHttpMethod('OPTIONS');
  ...
  public static of(value: string): ApiGatewayHttpMethod {
    return new ApiGatewayHttpMethod(value);
  }
...
export class ApiGatewayTargetConfiguration extends McpTargetConfiguration {
      ...
      apiGateway: {
        ...
        ...(this.metadataConfiguration && {
          metadataConfiguration: {
            ...(this.metadataConfiguration.allowedQueryParameters && { allowedQueryParameters: this.metadataConfiguration.allowedQueryParameters }),
            ...(this.metadataConfiguration.allowedRequestHeaders && { allowedRequestHeaders: this.metadataConfiguration.allowedRequestHeaders }),
            ...(this.metadataConfiguration.allowedResponseHeaders && { allowedResponseHeaders: this.metadataConfiguration.allowedResponseHeaders }),
          },
        }),
      },
    };
  ...
  private validateConfiguration(): void {
    ...
    if (!Token.isUnresolved(this.restApiId)) {
      const restApiIdErrors = validateStringFieldLength({
    ...
    if (!Token.isUnresolved(this.stage)) {
      const stageErrors = validateStringFieldLength({
        value: this.stage,
  ...
  private validateToolOverride(override: ApiGatewayToolOverride): void {
    ...
    const nameErrors = validateStringFieldLength({
      value: override.name,
    ...
    if (override.description && !Token.isUnresolved(override.description)) {
      const descErrors = validateStringFieldLength({
