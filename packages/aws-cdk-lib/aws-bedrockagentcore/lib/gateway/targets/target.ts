...
export class GatewayTarget extends GatewayTargetBase implements IMcpGatewayTarget {
  ...
  public static readonly PROPERTY_INJECTION_ID: string = 'aws-cdk-lib.aws-bedrockagentcore.GatewayTarget';
  /**
  ...
  public static fromGatewayTargetAttributes(
    ...
    class ImportedGatewayTarget extends GatewayTargetBase {
      ...
      public readonly gatewayTargetName = attrs.gatewayTargetName;
   ...
   * The name of the gateway target
   */
  public readonly gatewayTargetName;
  ...
  constructor(scope: Construct, id: string, props: GatewayTargetProps) {
    super(scope, id, {
      ...
      physicalName: props.gatewayTargetName ??
        Lazy.string({ produce: () => Names.uniqueResourceName(this, { maxLength: 100 }) }),
    });
    ...
    const cfnProps: bedrockagentcore.CfnGatewayTargetProps = {
      ...
      name: this.gatewayTargetName,
      description: this.description,
      credentialProviderConfigurations: Lazy.any({ produce: () => this._renderCredentialProviderConfigurations() }),
