...
describe('ApiGatewayTargetConfiguration with IRestApi', () => {
  ...
  // These tests verify ApiGatewayTargetConfiguration's internal API (property extraction, _render() output).
  // Template-based assertion for the full config rendering in CFN is in target.test.ts ('Should render full API Gateway target configuration in CFN').
