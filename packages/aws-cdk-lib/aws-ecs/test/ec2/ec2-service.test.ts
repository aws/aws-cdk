  ...
  describe('When creating an EC2 Service', () => {
    ...
    describe('with deployment alarms', () => {
      ...
      test('enableDeploymentAlarms concatenates alarms when called multiple times', () => {
        ...
        const alarm3 = cloudwatch.Alarm.fromAlarmArn(stack, 'alarm3', 'arn:aws:cloudwatch:us-east-1:1234567890:alarm:alarm3');
        ...
        service.enableDeploymentAlarms([alarm2.alarmName, alarm3.alarmName]);
