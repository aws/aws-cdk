...
import { DrainHookLambda_Function } from '../../../custom-resource-handlers/dist/aws-ecs/drain-hook-provider.generated';
...
export class InstanceDrainHook extends Construct {
  ...
  constructor(scope: Construct, id: string, props: InstanceDrainHookProps) {
    ...
    const fn = new DrainHookLambda_Function(this, 'Function', {
