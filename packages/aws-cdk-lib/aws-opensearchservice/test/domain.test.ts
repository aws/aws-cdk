...
each(testedOpenSearchVersions).describe('custom error responses', (engineVersion) => {
  ...
  test('error when I3, R6GD, I4G, I4I, IM4GN or R7GD instance types are specified with EBS enabled', () => {
    expect(() => new Domain(stack, 'Domain2', {
      version: engineVersion,
      capacity: {
        dataNodeInstanceType: 'i3.2xlarge.search',
    ...
    expect(() => new Domain(stack, 'Domain6', {
      version: engineVersion,
      capacity: {
        dataNodeInstanceType: 'i4i.xlarge.search',
      },
      ebs: {
        volumeSize: 100,
        volumeType: EbsDeviceVolumeType.GENERAL_PURPOSE_SSD,
    ...
    expect(() => new Domain(stack, 'Domain7', {
      version: engineVersion,
      capacity: {
        dataNodeInstanceType: 'r7gd.xlarge.search',
      },
      ebs: {
        volumeSize: 100,
        volumeType: EbsDeviceVolumeType.GENERAL_PURPOSE_SSD,
  ...
  test('error when any instance type other than R3, I3, R6GD, I4I, I4G, IM4GN or R7GD are specified without EBS enabled', () => {
    expect(() => new Domain(stack, 'Domain1', {
      version: engineVersion,
      ebs: {
        enabled: false,
    ...
    })).toThrow(/EBS volumes are required when using instance types other than R3, I3, R6GD, I4G, I4I, M4GN or R7GD./);
    expect(() => new Domain(stack, 'Domain2', {
      version: engineVersion,
      ebs: {
        enabled: false,
