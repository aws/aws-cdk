...
test('with service not in AWS SDK', () => {
  ...
  // THEN
  Annotations.fromStack(stack).hasWarning('*', 'EventsTargets:Api:no-such-serviceDoesNotExist: Service no-such-service does not exist in the AWS SDK. Check the list of available services and actions from https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/index.html');
});
