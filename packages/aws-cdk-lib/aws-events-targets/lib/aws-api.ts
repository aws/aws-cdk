...
import { AwsApiFunction } from '../../custom-resource-handlers/dist/aws-events-targets/aws-api-provider.generated';
...
export class AwsApi implements events.IRuleTarget {
  ...
  public bind(rule: events.IRule, id?: string): events.RuleTargetConfig {
    const handler = new AwsApiFunction(rule as events.Rule, `${rule.node.id}${id}Handler`, {
