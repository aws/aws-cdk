...
describe('ResponseHeadersPolicy', () => {
  ...
  test('import existing policy by id', () => {
    ...
    const responseHeadersPolicy = ResponseHeadersPolicy.fromResponseHeadersPolicyId(
      stack,
      'MyPolicy',
  ...
  test('managed policies are provided', () => {
    expect(ResponseHeadersPolicy.CORS_ALLOW_ALL_ORIGINS.responseHeadersPolicyId).toEqual(
      '60669652-455b-4ae9-85a4-c4c02393f86c'
    );
    expect(ResponseHeadersPolicy.CORS_ALLOW_ALL_ORIGINS_WITH_PREFLIGHT.responseHeadersPolicyId).toEqual(
      '5cc3b908-e619-4b99-88e5-2cf7f45965bd'
    );
    expect(ResponseHeadersPolicy.SECURITY_HEADERS.responseHeadersPolicyId).toEqual(
      '67f7725c-6f97-4210-82d7-5512b31e9d03'
    );
    expect(ResponseHeadersPolicy.CORS_ALLOW_ALL_ORIGINS_AND_SECURITY_HEADERS.responseHeadersPolicyId).toEqual(
      'e61eb60c-9c35-4d20-a928-2b84e02af89c'
    );
    expect(
      ResponseHeadersPolicy.CORS_ALLOW_ALL_ORIGINS_WITH_PREFLIGHT_AND_SECURITY_HEADERS.responseHeadersPolicyId
    ).toEqual('eaab4381-ed33-4a86-88ca-d9558dc6cd63');
  });
      ...
      ResponseHeadersPolicyConfig: {
        ...
        CorsConfig: {
          ...
          AccessControlAllowHeaders: {
            Items: ['X-Custom-Header-1', 'X-Custom-Header-2'],
          },
  ...
  test('it truncates long auto-generated names', () => {
    new ResponseHeadersPolicy(
      stack,
      'AVeryLongIdThatMightSeemRidiculousButSometimesHappensInCdkPipelinesBecauseTheStageNamesConcatenatedWithTheRegionAreQuiteLongMuchLongerThanYouWouldExpect'
    );
