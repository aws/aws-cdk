...
from SNI only and a minimum protocol version of TLSv1.2_2025 if the `@aws-cdk/aws-cloudfront:defaultSecurityPolicyTLSv1.2_2025` feature flag is set, TLSv1.2_2021 if the `@aws-cdk/aws-cloudfront:defaultSecurityPolicyTLSv1.2_2021` feature flag is set, and TLSv1.2_2019 otherwise.
