...
import { Lazy, Names, Resource, Stack, ValidationError } from '../../core';
...
export class Function extends Resource implements IFunction {
  ...
  constructor(scope: Construct, id: string, props: FunctionProps) {
    ...
    if (props.keyValueStore && this.functionRuntime === FunctionRuntime.JS_1_0.value) {
      throw new ValidationError('Valuestorescannotassociated', `Key Value Stores cannot be associated to functions using the ${this.functionRuntime} runtime`, this);
    }
