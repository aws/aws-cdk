...
export class Distribution extends Resource implements IDistribution {
  ...
  constructor(scope: Construct, id: string, props: DistributionProps) {
    ...
    if (props.certificate) {
      ...
      if (!Token.isUnresolved(certificateRegion) && certificateRegion !== 'us-east-1') {
        throw new ValidationError('Mustbedistributioncertificatesuseast1', `Distribution certificates must be in the us-east-1 region and the certificate you provided is in ${certificateRegion}.`, this);
      }
  ...
  public metricOriginLatency(props?: cloudwatch.MetricOptions): cloudwatch.Metric {
    if (this.publishAdditionalMetrics !== true) {
      throw new ValidationError('OriginLatencyMetricOnly', 'Origin latency metric is only available if \'publishAdditionalMetrics\' is set \'true\'', this);
    }
  ...
  public metricCacheHitRate(props?: cloudwatch.MetricOptions): cloudwatch.Metric {
    if (this.publishAdditionalMetrics !== true) {
      throw new ValidationError('CacheRateMetricOnly', 'Cache hit rate metric is only available if \'publishAdditionalMetrics\' is set \'true\'', this);
    }
  ...
  public metric401ErrorRate(props?: cloudwatch.MetricOptions): cloudwatch.Metric {
    if (this.publishAdditionalMetrics !== true) {
      throw new ValidationError('ErrorRateMetricOnly', '401 error rate metric is only available if \'publishAdditionalMetrics\' is set \'true\'', this);
    }
  ...
  public metric403ErrorRate(props?: cloudwatch.MetricOptions): cloudwatch.Metric {
    if (this.publishAdditionalMetrics !== true) {
      throw new ValidationError('ErrorRateMetricOnly', '403 error rate metric is only available if \'publishAdditionalMetrics\' is set \'true\'', this);
    }
  ...
  public metric404ErrorRate(props?: cloudwatch.MetricOptions): cloudwatch.Metric {
    if (this.publishAdditionalMetrics !== true) {
      throw new ValidationError('ErrorRateMetricOnly', '404 error rate metric is only available if \'publishAdditionalMetrics\' is set \'true\'', this);
    }
  ...
  public metric502ErrorRate(props?: cloudwatch.MetricOptions): cloudwatch.Metric {
    if (this.publishAdditionalMetrics !== true) {
      throw new ValidationError('ErrorRateMetricOnly', '502 error rate metric is only available if \'publishAdditionalMetrics\' is set \'true\'', this);
    }
  ...
  public metric503ErrorRate(props?: cloudwatch.MetricOptions): cloudwatch.Metric {
    if (this.publishAdditionalMetrics !== true) {
      throw new ValidationError('ErrorRateMetricOnly', '503 error rate metric is only available if \'publishAdditionalMetrics\' is set \'true\'', this);
    }
  ...
  public metric504ErrorRate(props?: cloudwatch.MetricOptions): cloudwatch.Metric {
    if (this.publishAdditionalMetrics !== true) {
      throw new ValidationError('ErrorRateMetricOnly', '504 error rate metric is only available if \'publishAdditionalMetrics\' is set \'true\'', this);
    }
  ...
  public addBehavior(pathPattern: string, origin: IOrigin, behaviorOptions: AddBehaviorOptions = {}) {
    if (pathPattern === '*') {
      throw new ValidationError('OnlyDefaultBehaviorPath', 'Only the default behavior can have a path pattern of \'*\'', this);
    }
  ...
  private validateWebAclId(webAclId: string) {
    ...
    if (webAclId.startsWith('arn:')) {
      ...
      if (!Token.isUnresolved(webAclRegion) && webAclRegion !== 'us-east-1') {
        throw new ValidationError('Mustbewebaclcloudfrontdistributions', `WebACL for CloudFront distributions must be created in the us-east-1 region; received ${webAclRegion}`, this);
      }
    }
  }
  ...
  private addOrigin(origin: IOrigin, isFailoverOrigin: boolean = false): string {
    ...
    if (existingOrigin) {
      ...
      if (duplicateId) {
        throw new ValidationError('Originalreadyexists', `Origin with id ${duplicateId.originProperty?.id} already exists. OriginIds must be unique within a distribution`, this);
      }
      if (!originBindConfig.failoverConfig) {
        this.boundOrigins.push({ origin, originId, distributionId, ...originBindConfig });
      } else {
        if (isFailoverOrigin) {
          throw new ValidationError('Origincannotoriginfailover', 'An Origin cannot use an Origin with its own failover configuration as its fallback origin!', this);
        }
  ...
  private addOriginGroup(
    ...
    if (statusCodes.length === 0) {
      throw new ValidationError('Fallbackstatuscodescannotempty', 'fallbackStatusCodes cannot be empty', this);
    }
  ...
  private validateGrpc(behaviorOptions: AddBehaviorOptions) {
    ...
    if (!validHttpVersions.includes(this.httpVersion)) {
      throw new ValidationError('MustBeHttpversionEnablegrpcDefaultbehavior', `'httpVersion' must be ${validHttpVersions.join(' or ')} if 'enableGrpc' in 'defaultBehavior' or 'additionalBehaviors' is true, got ${this.httpVersion}`, this);
    }
  }
}
