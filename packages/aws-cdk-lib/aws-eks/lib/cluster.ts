...
export class Cluster extends ClusterBase {
  ...
  constructor(scope: Construct, id: string, props: ClusterProps) {
    ...
    if (props.outputConfigCommand && !props.mastersRole) {
      Annotations.of(this).addWarningV2('@aws-cdk/aws-eks:clusterMastersroleNotSpecified', 'If you do not specify \'mastersRole\', you won\'t have access to the cluster from outside of the CDK application.\nsee: https://docs.aws.amazon.com/cdk/api/v2/docs/aws-cdk-lib.aws_eks-readme.html#masters-role');
    }
