...
export class Nodegroup extends Resource implements INodegroup {
  ...
  constructor(scope: Construct, id: string, props: NodegroupProps) {
    ...
    if (props.instanceType) {
      Annotations.of(this).addWarningV2('EKS:ManagedNodeGroup:DeprecatedInstanceType', '"instanceType" is deprecated and will be removed in the next major version. please use "instanceTypes" instead');
    }
