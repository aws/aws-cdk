...
import { OnEventFunction, IsCompleteFunction } from '../../custom-resource-handlers/dist/aws-eks/cluster-resource-provider.generated';
...
export class ClusterResourceProvider extends NestedStack {
  ...
  private constructor(scope: Construct, id: string, props: ClusterResourceProviderProps) {
    ...
    const onEvent = new OnEventFunction(this, 'OnEventHandler', {
    ...
    const isComplete = new IsCompleteFunction(this, 'IsCompleteHandler', {
