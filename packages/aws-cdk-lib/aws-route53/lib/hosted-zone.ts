...
export interface CommonHostedZoneProps {
   ...
   * @default true
   */
  readonly addTrailingDot?: boolean | undefined;
   ...
   * @default disabled
   */
  readonly queryLogsLogGroupArn?: string | undefined;
}
...
export class HostedZone extends Resource implements IHostedZone {
  ...
  public readonly hostedZoneNameServers?: string[] | undefined;
...
export interface PublicHostedZoneProps extends CommonHostedZoneProps {
   ...
   * @default false
   */
  readonly caaAmazon?: boolean | undefined;
   ...
   */
  readonly crossAccountZoneDelegationPrincipal?: iam.IPrincipal | undefined;
   ...
   * @deprecated Create the Role yourself and call `hostedZone.grantDelegation()`.
   */
  readonly crossAccountZoneDelegationRoleName?: string | undefined;
}
...
export class PublicHostedZone extends HostedZone implements IPublicHostedZone {
   ...
   */
  public readonly crossAccountZoneDelegationRole?: iam.Role | undefined;
