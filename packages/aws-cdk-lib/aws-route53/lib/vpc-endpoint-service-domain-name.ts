...
export class VpcEndpointServiceDomainName extends Construct {
  ...
  private validateProps(props: VpcEndpointServiceDomainNameProps): void {
    ...
    if (serviceUniqueId in VpcEndpointServiceDomainName.endpointServicesMap) {
      ...
      throw new ValidationError('CannotCannotcannotcreatevpcendpointservicedomainname', `Cannot create a VpcEndpointServiceDomainName for service ${serviceUniqueId}, another VpcEndpointServiceDomainName (${endpoint}) is already associated with it`, this);
    }
  }
