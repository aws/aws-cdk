...
export class RecordSet extends Resource implements IRecordSet {
  ...
  constructor(scope: Construct, id: string, props: RecordSetProps) {
    ...
    if (props.deleteExisting) {
      ...
      const provider = DeleteExistingRecordSetProvider.getOrCreateProvider(
        this,
        DELETE_EXISTING_RECORD_SET_RESOURCE_TYPE,
        {
          policyStatements: [
            {
              // IAM permissions for all providers
              Effect: 'Allow',
...
export class CrossAccountZoneDelegationRecord extends Construct {
  constructor(scope: Construct, id: string, props: CrossAccountZoneDelegationRecordProps) {
    ...
    const provider = CrossAccountZoneDelegationProvider.getOrCreateProvider(
      this,
