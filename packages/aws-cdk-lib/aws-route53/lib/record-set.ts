...
import { CustomResource, CustomResourceProvider, Duration, IResource, RemovalPolicy, Resource, Token } from '../../core';
  ...
  constructor(scope: Construct, id: string, props: RecordSetProps) {
    ...
    if (props.deleteExisting) {
      ...
      const provider = CustomResourceProvider.getOrCreateProvider(this, DELETE_EXISTING_RECORD_SET_RESOURCE_TYPE, {
        ...
        runtime: CustomResourceProvider.regionalDefaultRuntime(this),
