      ...
      public get logStreamRef() {
        return {
          get logGroupName(): string {
            throw new UnscopedValidationError('AccessLoggroupnameLogstreamObtained', 'Cannot access logGroupName on a LogStream obtained from fromLogStreamName. Use LogStream.fromLogStreamAttributes() instead.');
          },
