...
const defaultExpectedEcsProps: CfnComputeEnvironmentProps = {
  ...
  computeResources: {
    ...
    minvCpus: 0,
    subnets: [{ Ref: 'vpcPrivateSubnet1Subnet934893E8' } as any, { Ref: 'vpcPrivateSubnet2Subnet7031C2BA' } as any],
...
describe.each([ManagedEc2EcsComputeEnvironment, ManagedEc2EksComputeEnvironment])(
  ...
  (ComputeEnvironment) => {
    ...
    test('instance types are correctly rendered', () => {
      ...
      Template.fromStack(stack).hasResourceProperties('AWS::Batch::ComputeEnvironment', {
        ...
        ComputeResources: {
          ...defaultComputeResources,
          InstanceTypes: ['r4.large', 'c4.large', 'm4', 'optimal'],
        },
      });
    });
    ...
    test('respects security groups', () => {
      ...
      new ComputeEnvironment(stack, 'MyCE', {
        ...defaultProps,
        securityGroups: [
          new ec2.SecurityGroup(stack, 'TestSG', {
            vpc,
    ...
    test('respects vpcSubnets', () => {
      ...
      new ComputeEnvironment(stack, 'MyCE', {
        ...
        vpcSubnets: {
          subnets: [
            new ec2.Subnet(stack, 'testSubnet', {
      ...
      Template.fromStack(stack).hasResourceProperties('AWS::Batch::ComputeEnvironment', {
        ...
        ComputeResources: {
          ...defaultComputeResources,
          Subnets: [{ Ref: 'testSubnet42F0FA0C' }],
        },
      });
    });
    ...
    test('can be imported from arn', () => {
      // WHEN
      const ce = ManagedEc2EcsComputeEnvironment.fromManagedEc2EcsComputeEnvironmentArn(
        stack,
        'import',
...
describe('ManagedEc2EcsComputeEnvironment', () => {
  ...
  test('Amazon Linux 2023 does not support A1 instances.', () => {
    expect(
      () =>
        new ManagedEc2EcsComputeEnvironment(stack, 'Al2023A1InstanceClass', {
          ...defaultEcsProps,
...
describe('FargateComputeEnvironment', () => {
  ...
  test('can be imported from arn', () => {
    // WHEN
    const ce = FargateComputeEnvironment.fromFargateComputeEnvironmentArn(
      stack,
      'import',
      'arn:aws:batch:us-east-1:123456789012:compute-environment/ce-name'
    );
