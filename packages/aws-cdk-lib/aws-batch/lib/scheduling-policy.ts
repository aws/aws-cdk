 ...
 */
export interface ISchedulingPolicy extends IResource, interfaces.aws_batch.ISchedulingPolicyRef {
  /**
...
export abstract class SchedulingPolicyBase extends Resource implements ISchedulingPolicy {
  ...
  public get schedulingPolicyRef(): interfaces.aws_batch.SchedulingPolicyReference {
    return {
