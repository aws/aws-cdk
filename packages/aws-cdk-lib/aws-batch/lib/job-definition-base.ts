...
export interface JobDefinitionProps {
   ...
   * @default - no `RetryStrategy`
   */
  readonly retryStrategies?: RetryStrategy[] | undefined;
...
export abstract class JobDefinitionBase extends Resource implements IJobDefinition {
  ...
  public readonly parameters?: { [key:string]: any } | undefined;
  public readonly retryAttempts?: number | undefined;
  public readonly retryStrategies: RetryStrategy[];
  public readonly schedulingPriority?: number | undefined;
