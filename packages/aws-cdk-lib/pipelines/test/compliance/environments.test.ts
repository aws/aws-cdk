        ...
        Match.objectLike({
          ...
          Principal: {
            AWS: {
              'Fn::Join': [
                '',
                ['arn:', { Ref: 'AWS::Partition' }, stringLike('*-deploy-role-*'), { Ref: 'AWS::Region' }],
              ],
            },
          },
        }),
        ...
        Actions: [
          Match.objectLike({
            ...
            RoleArn: {
              'Fn::Join': [
                '',
                ['arn:', { Ref: 'AWS::Partition' }, ':iam::you:role/cdk-hnb659fds-deploy-role-you-elsewhere'],
              ],
            },
            Region: 'elsewhere',
            Configuration: Match.objectLike({
              ...
              RoleArn: {
                'Fn::Join': [
                  '',
                  ['arn:', { Ref: 'AWS::Partition' }, ':iam::you:role/cdk-hnb659fds-cfn-exec-role-you-elsewhere'],
                ],
              },
            }),
          }),
    ...
    PolicyDocument: {
      Statement: Match.arrayWith([
        Match.objectLike({
          ...
          Principal: {
            AWS: {
              'Fn::Join': ['', ['arn:', { Ref: 'AWS::Partition' }, stringLike('*-deploy-role-*')]],
            },
          },
        }),
      ]),
