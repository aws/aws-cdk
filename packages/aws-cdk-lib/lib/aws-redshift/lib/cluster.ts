...
import { ArnFormat, CustomResource, Duration, IResource, Lazy, RemovalPolicy, Resource, SecretValue, Stack, Token } from '../../core';
import { AwsCustomResource, AwsCustomResourcePolicy, PhysicalResourceId, Provider } from '../../custom-resources';
