...
export * as aws_iot_actions from './aws-iot-actions';
...
export * as aws_iotevents_actions from './aws-iotevents-actions';
...
export * as aws_kinesisanalytics_flink from './aws-kinesisanalytics-flink';
export * as aws_kinesisanalyticsv2 from './aws-kinesisanalyticsv2';
export * as aws_kinesisfirehose from './aws-kinesisfirehose';
export * as aws_kinesisfirehose_destinations from './aws-kinesisfirehose-destinations';
...
export * as aws_lambda_go from './aws-lambda-go';
export * as aws_lambda_nodejs from './aws-lambda-nodejs';
export * as aws_lambda_python from './aws-lambda-python';
...
export * as integ_tests from './integ-tests';
