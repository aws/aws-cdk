...
describe('Schedule class', () => {
  test.each([
    ...
    {
      schedule: tasks.Schedule.cron({ minute: '0', hour: '12', day: '29', month: '12' }),
      expression: 'cron(0 12 29 12 ? *)',
    },
    {
      schedule: tasks.Schedule.cron({ minute: '0', hour: '12', day: '29', month: '12', year: '2023' }),
      expression: 'cron(0 12 29 12 ? 2023)',
    },
