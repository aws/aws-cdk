...
describe('EvaluateExpression expression shapes', () => {
  ...
  describe('SAFE - synthesizes and binds each referenced path', () => {
  ...
  describe('THROWS - a path used as literal text inside a string or template', () => {
  ...
  describe('GUARD - tokenized expressions skip the literal-text check', () => {
