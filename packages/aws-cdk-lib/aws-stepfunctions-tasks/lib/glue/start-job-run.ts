  ...
  protected _renderTask(topLevelQueryLanguage?: sfn.QueryLanguage): any {
    ...
    if (this.props.workerConfiguration) {
      ...
      if (workerConfiguration?.workerTypeV2 && workerConfiguration.workerType) {
        throw new ValidationError('CannotSetBothWorkerTypeAndWorkerTypeV2', 'You cannot set both \'workerType\' and \'workerTypeV2\' properties in \'workerConfiguration\'.', this);
      }
      if (!workerConfiguration.workerTypeV2 && !workerConfiguration.workerType) {
        throw new ValidationError('EitherWorkerTypeOrWorkerTypeV2Required', 'You must set either \'workerType\' or \'workerTypeV2\' property in \'workerConfiguration\'.', this);
      }
    }
