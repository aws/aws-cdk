 ...
 * construct fail fast at synth. This is a convenience check, not a security control: the
 ...
 *
 * Known limitations, both rare in an EvaluateExpression and never unsafe: we misread
 * expression-expecting keywords like `typeof /re/` as division, and we don't model
 * `//` or `/*` comments.
 */
