...
// interface writeProvisionedThroughputSettingsProps {
//       /**
...
//   readonly targetTrackingScalingPolicyConfiguration: targetTrackingScalingPolicyConfigurationProps
// }

// interface targetTrackingScalingPolicyConfigurationProps {
//     targetValue: number
// }
...
export interface GlobalSecondaryIndexProps extends SecondaryIndexProps, SchemaOptions {
     ...
     * This policy will be applied to all replicas. This setting must be specified
     * if `BillingMode` is set to `PROVISIONED`.
     */
    writeProvisionedThroughputSettings?: CfnGlobalTable.WriteProvisionedThroughputSettingsProperty
...
export class GlobalTable extends TableBase {
    ...
    public addReplica(props: ReplicaProps) {
        this.replicaGlobalSecondaryIndexes.map((rep: any) => {
            if(rep.indexName === props.replicaGlobalSecondaryIndexSpecification?.indexName) {
                rep.readProvisionedThroughputSettings = props.replicaGlobalSecondaryIndexSpecification?.readProvisionedThroughputSettings
            }
        })
        this.replicas.push({
            contributorInsightsSpecification: props.contributorInsightsEnabled !== undefined ? { enabled: props.contributorInsightsEnabled } : undefined,
            ...
            region: props.region,
            tableClass: props.tableClass,
            readProvisionedThroughputSettings: props.readProvisionedThroughputSettings,
            globalSecondaryIndexes: this.replicaGlobalSecondaryIndexes,
        })
    }
    ...
    public addGlobalSecondaryIndex(props: GlobalSecondaryIndexProps) {
        ...
        this.globalSecondaryIndexes.push({
            ...
            writeProvisionedThroughputSettings: props.writeProvisionedThroughputSettings,
        });
...
class SourceTableAttachedPolicy extends Construct implements iam.IGrantable {
    ...
    public constructor(sourceTable: GlobalTable, role: iam.IRole) {
...
interface explicitProps {
    table: CfnGlobalTable.CapacityAutoScalingSettingsProperty | number
    globalSecondaryIndexes?: {
        [indexname: string]: CfnGlobalTable.CapacityAutoScalingSettingsProperty | number
    }
}
