...
export enum DatadogLogsEndpointUrl {
	 ...
	 * Japan Location
	 */
	DATADOG_LOGS_AP1 = "https://aws-kinesis-http-intake.logs.ap1.datadoqhq.com/api/v2/logs?dd-protocol=aws-kinesis-firehose",
	/**
	 * EU Location
	 */
...
export interface DatadogProps {
	 ...
	 */
	readonly url:
		| DatadogLogsEndpointUrl
		| DatadogMetricsEndpointUrl
		| DatadogConfigurationsEndpointUrl;
	/**
