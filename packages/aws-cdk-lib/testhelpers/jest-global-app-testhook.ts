...
(globalThis as any)[APP_INIT_HOOK_SYMBOL] = (app: cdk.App) => {
  cdk.Validations.of(app).acknowledge(
    ...
    { id: 'CloudFormation-Validate::W3697', reason: 'Service in maintenance mode, no reason not to test' },
    { id: 'CloudFormation-Validate::F3031', reason: 'Some test value does not match the expected regex' },
    { id: 'CloudFormation-Validate::E1150', reason: 'Bogus security group IDs in tests' },
    ...
    { id: 'CloudFormation-Validate::E3620', reason: 'Instance type not available in that region' },
    { id: 'CloudFormation-Validate::E3628', reason: 'Instance type not available in that region' },
    { id: 'CloudFormation-Validate::E3652', reason: 'Elasticsearch instance not available in that region' },
    { id: 'CloudFormation-Validate::W3030', reason: 'Enum values in tests may not match the latest service schema' },
    ...
    { id: 'CloudFormation-Validate::W9013', reason: 'Hardcoded account IDs in ARNs. Fine for tests.' },
    { id: 'CloudFormation-Validate::W3660', reason: 'Tests intentionally add Methods to SpecRestApi with an inline/external body' },
    ...
    { id: 'CloudFormation-Validate::F3032', reason: 'Some tests pass empty arrays to validate passthrough behavior' },
  );
};
