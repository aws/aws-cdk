...
import { ICfnDBCluster } from './rds.generated';
 ...
 */
export interface IDatabaseCluster extends IResource, ec2.IConnectable, secretsmanager.ISecretAttachmentTarget, ICfnDBCluster {
  /**
