...
connections to the database and improve scalability of the application. Learn more about at [Amazon RDS Proxy](https://aws.amazon.com/rds/proxy/). Proxies require an engine family to be specified on the database cluster or instance.
