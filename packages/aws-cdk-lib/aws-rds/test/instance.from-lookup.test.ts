...
describe('DatabaseInstanceBase from lookup with VpcSecurityGroupIds', () => {
  test('return correct instance info', () => {
    // GIVEN
    const resultObjs = [
      {
...
describe('DatabaseInstanceBase from lookup with empty DBSecurityGroups and valid VpcSecurityGroupIds', () => {
  test('return correct instance info', () => {
    // GIVEN
    const resultObjs = [
      {
