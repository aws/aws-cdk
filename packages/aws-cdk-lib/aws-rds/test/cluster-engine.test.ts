...
describe('cluster engine', () => {
  ...
  test('cluster parameter group correctly determined for AURORA_POSTGRESQL and given version', () => {
    ...
    const engine_VER_18_4 = DatabaseClusterEngine.auroraPostgres({
      version: AuroraPostgresEngineVersion.VER_18_4,
    });
    ...
    expect(engine_VER_18_4.parameterGroupFamily).toEqual('aurora-postgresql18');
  });
