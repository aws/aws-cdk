...
import { CertificateRequestFunction } from '../../custom-resource-handlers/dist/aws-certificatemanager/certificate-request-provider.generated';
...
export class DnsValidatedCertificate extends CertificateBase implements ICertificate, cdk.ITaggable {
  ...
  */
  ...
  constructor(scope: Construct, id: string, props: DnsValidatedCertificateProps) {
    ...
    const requestorFunction = new CertificateRequestFunction(this, 'CertificateRequestorFunction', {
