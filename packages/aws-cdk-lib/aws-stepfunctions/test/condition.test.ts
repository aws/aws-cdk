...
describe('Condition Variables', () => {
  test('Condition variables must start with $. or $[', () => {
    ...
    test('NotConditon must render properly', () => {
      assertRendersTo(stepfunctions.Condition.not(stepfunctions.Condition.stringEquals('$.a', 'b')), {
    ...
    test('Exercise string conditions', () => {
      const cases: Array<[stepfunctions.Condition, object]> = [
        ...
        [stepfunctions.Condition.stringLessThanEquals('$.a', 'foo'), { Variable: '$.a', StringLessThanEquals: 'foo' }],
        [
          stepfunctions.Condition.stringLessThanEqualsJsonPath('$.a', '$.b'),
          { Variable: '$.a', StringLessThanEqualsPath: '$.b' },
        ],
        [stepfunctions.Condition.stringGreaterThan('$.a', 'foo'), { Variable: '$.a', StringGreaterThan: 'foo' }],
        [
          stepfunctions.Condition.stringGreaterThanJsonPath('$.a', '$.b'),
        ...
        [
          stepfunctions.Condition.stringGreaterThanEqualsJsonPath('$.a', '$.b'),
    ...
    test('Exercise number conditions', () => {
      const cases: Array<[stepfunctions.Condition, object]> = [
        ...
        [
          stepfunctions.Condition.numberGreaterThanEqualsJsonPath('$.a', '$.b'),
    ...
    test('Exercise timestamp conditions', () => {
      const cases: Array<[stepfunctions.Condition, object]> = [
        [
          stepfunctions.Condition.timestampEquals('$.a', 'timestamp'),
          { Variable: '$.a', TimestampEquals: 'timestamp' },
        ],
        [
          stepfunctions.Condition.timestampEqualsJsonPath('$.a', '$.b'),
          { Variable: '$.a', TimestampEqualsPath: '$.b' },
        ],
        [
          stepfunctions.Condition.timestampLessThan('$.a', 'timestamp'),
          { Variable: '$.a', TimestampLessThan: 'timestamp' },
        ],
        [
          stepfunctions.Condition.timestampLessThanJsonPath('$.a', '$.b'),
          { Variable: '$.a', TimestampLessThanPath: '$.b' },
        ],
        [
          stepfunctions.Condition.timestampGreaterThan('$.a', 'timestamp'),
          { Variable: '$.a', TimestampGreaterThan: 'timestamp' },
        ],
        [
          stepfunctions.Condition.timestampGreaterThanJsonPath('$.a', '$.b'),
          { Variable: '$.a', TimestampGreaterThanPath: '$.b' },
        ],
        [
          stepfunctions.Condition.timestampLessThanEquals('$.a', 'timestamp'),
          { Variable: '$.a', TimestampLessThanEquals: 'timestamp' },
        ],
        [
          stepfunctions.Condition.timestampLessThanEqualsJsonPath('$.a', '$.b'),
          { Variable: '$.a', TimestampLessThanEqualsPath: '$.b' },
        ],
        [
          stepfunctions.Condition.timestampGreaterThanEquals('$.a', 'timestamp'),
          { Variable: '$.a', TimestampGreaterThanEquals: 'timestamp' },
        ],
        [
          stepfunctions.Condition.timestampGreaterThanEqualsJsonPath('$.a', '$.b'),
