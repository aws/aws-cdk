      ...
      expect(render(map)).toStrictEqual({
        ...
        States: {
          'Map State': {
            ...
            ItemReader: {
              Resource: {
                'Fn::Join': ['', ['arn:', { Ref: 'AWS::Partition' }, ':states:::s3:listObjectsV2']],
              },
              ReaderConfig: {
                MaxItems: 10,
              },
      ...
      expect(render(map)).toStrictEqual({
        ...
        States: {
          'Map State': {
            ...
            ItemReader: {
              Resource: {
                'Fn::Join': ['', ['arn:', { Ref: 'AWS::Partition' }, ':states:::s3:getObject']],
              },
              ReaderConfig: {
                InputType: 'JSON',
              },
      ...
      expect(render(map)).toStrictEqual({
        ...
        States: {
          'Map State': {
            ...
            ResultWriter: {
              Resource: {
                'Fn::Join': ['', ['arn:', { Ref: 'AWS::Partition' }, ':states:::s3:putObject']],
              },
              Parameters: {
                Bucket: {
