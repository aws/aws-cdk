...
export interface RuleTargetConfig {
   ...
   * @deprecated Target authors should not set this. Users wishing to set a
   * custom target id should pass it via the second argument of
   * `Rule.addTarget(target, { id })`.
   */
  readonly id?: string;
