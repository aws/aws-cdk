...
export interface RuleTargetConfig {
   ...
   */
  readonly batchParameters?: CfnRule.BatchParametersProperty | undefined;

  /**
   * Contains information about a dead-letter queue configuration.
   * @default no dead-letter queue set
   */
  readonly deadLetterConfig?: CfnRule.DeadLetterConfigProperty | undefined;

  /**
   * A RetryPolicy object that includes information about the retry policy settings.
   * @default EventBridge default retry policy
   */
  readonly retryPolicy?: CfnRule.RetryPolicyProperty | undefined;

  /**
   * Contains the GraphQL operation to be parsed and executed, if the event target is an AWS AppSync API.
   * @default - None
   */
  readonly appSyncParameters?: CfnRule.AppSyncParametersProperty | undefined;

  /**
   * The Amazon ECS task definition and task count to use, if the event target
   * is an Amazon ECS task.
   */
  readonly ecsParameters?: CfnRule.EcsParametersProperty | undefined;
   ...
   * @default - None
   */
  readonly httpParameters?: CfnRule.HttpParametersProperty | undefined;
   ...
   * partition key.
   */
  readonly kinesisParameters?: CfnRule.KinesisParametersProperty | undefined;

  /**
   * Parameters used when the rule invokes Amazon EC2 Systems Manager Run
   * Command.
   */
  readonly runCommandParameters?: CfnRule.RunCommandParametersProperty | undefined;

  /**
   * Parameters used when the FIFO sqs queue is used an event target by the
   * rule.
   */
  readonly sqsParameters?: CfnRule.SqsParametersProperty | undefined;
   ...
   * @default - no parameters set
   */
  readonly redshiftDataParameters?: CfnRule.RedshiftDataParametersProperty | undefined;
   ...
   */
  readonly input?: RuleTargetInput | undefined;
   ...
   */
  readonly targetResource?: IConstruct | undefined;
}
