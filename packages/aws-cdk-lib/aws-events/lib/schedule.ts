  ...
  public static cron(options: CronOptions): Schedule {
    ...
    return new class extends Schedule {
      ...
      public _bind(scope: Construct) {
        if (!options.minute) {
          Annotations.of(scope).addWarningV2('Events:Schedule:WillRunEveryMinute', 'cron: If you don\'t pass \'minute\', by default the event runs every minute. Pass \'minute: \'*\'\' if that\'s what you intend, or \'minute: 0\' to run once per hour instead.');
        }
