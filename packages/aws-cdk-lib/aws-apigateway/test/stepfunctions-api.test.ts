...
describe('Step Functions api', () => {
  test('StepFunctionsRestApi defines correct REST API resources', () => {
    ...
    Template.fromStack(stack).hasResourceProperties('AWS::ApiGateway::Method', {
      ...
      ResourceId: {
        'Fn::GetAtt': ['StepFunctionsRestApiC6E3E883', 'RootResourceId'],
      },
      Integration: {
        Credentials: {
          'Fn::GetAtt': ['StepFunctionsRestApiANYStartSyncExecutionRole425C03BB', 'Arn'],
        },
  ...
  test('StepFunctionsExecutionIntegration on a method', () => {
    ...
    Template.fromStack(stack).hasResourceProperties('AWS::ApiGateway::Method', {
      ...
      Integration: {
        Credentials: {
          'Fn::GetAtt': ['ApisfnPOSTStartSyncExecutionRole8E8879B0', 'Arn'],
        },
        IntegrationHttpMethod: 'POST',
        IntegrationResponses: getIntegrationResponse(),
        RequestTemplates: {
