...
describe('Layout', () => {
  test('row has the height of the tallest element', () => {
    // WHEN
    const row = new Row(new Spacer({ width: 10, height: 1 }), new Spacer({ width: 10, height: 4 }));
  ...
  test('column has the width of the tallest element', () => {
    // WHEN
    const col = new Column(new Spacer({ width: 1, height: 1 }), new Spacer({ width: 4, height: 4 }));
  ...
  test('add a widget to the column', () => {
    const column = new Column(new Spacer(), new Spacer());
  ...
  test('row wraps when adding widgets', () => {
    const row = new Row(new Spacer({ width: 10 }), new Spacer({ width: 10 }));
