...
/**
 * Log levels for Lambda Event Source Mapping system logging
 */
 ...
 * Configuration for system logging from the event source mapping poller
 *
 * This configuration controls the verbosity of system logs generated by the polling infrastructure
...
export interface LoggingConfig {
  /**
   * The system log level for the event source mapping poller
   *
   * Controls the verbosity of system logs generated by the polling infrastructure.
   ...
   * const debugLoggingConfig: lambda.LoggingConfig = {
   *   systemLogLevel: lambda.EventSourceMappingLogLevel.DEBUG
   * };
   */
  readonly systemLogLevel: EventSourceMappingLogLevel;
}
