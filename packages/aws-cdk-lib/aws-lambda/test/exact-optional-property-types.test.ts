...
import { Alias, IAlias, Version, IVersion } from '../lib';

declare const alias: Alias;
const _alias: IAlias = alias;
void _alias;

declare const version: Version;
const _version: IVersion = version;
void _version;
`;
...
describe('exactOptionalPropertyTypes assignability (issue #37996)', () => {
  ...
  test('aws-lambda concrete classes are assignable to their interfaces under the flag', () => {
