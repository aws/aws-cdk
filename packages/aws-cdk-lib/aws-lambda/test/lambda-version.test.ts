...
describe('lambda version', () => {
  ...
  testDeprecated('addAlias can be used to add an alias that points to a version', () => {
    ...
    Template.fromStack(stack).hasResourceProperties('AWS::Lambda::Alias', {
      ...
      FunctionVersion: {
        'Fn::GetAtt': [
          'FnCurrentVersion17A89ABB47320fcc0a7cb943f487b263083e2bb3',
          'Version',
        ],
      },
      Name: 'foo',
  ...
  test('edgeArn', () => {
    ...
    // THEN
    expect(stack.resolve(version.edgeArn)).toEqual({ Ref: 'FnCurrentVersion17A89ABB47320fcc0a7cb943f487b263083e2bb3' });
  });
