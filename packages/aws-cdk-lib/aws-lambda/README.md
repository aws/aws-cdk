...
layers in the same account. If the source bucket is imported and its policy cannot
be modified by CDK, configure these permissions on the bucket before deployment.
