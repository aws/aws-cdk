      ...
      public get userPoolResourceServerRef(): UserPoolResourceServerReference {
        return {
          ...
          get userPoolId(): string {
            throw new UnscopedValidationError('UserpoolidAvailableUserpoolresourceserver', 'userPoolId is not available on UserPoolResourceServer.fromUserPoolResourceServiceId().');
          },
        };
      }
    }
