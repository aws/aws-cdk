...
/**
 * The intrinsic function ``Fn::AccountIdFromAlias`` which resolves an AWS account
 * alias to its account id. This function is typically used to to reference another
 * account within your template.
 */
