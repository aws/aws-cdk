...
export class CfnParameter extends CfnElement {
  ...
  public get valueAsString(): string {
    if (!isStringType(this.type) && !isNumberType(this.type)) {
      throw new ValidationError('Parametertypestringnumber', `Parameter type (${this.type}) is not a string or number type`, this);
    }
  ...
  public get valueAsList(): string[] {
    if (!isListType(this.type)) {
      throw new ValidationError('Parametertypestringlist', `Parameter type (${this.type}) is not a string list type`, this);
    }
  ...
  public get valueAsNumber(): number {
    if (!isNumberType(this.type)) {
      throw new ValidationError('Parametertypenumbertype', `Parameter type (${this.type}) is not a number type`, this);
    }
