...
describe('removal policy', () => {
  test.each([
    ...
    'should set correct DeletionPolicy for RemovalPolicy.%s',
    (removalPolicy: RemovalPolicy, deletionPolicy: string) => {
  ...
  test.each([
    ...
    'should set correct UpdateReplacePolicy for RemovalPolicy.%s',
    (removalPolicy: RemovalPolicy, updateReplacePolicy: string) => {
      const stack = new Stack();
