...
export class ArbitraryCompleteIntervals extends fc.Arbitrary<
  scalingcommon.CompleteScalingInterval[]
> {
  ...
  public canShrinkWithoutContext(
    _value: unknown
  ): _value is scalingcommon.CompleteScalingInterval[] {
    return false;
  }

  public shrink(
    _value: scalingcommon.CompleteScalingInterval[],
    _context: unknown
  ): fc.Stream<fc.Value<scalingcommon.CompleteScalingInterval[]>> {
