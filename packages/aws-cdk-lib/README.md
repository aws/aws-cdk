...
CDK Mixins provide composable abstractions that allow you to pick and choose exactly the capabilities you need for constructs.
They are applied using the `.with()` method:
...
See the [Mixins module documentation](https://docs.aws.amazon.com/cdk/api/v2/docs/aws-cdk-lib.mixins-readme.html) for the full API including `Mixins.of()`, construct selectors, custom Mixins, and validation.
