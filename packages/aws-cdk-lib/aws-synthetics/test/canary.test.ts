...
test.each([
  ...
  synthetics.Runtime.SYNTHETICS_NODEJS_PLAYWRIGHT_3_0,
  synthetics.Runtime.SYNTHETICS_NODEJS_PLAYWRIGHT_4_0,
  synthetics.Runtime.SYNTHETICS_NODEJS_PLAYWRIGHT_5_0,
