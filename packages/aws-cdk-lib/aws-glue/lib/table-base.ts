...
import type { CfnTable } from './glue.generated';
...
import { ArnFormat, CustomResource, Duration, Fn, Lazy, Names, Resource, Stack, Token, UnscopedValidationError, ValidationError } from '../../core';
import { lit, md5hash } from '../../core/lib/helpers-internal';
import { PartitionIndexIsCompleteFunction, PartitionIndexOnEventFunction } from '../../custom-resource-handlers/dist/aws-glue/partition-index-provider.generated';
