...
import { HostedConfiguration, SourcedConfiguration, IConfiguration } from '../lib';

declare const hosted: HostedConfiguration;
const _hosted: IConfiguration = hosted;
void _hosted;

declare const sourced: SourcedConfiguration;
const _sourced: IConfiguration = sourced;
void _sourced;
`;
...
describe('exactOptionalPropertyTypes assignability (issue #37996)', () => {
  ...
  test('aws-appconfig concrete classes are assignable to their interfaces under the flag', () => {
