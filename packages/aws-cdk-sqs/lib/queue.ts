...
export interface QueueProps {
     ...
     */
    encryptionMasterKey?: EncryptionKeyRef;
...
export class Queue extends QueueRef {
    ...
    constructor(parent: Construct, name: string, props: QueueProps = {}) {
        super(parent, name);
    ...
    private determineEncryptionProps(props: QueueProps): EncryptionProps {
        ...
        if (props.encryption === QueueEncryption.Kms) {
            const encryptionKey = props.encryptionMasterKey || new EncryptionKey(this, 'Key', {
