...
/**
 * The `AWS::SQS::Queue` Interface
 */
export interface ICfnQueue extends constructs.IConstruct, lambda.CfnFunction.IDeadLetterConfigTargetProperty {
  /**
 ...
 */
export class CfnQueue extends cdk.CfnResource implements ICfnQueue, lambda.CfnFunction.IDeadLetterConfigTargetProperty, cdk.IInspectable, cdk.ITaggable {
  /**
