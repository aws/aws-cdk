...
/**
 * The `AWS::SNS::Topic` resource Interface
 */
export interface ICfnTopic extends constructs.IConstruct, lambda.CfnFunction.IDeadLetterConfigTargetProperty {
  /**
 ...
 */
export class CfnTopic extends cdk.CfnResource implements ICfnTopic, lambda.CfnFunction.IDeadLetterConfigTargetProperty, cdk.IInspectable, cdk.ITaggable {
  /**
   * The CloudFormation resource type name for this resource class.
   */
