...
export interface DeployStackOptions {
  stack: cxapi.ICloudFormationStackArtifact;
  sdk: SDK;
 ...
 */
async function makeBodyParameter(stack: cxapi.ICloudFormationStackArtifact, toolkitInfo?: ToolkitInfo): Promise<TemplateBodyParameter> {
