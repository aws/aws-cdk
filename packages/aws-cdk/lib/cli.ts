...
async function parseCommandLineArguments() {
  ...
  return yargs
    ...
    .command('bootstrap [ENVIRONMENTS..]', 'Deploys the CDK toolkit stack into an AWS environment', (yargs: Argv) => yargs
      ...
      .option('use-default-permissions-boundary', { type: 'boolean', alias: ['dpb', 'default-permissions-boundary'], desc: 'Use the default permissions boundary.', default: undefined, conflicts: 'permissions-boundary' })
      .option('permissions-boundary', { type: 'string', alias: ['pb', 'permissions-boundary'], desc: 'Use the permissions boundary specified by name.', default: undefined, conflicts: 'use-default-permissions-boundary' })
