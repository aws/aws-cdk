...
async function parseCommandLineArguments() {
  ...
  return yargs
    ...
    .command('bootstrap [ENVIRONMENTS..]', 'Deploys the CDK toolkit stack into an AWS environment', (yargs: Argv) => yargs
      ...
      .option('create-default-permissions-boundary', { type: 'string', alias: ['pb', 'permissions-boundary'], desc: 'The default permissions boundary will be used', default: undefined })
