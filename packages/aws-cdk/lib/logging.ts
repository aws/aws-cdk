 ...
 */
export const error = async (fmt: string, ...args: unknown[]) => {
  await convenienceLog('error', false, fmt, undefined, ...args);
};
 ...
 */
export const warning = async (fmt: string, ...args: unknown[]) => {
  await convenienceLog('warn', false, fmt, undefined, ...args);
};
 ...
 */
export const info = async (fmt: string, ...args: unknown[]) => {
  await convenienceLog('info', false, fmt, undefined, ...args);
};
 ...
 * @param code An optional code of format [A-Z_]+_[0-2]\d{3}, defaults to `TOOLKIT_2000`
 */
export const data = async (fmt: string, ...args: unknown[]) => {
  await convenienceLog('info', true, fmt, undefined, ...args);
};
 ...
 * @param code An optional code of format [A-Z_]+_[0-2]\d{3}, defaults to `TOOLKIT_2000`
 */
export const debug = async (fmt: string, ...args: unknown[]) => {
  await convenienceLog('debug', false, fmt, undefined, ...args);
};
 ...
 * @param code An optional code of format [A-Z_]+_[0-2]\d{3}, defaults to `TOOLKIT_2000`
 */
export const trace = async (fmt: string, ...args: unknown[]) => {
  await convenienceLog('trace', false, fmt, undefined, ...args);
};
 ...
 * @param code An optional code of format [A-Z_]+_[0-2]\d{3}, defaults to `TOOLKIT_2000`
 */
export const success = async (fmt: string, ...args: unknown[]) => {
  await convenienceLog('info', false, fmt, chalk.green, ...args);
};
 ...
 * @param code An optional code of format [A-Z_]+_[0-2]\d{3}, defaults to `TOOLKIT_2000`
 */
export const highlight = async (fmt: string, ...args: unknown[]) => {
  await convenienceLog('info', false, fmt, chalk.bold, ...args);
};
