...
${repo_root}/test/integ/run-against-repo test-cli-regression-against-current-code.sh

echo "Running regression tests against local CLI and published framework"
${repo_root}/test/integ/run-against-repo test-cli-regression-against-latest-release.sh