...
describe.each([HotswapType.HOTSWAP, HotswapType.HOTSWAP_ONLY])('these tests depend on the hotswap type', (hotswapType) => {
  test('non-hotswappable changes in nested stacks result in a full deployment, even if their parent contains a hotswappable change', async () => { //different
    // GIVEN
  ...
  test('deleting a nested stack results in a full deployment, even if their parent contains a hotswappable change', async () => { //different
    // GIVEN
  ...
  test('creating a nested stack results in a full deployment, even if their parent contains a hotswappable change', async () => { //different
    // GIVEN
  ...
  test('attempting to hotswap a newly created nested stack with the same logical ID as a resource with a different type results in a full deployment', async () => { //different
    // GIVEN
