...
async function parseCommandLineArguments() {
  ...
  return yargs
    ...
    .command('deploy [STACKS..]', 'Deploys the stack(s) named STACKS into your AWS account', yargs => yargs
      ...
      .option('progress', { type: 'string', choices: [StackActivityProgress.Bar, StackActivityProgress.Events], desc: 'Display mode for stack activity events.', default: StackActivityProgress.Bar }),
    )
