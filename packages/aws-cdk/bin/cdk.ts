...
async function parseCommandLineArguments() {
  ...
  return yargs
    ...
    .option('role-arn', { type: 'string', desc: 'ARN of Role for CloudFormation to execute changes (deprecated, use --execution-role-arn)', default: undefined, requiresArg: true })
    ...
    .option('assume-role-arn', { type: 'string', desc: 'ARN of Role to use when invoking CloudFormation', default: undefined, requiresArg: true })
    .option('assume-role-external-id', { type: 'string', desc: 'External id for Role to use when invoking CloudFormation', default: undefined, requiresArg: true })
