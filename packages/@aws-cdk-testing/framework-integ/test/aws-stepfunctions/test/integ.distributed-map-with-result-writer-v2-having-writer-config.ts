...
const stack = new DistributedMapStack(app, 'distributed-map-with-result-writer-v2-having-writer-config');

const testCase = new IntegTest(app, 'DistributedMap-ResultWriter-with-WriterConfig', {
  testCases: [stack],
});
