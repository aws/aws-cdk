...
const stack = new cdk.Stack(app, 'aws-cdk-elbv2-integ'); // Does not specify env
...
// Forced to use service principal for resource principal
...
const group1 = listener.addTargets('Target', {
  port: 80,
  targets: [new elbv2Targets.IpTarget('10.0.128.6')],
