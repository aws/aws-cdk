...
const stack = new cdk.Stack(app, 'aws-stepfunctions-tasks-call-aws-service-elasticloadbalancingv2-integ');

const task = new CallAwsService(stack, 'DescribeELBV2TargetGroups', {
