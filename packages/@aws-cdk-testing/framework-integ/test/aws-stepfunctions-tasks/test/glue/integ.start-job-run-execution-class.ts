...
import { ExecutionClass, GlueStartJobRun } from 'aws-cdk-lib/aws-stepfunctions-tasks';
import { ExpectedResult, IntegTest } from '@aws-cdk/integ-tests-alpha';

const app = new cdk.App();

class GlueStartJobRunExecutionClassStack extends cdk.Stack {
...
const stack = new GlueStartJobRunExecutionClassStack(app, 'aws-stepfunctions-integ-execution-class');
