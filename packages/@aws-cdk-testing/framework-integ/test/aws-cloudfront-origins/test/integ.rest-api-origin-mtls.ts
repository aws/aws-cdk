 ...
 * mutual TLS (mTLS) authentication configured on REST API origins.
 *
...
const stack = new cdk.Stack(app, 'integ-cloudfront-rest-api-origin-mtls');
...
new IntegTest(app, 'rest-api-origin-mtls-integ', {
  testCases: [stack],
