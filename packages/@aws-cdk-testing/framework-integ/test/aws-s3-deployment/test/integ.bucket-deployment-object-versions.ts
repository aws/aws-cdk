...
const app = new cdk.App({
  postCliContext: {
    // Use a CDK-managed log group for the deployment Lambda so it is deleted on stack teardown,
    // rather than an implicitly-created one that would be orphaned on the account after cleanup.
