 ...
 *     - `yarn integ aws-dynamodb/test/integ.dynamodb-v2.cross-account-replica-kms.js`
 *   b. Fall back if temp credentials do not work
 *     - `yarn integ aws-dynamodb/test/integ.dynamodb-v2.cross-account-replica-kms.js --profiles multi-account`
 *
