...
new agentcore.Memory(stack, 'MemoryWithCustomStrategies', {
  ...
  memoryStrategies: [
    agentcore.MemoryStrategy.usingSemantic({
      ...
      customConsolidation: {
        model: bedrock.FoundationModel.fromFoundationModelId(stack, 'ConsolidationModel', bedrock.FoundationModelIdentifier.ANTHROPIC_CLAUDE_3_SONNET_20240229_V1_0),
        appendToPrompt: 'Custom consolidation prompt for semantic memory',
      },
      customExtraction: {
        model: bedrock.FoundationModel.fromFoundationModelId(stack, 'ExtractionModel', bedrock.FoundationModelIdentifier.ANTHROPIC_CLAUDE_3_SONNET_20240229_V1_0),
...
// Create a memory with a removal policy applied via the L2. This exercises
// applyRemovalPolicy(), which requires the CfnMemory to be set as the
// construct's default child (see #38262)
