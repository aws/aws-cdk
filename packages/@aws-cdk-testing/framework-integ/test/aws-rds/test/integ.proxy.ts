...
// In this test, we use `addProxy` to add two `TargetGroup` as children of `DatabaseCluster`
// and verify that they can be deployed correctly without dependency cycling.
