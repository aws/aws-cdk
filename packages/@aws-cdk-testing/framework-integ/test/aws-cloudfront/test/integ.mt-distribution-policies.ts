...
const stack = new cdk.Stack(app, 'integ-mt-distribution-policies');
...
new cloudfront.MTDistribution(stack, 'Dist', {
  defaultBehavior: {
...
new cloudfront.MTDistribution(stack, 'Dist-2', {
  defaultBehavior: {
...
new IntegTest(app, 'MTDistributionPolicies', {
  testCases: [stack],
});
